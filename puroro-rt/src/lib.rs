...
pub use fields::wire::{
    Closed, ClosedEnum, Fixed32ProtoType, Fixed64ProtoType, MapKey, MapKeyInsert, MapValueView,
    Open, OpenEnum, PackableRepeatedElement, PayloadAccess, ProtoBool, ProtoBytes, ProtoDouble,
    ProtoEnum, ProtoEnumStorage, ProtoFixed32, ProtoFixed64, ProtoFloat, ProtoInt32, ProtoInt64,
    ProtoMessage, ProtoSFixed32, ProtoSFixed64, ProtoSint32, ProtoSint64, ProtoString, ProtoType,
    ProtoUInt32, ProtoUInt64, RepeatedElement, RepeatedElementMerge, RepeatedElementMut,
    RepeatedSlicePush, RepeatedVecMut, VarintProtoType,
};
