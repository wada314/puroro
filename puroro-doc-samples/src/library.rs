...
impl<ScalarType> ::puroro::Message<super::Book>
for BookSingleField1<ScalarType>
where
...
impl<ScalarType> super::_puroro_traits::BookTrait
for BookSingleField1<ScalarType>
where
...
impl<ScalarType> ::puroro::Message<super::Book>
for BookSingleField2<ScalarType>
where
...
fn num_pages_opt<'this>(&'this self) -> ::std::option::Option<u32> {
    ::std::option::Option::Some(
        ::std::convert::Into::into(::std::clone::Clone::clone(&self.num_pages))
    )
}
}
...
impl<'bump> BookBumpalo<'bump> {
    ...
    pub fn title_mut<'this>(&'this mut self) -> impl 'this + ::std::ops::DerefMut<Target=::puroro::bumpalo::collections::String<'bump>> {
        if !self.has_title() {
            self.title = ::std::default::Default::default();
        }
    ...
    T: BookTrait
{
    ...
    pub fn append_title<ScalarType>(self, value: ScalarType)
...
ScalarType:
    ...
    pub fn append_num_pages<ScalarType>(self, value: ScalarType)
...
pub struct BookTemplate<T, B>
    where T: BookTemplateFieldTypes
{
    _bitvec: B,
...
{
    pub fn title_opt(&self) -> ::std::option::Option<&T::TitleType> {
        #[allow(unused)]
...
where
    ...
    <T as BookTemplateFieldTypes>::NumPagesType: ::std::clone::Clone,_unesc_opt
{
    pub fn num_pages_opt(&self) -> ::std::option::Option<T::NumPagesType> {
        #[allow(unused)]
        use ::std::option::Option::{Some, None};
    }
...
pub mod _puroro_traits {
    ...
    pub trait BookTrait {
        fn title<'this>(&'this self) -> &'this str {
            self.title_opt().unwrap_or_else(::std::default::Default::default)
        }
        ...
        fn num_pages<'this>(&'this self) -> u32 {
            self.num_pages_opt().unwrap_or_else(::std::default::Default::default)
        }
        ...
        U: BookTrait,
    {
        ...
        fn title_opt<'this>(&'this self) -> Option<&'this str>
        {
            <U as BookTrait>::title_opt(&self.1)
                .or_else(|| <T as BookTrait>::title_opt(&self.0))
        }
