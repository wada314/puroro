...
impl ::std::default::Default for self::Conflict {
    fn default() -> Self {
        Self(
            ::std::boxed::Box::new(
                <self::_root::name_conflict_fields::_view::ConflictView as ::std::default::Default>::default(),
            ),
        )
    }
}
...
impl ::std::default::Default for self::ConflictFields {
    fn default() -> Self {
        Self(
            ::std::boxed::Box::new(
                <self::_root::name_conflict_fields::_view::ConflictFieldsView as ::std::default::Default>::default(),
            ),
        )
    }
}
...
pub mod _view {
    ...
    impl self::_pinternal::MessageViewInternal for self::ConflictView {
        ...
        fn new_boxed_in<A: ::std::alloc::Allocator>(
            ...
            let (fields, allocator) = {
                let (this_is_original_message_field, _allocator) = self::_pinternal::FieldType::new_in(
                    shared.bitfield_mut(),
                    _allocator,
                );
                (
                    self::_root::name_conflict_fields::_fields::ConflictFields {
                        this_is_original_message_field,
                    },
                    _allocator,
                )
            };
    ...
    impl self::_pinternal::MessageViewInternal for self::ConflictFieldsView {
        ...
        fn new_boxed_in<A: ::std::alloc::Allocator>(
            ...
            let mut shared: self::_pinternal::SharedItemsImpl::<1usize> = ::std::default::Default::default();
            let (fields, allocator) = {
                let (this_is_fields_message_field, _allocator) = self::_pinternal::FieldType::new_in(
                    shared.bitfield_mut(),
                    _allocator,
                );
                (
                    self::_root::name_conflict_fields::_fields::ConflictFieldsFields {
                        this_is_fields_message_field,
                    },
                    _allocator,
                )
            };
