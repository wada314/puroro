...
pub struct Submsg<A: ::std::alloc::Allocator = ::std::alloc::Global>(
    ::std::boxed::Box<self::_root::full_coverage2::msg::_view::SubmsgView, A>,
);
...
impl ::std::default::Default for self::Submsg {
    fn default() -> Self {
        Self(
            ::std::boxed::Box::new(
                <self::_root::full_coverage2::msg::_view::SubmsgView as ::std::default::Default>::default(),
            ),
        )
    }
}
...
where
    ...
    self::_root::full_coverage2::msg::_view::SubmsgView: self::_puroro::DefaultIn<A>,
{
    fn default_in(allocator: A) -> Self {
        Self(
            ::std::boxed::Box::new_in(
                <self::_root::full_coverage2::msg::_view::SubmsgView as self::_puroro::DefaultIn<
                    A,
...
pub mod _view {
    ...
    impl self::_pinternal::MessageViewInternal for self::SubmsgView {
        fn new_boxed() -> ::std::boxed::Box<Self> {
            ...
            let fields = self::_root::full_coverage2::msg::_fields::SubmsgFields {
        ...
        fn new_boxed_in<A: ::std::alloc::Allocator>(
            ...
            let (fields, allocator) = {
                ...
                (
                    self::_root::full_coverage2::msg::_fields::SubmsgFields {
                        i32_required,
                        i64_required,
                    },
                    _allocator,
