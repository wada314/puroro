...
pub mod _view {
    ...
    impl self::_pinternal::MessageViewInternal for self::SubmsgView {
        fn new_boxed() -> ::std::boxed::Box<Self> {
            ...
            let fields = self::_root::nested::msg::_fields::SubmsgFields {
                item_inner: self::_pinternal::FieldType::new(shared.bitfield_mut()),
            };
        ...
        fn new_boxed_in<A: ::std::alloc::Allocator>(
            ...
            let (fields, allocator) = {
                let (item_inner, _allocator) = self::_pinternal::FieldType::new_in(
                    shared.bitfield_mut(),
                    _allocator,
                );
                (
                    self::_root::nested::msg::_fields::SubmsgFields {
                        item_inner,
                    },
                    _allocator,
                )
