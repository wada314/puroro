                ...
                match number {
                    1i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.i32_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    11i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.float_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    21i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.bytes_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    31i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.string_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    41i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.enum_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    51i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.submsg_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    101i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.i64_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    111i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.u32_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    121i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.u64_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    131i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.s32_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    141i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.s64_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    151i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.fixed32_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    161i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.fixed64_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    171i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.sfixed32_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    181i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.sfixed64_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
                    ...
                    191i32 => {
                        self::_pinternal::FieldType::deser_from_field_data(
                            &mut self.0.fields.f64_required,
                            self.0.shared.bitfield_mut(),
                            field_data,
                        )?
                    }
