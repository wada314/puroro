...
impl ::std::default::Default for self::Submsg {
    fn default() -> Self {
        Self(
            ::std::boxed::Box::new(
                <self::_root::full_coverage3::msg::_view::SubmsgView as ::std::default::Default>::default(),
            ),
        )
    }
}
...
where
    ...
    self::_root::full_coverage3::msg::_view::SubmsgView: self::_puroro::DefaultIn<A>,
{
    fn default_in(allocator: A) -> Self {
        Self(
            ::std::boxed::Box::new_in(
                <self::_root::full_coverage3::msg::_view::SubmsgView as self::_puroro::DefaultIn<
                    A,
