...
//! `oneof` declarations** (real oneofs are covered by `oneof_basic`). This
//! case proves the generator can handle the subset of official protos checked
//! in here (including proto2 required fields, nested types, and closed enums).
