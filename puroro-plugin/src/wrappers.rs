...
impl Message {
    pub fn try_from_proto(
        ...
        let message = Rc::new_cyclic(|message| Self {
            ...
            rust_ident: proto_name
                .to_camel_case()
                .escape_rust_keywords()
                .to_string(),
            rust_nested_module_ident: proto_name
                .to_lower_snake_case()
                .escape_rust_keywords()
                .to_string(),
            proto_name,
    ...
    pub fn try_from_proto(
        ...
        Ok(Rc::new(Self {
            ...
            values: proto_value
                .into_iter()
                .map(|v| EnumValue {
                    rust_ident: v.name().to_camel_case().escape_rust_keywords().to_string(),
                    number: v.number(),
                })
                .collect_vec(),
        }))
...
impl Field {
    pub fn try_from_proto(message: Weak<Message>, proto: &FieldDescriptorProto) -> Result<Self> {
        ...
        Ok(Self {
            ...
            ident_lower_snake: proto_name
                .to_lower_snake_case()
                .escape_rust_keywords()
                .to_string(),
            ident_lower_snake_unesc: proto_name.to_lower_snake_case().to_string(),
            ident_camel: proto_name
                .to_camel_case()
                .escape_rust_keywords()
                .to_string(),
            ident_camel_unesc: proto_name.to_camel_case().to_string(),
            proto_name,
            proto_type_name,
            proto_type_enum,
...
impl Oneof {
    pub fn try_from_proto(
        ...
        Ok(Rc::new(Self {
            message,
            index: index,
            rust_enum_ident: proto
                .name()
                .to_camel_case()
                .escape_rust_keywords()
                .to_string(),
            rust_getter_ident: proto
                .name()
                .to_lower_snake_case()
                .escape_rust_keywords()
                .to_string(),
