...
impl ::puroro::deser::DeserializableMessageFromIter for CodeGeneratorResponse {
    fn met_field<'a, 'b, I>(
        &mut self,
...
impl ::puroro::deser::DeserializableFromIter for CodeGeneratorResponse {
...
#[cfg(feature = "puroro-bumpalo")]
impl<'bump> ::puroro::deser::DeserializableMessageFromIter for CodeGeneratorResponseBumpalo<'bump> {
    fn met_field<'a, 'b, I>(
        &mut self,
        field: ::puroro::types::FieldData<&'a mut ::puroro::deser::BytesIter<'b, I>>,
        field_number: usize,
...
#[cfg(feature = "puroro-bumpalo")]
impl<'bump> ::puroro::deser::DeserializableFromIter for CodeGeneratorResponseBumpalo<'bump> {
    fn deserialize_from_bytes_iter<'a, I>(&mut self, mut bytes_iter: ::puroro::deser::BytesIter<'a, I>) -> ::puroro::Result<()>
    where
        I: Iterator<Item = ::std::io::Result<u8>>
    {
...
impl ::puroro::deser::DeserializableMessageFromIter for File {
    fn met_field<'a, 'b, I>(
        &mut self,
        field: ::puroro::types::FieldData<&'a mut ::puroro::deser::BytesIter<'b, I>>,
        field_number: usize,
...
impl ::puroro::deser::DeserializableFromIter for File {
    fn deserialize_from_bytes_iter<'a, I>(&mut self, mut bytes_iter: ::puroro::deser::BytesIter<'a, I>) -> ::puroro::Result<()>
    where
        I: Iterator<Item = ::std::io::Result<u8>>
    {
...
#[cfg(feature = "puroro-bumpalo")]
impl<'bump> ::puroro::deser::DeserializableMessageFromIter for FileBumpalo<'bump> {
    fn met_field<'a, 'b, I>(
        &mut self,
        field: ::puroro::types::FieldData<&'a mut ::puroro::deser::BytesIter<'b, I>>,
        field_number: usize,
...
#[cfg(feature = "puroro-bumpalo")]
impl<'bump> ::puroro::deser::DeserializableFromIter for FileBumpalo<'bump> {
    fn deserialize_from_bytes_iter<'a, I>(&mut self, mut bytes_iter: ::puroro::deser::BytesIter<'a, I>) -> ::puroro::Result<()>
    where
        I: Iterator<Item = ::std::io::Result<u8>>
    {
...
impl ::puroro::deser::DeserializableMessageFromIter for CodeGeneratorRequest {
    fn met_field<'a, 'b, I>(
        &mut self,
        field: ::puroro::types::FieldData<&'a mut ::puroro::deser::BytesIter<'b, I>>,
        field_number: usize,
...
impl ::puroro::deser::DeserializableFromIter for CodeGeneratorRequest {
    fn deserialize_from_bytes_iter<'a, I>(&mut self, mut bytes_iter: ::puroro::deser::BytesIter<'a, I>) -> ::puroro::Result<()>
    where
        I: Iterator<Item = ::std::io::Result<u8>>
    {
...
#[cfg(feature = "puroro-bumpalo")]
impl<'bump> ::puroro::deser::DeserializableMessageFromIter for CodeGeneratorRequestBumpalo<'bump> {
    fn met_field<'a, 'b, I>(
        &mut self,
        field: ::puroro::types::FieldData<&'a mut ::puroro::deser::BytesIter<'b, I>>,
        field_number: usize,
...
#[cfg(feature = "puroro-bumpalo")]
impl<'bump> ::puroro::deser::DeserializableFromIter for CodeGeneratorRequestBumpalo<'bump> {
    fn deserialize_from_bytes_iter<'a, I>(&mut self, mut bytes_iter: ::puroro::deser::BytesIter<'a, I>) -> ::puroro::Result<()>
    where
        I: Iterator<Item = ::std::io::Result<u8>>
    {
...
impl ::puroro::deser::DeserializableMessageFromIter for Version {
    fn met_field<'a, 'b, I>(
        &mut self,
        field: ::puroro::types::FieldData<&'a mut ::puroro::deser::BytesIter<'b, I>>,
        field_number: usize,
...
impl ::puroro::deser::DeserializableFromIter for Version {
    fn deserialize_from_bytes_iter<'a, I>(&mut self, mut bytes_iter: ::puroro::deser::BytesIter<'a, I>) -> ::puroro::Result<()>
    where
        I: Iterator<Item = ::std::io::Result<u8>>
    {
...
#[cfg(feature = "puroro-bumpalo")]
impl<'bump> ::puroro::deser::DeserializableMessageFromIter for VersionBumpalo<'bump> {
    fn met_field<'a, 'b, I>(
        &mut self,
        field: ::puroro::types::FieldData<&'a mut ::puroro::deser::BytesIter<'b, I>>,
        field_number: usize,
...
#[cfg(feature = "puroro-bumpalo")]
impl<'bump> ::puroro::deser::DeserializableFromIter for VersionBumpalo<'bump> {
    fn deserialize_from_bytes_iter<'a, I>(&mut self, mut bytes_iter: ::puroro::deser::BytesIter<'a, I>) -> ::puroro::Result<()>
    where
        I: Iterator<Item = ::std::io::Result<u8>>
    {
