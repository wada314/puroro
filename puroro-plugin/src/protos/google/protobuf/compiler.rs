...
pub mod puroro_structs {
    ...
    pub mod public {
        ...
        impl<ImplTag> ::puroro::Message for Version<ImplTag> where
            ImplTag: ::puroro_internal::AnyFieldTypeGen + ::puroro_internal::StructInternalTypeGen
        {
        }
                ...
                I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>,
            {
                match field_number {
                    ...
                    >>::deser_from_scoped_bytes_iter(
                        &mut self.major, data, &self.puroro_internal
                    ),
                    2 => <ImplTag as ::puroro_internal::de::DeserFieldFromBytesIter<
                        ...
                        ::puroro::tags::Int32,
                    >>::deser_from_scoped_bytes_iter(
                        &mut self.minor, data, &self.puroro_internal
                    ),
                    3 => <ImplTag as ::puroro_internal::de::DeserFieldFromBytesIter<
                        ...
                        ::puroro::tags::Int32,
                    >>::deser_from_scoped_bytes_iter(
                        &mut self.patch, data, &self.puroro_internal
                    ),
                    4 => <ImplTag as ::puroro_internal::de::DeserFieldFromBytesIter<
                        ...
                        ::puroro::tags::String,
                    >>::deser_from_scoped_bytes_iter(
                        &mut self.suffix, data, &self.puroro_internal
                    ),
            ...
            ImplTag: ::puroro_internal::AnyFieldTypeGen + ::puroro_internal::StructInternalTypeGen,
        {
            ...
            pub compiler_version:
                <ImplTag as ::puroro_internal::MsgTypeGen<
                    ::puroro::tags::Proto2,
                    ::puroro::tags::Optional,
                >>::MsgType<self::puroro_root::google::protobuf::compiler::Version<ImplTag>>,
            puroro_internal: <ImplTag as ::puroro_internal::StructInternalTypeGen>::Type,
        }

        impl<ImplTag> ::puroro::Message for CodeGeneratorRequest<ImplTag> where
            ImplTag: ::puroro_internal::AnyFieldTypeGen + ::puroro_internal::StructInternalTypeGen
        {
        }
                ...
                + ::puroro_internal::DeserAnyFieldFromBytesIter,
        {
                ...
                I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>,
            {
                match field_number {
                    ...
                    3 => {
                        <ImplTag as ::puroro_internal::de::DeserMsgFromBytesIterProxy<
                            ::puroro::tags::Proto2,
                            ::puroro::tags::Optional,
                        >>::DeserMsg::<
                ...
                + ::puroro_internal::StructInternalTypeGen,
        {
                ...
                W: ::std::io::Write,
            {
                <ImplTag as ::puroro_internal::se::SerFieldToIoWrite<
                    ...
                    ::puroro::tags::String,
                >>::ser_to_io_write(
                    &self.file_to_generate, 1, out, &self.puroro_internal
                )?;
                <ImplTag as ::puroro_internal::se::SerFieldToIoWrite<
                    ::puroro::tags::Proto2,
                    ::puroro::tags::Optional,
            ...
            fn clone(&self) -> Self {
                ...
                Self {
                    file_to_generate: <ImplTag as ::puroro_internal::FieldTypeGen<
                        ...
                        ::puroro::tags::String,
                    >>::clone(
                        &self.file_to_generate, &internal_data
                    ),
                    parameter: <ImplTag as ::puroro_internal::FieldTypeGen<
                        ::puroro::tags::Proto2,
                        ::puroro::tags::Optional,
                    ...
                    compiler_version: <ImplTag as ::puroro_internal::MsgTypeGen<
                        ...
                        ::puroro::tags::Optional,
                    >>::clone(
                        &self.compiler_version, &internal_data
                    ),
                    puroro_internal: internal_data,
                }
            }
        ...
        impl<ImplTag> ::puroro::Message for CodeGeneratorResponse<ImplTag> where
            ImplTag: ::puroro_internal::AnyFieldTypeGen + ::puroro_internal::StructInternalTypeGen
        {
        }
                ...
                + ::puroro_internal::StructInternalTypeGen,
        {
                ...
                W: ::std::io::Write,
            {
                ...
                <ImplTag as ::puroro_internal::se::SerFieldToIoWrite<
                    ...
                    ::puroro::tags::UInt64,
                >>::ser_to_io_write(
                    &self.supported_features, 2, out, &self.puroro_internal
                )?;
                <ImplTag as ::puroro_internal::se::SerMsgToIoWriteProxy<
                    ::puroro::tags::Proto2, ::puroro::tags::Repeated
                >>::SerMsg::<
            ...
            fn clone(&self) -> Self {
                ...
                Self {
                    ...
                    supported_features: <ImplTag as ::puroro_internal::FieldTypeGen<
                        ...
                        ::puroro::tags::UInt64,
                    >>::clone(
                        &self.supported_features, &internal_data
                    ),
                    file: <ImplTag as ::puroro_internal::MsgTypeGen<
                        ::puroro::tags::Proto2,
                        ::puroro::tags::Repeated,
    ...
    pub mod private {
        ...
        {
            fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                <super::public::Version<ImplTag> as ::std::fmt::Debug>::fmt(&self.body, f)
            }
        }
...
pub type Version<ImplTag = ::puroro_internal::SimpleImpl> =
    self::puroro_structs::public::Version<ImplTag>;
pub type CodeGeneratorRequest<ImplTag = ::puroro_internal::SimpleImpl> =
    self::puroro_structs::public::CodeGeneratorRequest<ImplTag>;
pub type CodeGeneratorResponse<ImplTag = ::puroro_internal::SimpleImpl> =
    self::puroro_structs::public::CodeGeneratorResponse<ImplTag>;
    ...
    pub mod code_generator_response {
        ...
        pub mod puroro_structs {
            ...
            pub mod public {
                ...
                impl<ImplTag> ::puroro::Message for File<ImplTag> where
                    ImplTag: ::puroro_internal::AnyFieldTypeGen
                        + ::puroro_internal::StructInternalTypeGen
                {
                }
                        ...
                        + ::puroro_internal::StructInternalTypeGen,
                {
                        ...
                        W: ::std::io::Write,
                    {
                        <ImplTag as ::puroro_internal::se::SerFieldToIoWrite<
                            ...
                            ::puroro::tags::String,
                        >>::ser_to_io_write(
                            &self.name, 1, out, &self.puroro_internal
                        )?;
                        <ImplTag as ::puroro_internal::se::SerFieldToIoWrite<
                            ::puroro::tags::Proto2,
                            ::puroro::tags::Optional,
                            ::puroro::tags::String,
                        >>::ser_to_io_write(
                            &self.insertion_point, 2, out, &self.puroro_internal
                        )?;
                        <ImplTag as ::puroro_internal::se::SerFieldToIoWrite<
                            ::puroro::tags::Proto2,
                            ::puroro::tags::Optional,
                            ::puroro::tags::String,
                        >>::ser_to_io_write(
                            &self.content, 15, out, &self.puroro_internal
                        )?;
                        <ImplTag as ::puroro_internal::se::SerMsgToIoWriteProxy<
                            ::puroro::tags::Proto2,
                            ::puroro::tags::Optional,
                    ...
                    fn clone(&self) -> Self {
                        ...
                        Self {
                            ...
                            insertion_point: <ImplTag as ::puroro_internal::FieldTypeGen<
                                ...
                                ::puroro::tags::String,
                            >>::clone(
                                &self.insertion_point, &internal_data
                            ),
                            content: <ImplTag as ::puroro_internal::FieldTypeGen<
                                ::puroro::tags::Proto2,
                                ::puroro::tags::Optional,
                                ::puroro::tags::String,
                            >>::clone(
                                &self.content, &internal_data
                            ),
                            generated_code_info: <ImplTag as ::puroro_internal::MsgTypeGen<
                                ::puroro::tags::Proto2,
                                ::puroro::tags::Optional,
                            >>::clone(
                                &self.generated_code_info, &internal_data
                            ),
                            puroro_internal: internal_data,
                        }
                    }
                ...
                where
                    ...
                    <ImplTag as ::puroro_internal::MsgTypeGen<
                        ::puroro::tags::Proto2,
                        ::puroro::tags::Optional,
                    >>::MsgType<self::puroro_root::google::protobuf::GeneratedCodeInfo<ImplTag>>:
                        std::fmt::Debug,
                {
                    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                        f.debug_struct("File")
            ...
            pub mod private {
                ...
                {
                    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                        <super::public::File<ImplTag> as ::std::fmt::Debug>::fmt(&self.body, f)
                    }
                }
        ...
        pub type File<ImplTag = ::puroro_internal::SimpleImpl> =
            self::puroro_structs::public::File<ImplTag>;
