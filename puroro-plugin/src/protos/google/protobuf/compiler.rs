...
pub mod puroro_structs {
    ...
    impl<ImplTag> self::puroro_root::google::protobuf::compiler::puroro_traits::VersionTrait
        for Version<ImplTag>
    where
        Self: ::puroro_internal::GetImplStruct,
        <Self as ::puroro_internal::GetImplStruct>::Type:
            self::puroro_root::google::protobuf::compiler::puroro_traits::VersionTrait,
    {
    ...
    impl self::puroro_root::google::protobuf::compiler::puroro_traits::VersionTrait
        for Version_SimpleImpl
    {
        /// optional int32 major = 1;
        fn major<'this>(&'this self) -> ::std::option::Option<i32> {
            todo!()
    ...
    impl<ImplTag>
        self::puroro_root::google::protobuf::compiler::puroro_traits::CodeGeneratorRequestTrait
        for CodeGeneratorRequest<ImplTag>
    where
        Self: ::puroro_internal::GetImplStruct,
        <Self as ::puroro_internal::GetImplStruct>::Type:
            self::puroro_root::google::protobuf::compiler::puroro_traits::CodeGeneratorRequestTrait,
    ...
    pub struct CodeGeneratorRequest_SimpleImpl {
        ...
        pub compiler_version: ::std::option::Option<
            ::std::boxed::Box<
                self::puroro_root::google::protobuf::compiler::Version<::puroro::tags::SimpleImpl>,
            >,
        >,
    }
    ...
    impl self::puroro_root::google::protobuf::compiler::puroro_traits::CodeGeneratorRequestTrait
        for CodeGeneratorRequest_SimpleImpl
    {
        type Field1RepeatedType<'this> =
        ...
        type Field15MessageType<'this> =
            self::puroro_root::google::protobuf::FileDescriptorProto<::puroro::tags::SimpleImpl>;
        type Field15RepeatedType<'this> = ::puroro_internal::impls::simple::VecCowWrapper<
            'this,
            self::puroro_root::google::protobuf::FileDescriptorProto<::puroro::tags::SimpleImpl>,
        >;
            ...
            I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>,
        {
            match field_number {
                ...
                3 => ::puroro_internal::impls::simple::DeserFieldFromBytesIter::<
                    ::puroro::tags::Optional,
                    ::puroro::tags::Message<
                        self::puroro_root::google::protobuf::compiler::Version<
                            ::puroro::tags::SimpleImpl,
                        >,
                    >,
    ...
    impl self::puroro_root::google::protobuf::compiler::puroro_traits::CodeGeneratorResponseTrait
        for CodeGeneratorResponse_SimpleImpl
    {
        /// optional string error = 1;
        fn error<'this>(&'this self) -> ::std::option::Option<::std::borrow::Cow<'this, str>> {
            todo!()
...
pub type CodeGeneratorRequest<ImplTag = ::puroro::tags::SimpleImpl> =
    self::puroro_structs::CodeGeneratorRequest<ImplTag>;
pub type CodeGeneratorResponse<ImplTag = ::puroro::tags::SimpleImpl> =
    self::puroro_structs::CodeGeneratorResponse<ImplTag>;
...
pub mod puroro_traits {
    ...
    pub trait CodeGeneratorRequestTrait: ::std::clone::Clone {
        ...
        type Field15RepeatedType<'this>: ::puroro::RepeatedField<
            'this,
            ::std::borrow::Cow<'this, Self::Field15MessageType<'this>>,
        >;
        ...
        fn generated_code_info<'this>(&'this self) -> ::std::option::Option<::std::borrow::Cow<'this, Self::Field16MessageType<'this>>> {
            ...
            pub struct File_SimpleImpl {
                ...
                pub generated_code_info: ::std::option::Option<
                    ::std::boxed::Box<
                        self::puroro_root::google::protobuf::GeneratedCodeInfo<
                            ::puroro::tags::SimpleImpl,
                        >,
                    >,
                >,
                    ...
                    I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>,
                {
                    match field_number {
                        ...
                        16 => ::puroro_internal::impls::simple::DeserFieldFromBytesIter::<
                            ...
                            >,
                        >::deser_field(
                            &mut self.generated_code_info, data
                        ),
                        _ => unimplemented!("TODO: This case should be handled properly..."),
                    }
                }
        ...
        pub mod puroro_traits {
            ...
            pub trait FileTrait: ::std::clone::Clone {
                ...
                fn generated_code_info<'this>(
                    &'this self,
                ) -> ::std::option::Option<::std::borrow::Cow<'this, Self::Field16MessageType<'this>>>;
            }
        } // mod puroro_traits
