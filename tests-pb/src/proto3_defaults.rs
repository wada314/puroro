...
type Field6MessageType<'this> where Self: 'this = &'this self::_puroro_root::proto3_defaults::_puroro_simple_impl::Submsg;
    ...
    Self: super::_puroro_traits::MsgTrait,
{
        ...
        W: ::std::io::Write,
    {
        ...
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::Unlabeled, ::puroro::tags::Message<<Self as super::_puroro_traits::MsgTrait>::Field6MessageType<'_>>
        >::ser_field(
...
fn submsg_unlabeled_opt<'this>(&'this self) -> ::std::option::Option<Self::Field6MessageType<'this>> {
...
type Field6MessageType<'this> where Self: 'this = &'this self::_puroro_root::proto3_defaults::_puroro_impls::SubmsgBumpalo<'this>;
fn submsg_unlabeled_opt<'this>(&'this self) -> Option<Self::Field6MessageType<'this>> {
...
pub mod _puroro_traits {
        ...
        U: MsgTrait,
    {
        ...
        fn f32_unlabeled<'this>(&'this self) -> f32 {
            self.f32_unlabeled_opt().unwrap_or_else(|| self.1.f32_unlabeled() )
        }
        fn string_unlabeled_opt<'this>(&'this self) -> Option<&'this str>
        {
        ...
        T: MsgTrait,
    {
        ...
        fn f32_unlabeled<'this>(&'this self) -> f32 {
            self.as_ref().map_or(, |msg| msg.f32_unlabeled())
        }
        fn string_unlabeled_opt<'this>(&'this self) -> ::std::option::Option<&'this str> {
        ...
        type Field6MessageType<'this> where Self: 'this = ::std::option::Option<T::Field6MessageType<'this>>;
        fn submsg_unlabeled_opt<'this>(&'this self) -> ::std::option::Option<Self::Field6MessageType<'this>> {
