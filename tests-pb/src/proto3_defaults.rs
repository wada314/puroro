...
pub mod _puroro_impls {
        ...
        BT: ::puroro::BumpTypes + ::std::fmt::Debug + ::std::cmp::PartialEq,
    {
        ...
        submsg_unlabeled: ::std::option::Option<
            ::puroro::bumpalo::boxed::Box<
                'static,
                self::_puroro_root::proto3_defaults::_puroro_impls::SubmsgBumpalo<BT::AsStatic>,
            >,
        >,
        ...
        BT: ::puroro::BumpTypes + ::std::fmt::Debug + ::std::cmp::PartialEq,
    {
        ...
        where
            Self: 'this,
        = &'this self::_puroro_root::proto3_defaults::_puroro_impls::SubmsgBumpalo<BT>;
        fn submsg_unlabeled_opt<'this>(&'this self) -> Option<Self::Field6MessageType<'this>> {
        ...
        BT: ::puroro::BumpTypes + ::std::fmt::Debug + ::std::cmp::PartialEq,
    {
            ...
            I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>,
        {
            ...
            6 => {
                DeserFieldFromBytesIter::<
                    ::puroro::tags::Unlabeled, ::puroro::tags::Message<::puroro::bumpalo::boxed::Box<'static, self::_puroro_root::proto3_defaults::_puroro_impls::SubmsgBumpalo<BT::AsStatic>>>, BT
