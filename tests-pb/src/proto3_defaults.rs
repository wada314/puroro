...
pub struct Msg {
    ...
    f32_unlabeled: self::_puroro::internal::field_types::,
    ...
    submsg_unlabeled: self::_puroro::internal::field_types::SingularHeapMessageField<_puroro_root::proto3_defaults::Submsg>,
...
impl Msg {
    ...
    pub fn submsg_unlabeled(&self) -> Option<&_puroro_root::proto3_defaults::Submsg> {
        <self::_puroro::internal::field_types::SingularHeapMessageField<_puroro_root::proto3_defaults::Submsg> as self::_puroro::internal::field_types::FieldType>::get_field(
