...
pub struct Test1Simple {pub a: ::std::option::Option<i32>,
}
...
struct Test1SingleField1<FieldType> {
    field: FieldType,
}

impl<FieldType> ::puroro::Message for Test1SingleField1<FieldType> {}

impl<FieldType> super::_puroro_traits::Test1Trait for Test1SingleField1<FieldType>
where
...
#[derive(Clone, Default, PartialEq, Debug)]
pub struct Test2Simple {pub b: ::std::option::Option<::std::string::String>,
}
...
impl super::_puroro_traits::Test2Trait for Test2Simple {
    fn b<'this>(&'this self) -> ::std::option::Option<::std::borrow::Cow<'this, str>> {
        self.b.as_ref().map(|v| ::std::borrow::Cow::Borrowed(v.as_ref()))
    }
}
...
#[derive(Clone, PartialEq, Debug)]
struct Test2SingleField2<FieldType> {
    field: FieldType,
}

impl<FieldType> ::puroro::Message for Test2SingleField2<FieldType> {}

impl<FieldType> super::_puroro_traits::Test2Trait for Test2SingleField2<FieldType>
where
    FieldType: Clone, PartialEq, Debug,
{
    fn b<'this>(&'this self) -> ::std::option::Option<::std::borrow::Cow<'this, str>> {
...
#[derive(Clone, Default, PartialEq, Debug)]
pub struct Test3Simple {pub c: ::std::option::Option<::std::boxed::Box<self::_puroro_root::official_samples::_puroro_impls::Test1Simple>>,
}
impl ::puroro::Message for Test3Simple {}

impl super::_puroro_traits::Test3Trait for Test3Simple {
    type Field3MessageType<'this> = self::_puroro_root::official_samples::_puroro_impls::Test1Simple;
    fn c<'this>(&'this self) -> ::std::option::Option<::std::borrow::Cow<'this, Self::Field3MessageType<'this>>> {
        self.c.as_ref().map(|boxed| ::std::borrow::Cow::Borrowed(boxed.as_ref()))
    }
}
        ...
        I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>
    {
        match field_number {
            3 => ::puroro_internal::impls::simple::de::DeserFieldFromBytesIter::<
                ::puroro::tags::Optional, ::puroro::tags::Message<self::_puroro_root::official_samples::_puroro_impls::Test1Simple>
...
impl super::_puroro_traits::Test3Trait for Test3Empty {
    type Field3MessageType<'this> = self::_puroro_root::official_samples::_puroro_impls::Test1Empty;
    fn c<'this>(&'this self) -> ::std::option::Option<::std::borrow::Cow<'this, Self::Field3MessageType<'this>>> {
        None
    }
}
...
#[derive(Clone, PartialEq, Debug)]
struct Test3SingleField3<FieldType> {
    field: FieldType,
}

impl<FieldType> ::puroro::Message for Test3SingleField3<FieldType> {}

impl<FieldType> super::_puroro_traits::Test3Trait for Test3SingleField3<FieldType>
where
    FieldType: Clone, PartialEq, Debug,
{
    type Field3MessageType<'this> = self::_puroro_root::official_samples::_puroro_impls::Test1Empty;
...
#[derive(Clone, Default, PartialEq, Debug)]
pub struct Test4Simple {pub d: ::std::vec::Vec<i32>,
}
...
#[derive(Clone, PartialEq, Debug)]
struct Test4SingleField4<FieldType> {
    field: FieldType,
}

impl<FieldType> ::puroro::Message for Test4SingleField4<FieldType> {}

impl<FieldType> super::_puroro_traits::Test4Trait for Test4SingleField4<FieldType>
where
    FieldType: Clone, PartialEq, Debug,
{
    type Field4RepeatedType<'this> = ::puroro_internal::impls::empty::EmptyRepeatedField<i32>;
