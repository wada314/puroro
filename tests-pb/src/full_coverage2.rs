...
pub struct Msg {
    ...
    float_required: self::_puroro::internal::field_types::Dummy,
    // Optional, Bits32(Float)
    float_optional: self::_puroro::internal::field_types::Dummy,
    // Optional, LengthDelimited(Bytes)
    bytes_required: self::_puroro::internal::field_types::Dummy,
    // Optional, LengthDelimited(Bytes)
    ...
    enum_required: self::_puroro::internal::field_types::OptionalVariantField<
    ...
    submsg_required: self::_puroro::internal::field_types::SingularHeapMessageField<
        _puroro_root::full_coverage2::_msg::Submsg,
    >,
    // Optional, LengthDelimited(Message(Fqtn(".full_coverage2.Msg.Submsg")))
    ...
    u32_required: self::_puroro::internal::field_types::OptionalVariantField<
        u32,
    ...
    u64_required: self::_puroro::internal::field_types::OptionalVariantField<
        u64,
    ...
    s32_required: self::_puroro::internal::field_types::OptionalVariantField<
        i32,
    ...
    s64_required: self::_puroro::internal::field_types::OptionalVariantField<
        i64,
