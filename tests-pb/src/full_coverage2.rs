...
impl<R: ::puroro::Reflection> MsgWrapper<R> {
    ...
    pub fn bytes_required_opt(&self) -> ::std::option::Option<&'_ dyn ::std::convert::AsRef<[u8]>> {
        self.0
            .get_bytes(21)
            .unwrap()
    }
    ...
    pub fn bytes_required(&self) -> &'_ dyn ::std::convert::AsRef<[u8]> {
        self.bytes_required_opt().unwrap_or(
            todo!()
        )
    }
    ...
    pub fn string_required_opt(&self) -> ::std::option::Option<&'_ dyn ::std::convert::AsRef<str>> {
        self.0
            .get_str(31)
            .unwrap()
    }
    ...
    pub fn string_required(&self) -> &'_ dyn ::std::convert::AsRef<str> {
        self.string_required_opt().unwrap_or(
            todo!()
        )
    }
    ...
    pub fn enum_required_opt(&self) -> ::std::option::Option<self::_puroro_root::full_coverage2::Enum> {
        self.0
            .get_self::_puroro_root::full_coverage2::Enum(41)
            .unwrap()
    }
    ...
    pub fn enum_optional_opt(&self) -> ::std::option::Option<self::_puroro_root::full_coverage2::Enum> {
        self.0
            .get_self::_puroro_root::full_coverage2::Enum(42)
            .unwrap()
    }
    ...
    pub fn submsg_required_opt(&self) -> ::std::option::Option<()> {
        self.0
            .get_message(51)
            .unwrap()
    }
