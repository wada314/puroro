...
impl Msg {
    ...
    pub fn bytes_required_opt(&self) -> ::std::option::Option<&'_ [u8]> {
        if self.bytes_required.as_deref()
    }
    ...
    pub fn bytes_optional_opt(&self) -> ::std::option::Option<&'_ [u8]> {
        if self.bytes_optional.as_deref()
    }
    ...
    pub fn string_required_opt(&self) -> ::std::option::Option<&'_ str> {
        if self.string_required.as_deref()
    }
    ...
    pub fn string_optional_opt(&self) -> ::std::option::Option<&'_ str> {
        if self.string_optional.as_deref()
    }
...
ScalarType:
    ::std::convert::Into<self::_puroro_root::full_coverage2::Enum>
    + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        ...
        type Field51MessageType<'this>: self::_puroro_root::full_coverage2::_puroro_nested::msg::_puroro_traits::SubmsgTrait
            where Self: 'this;
        fn submsg_required<'this>(&'this self) -> ::std::option::Option<Self::Field51MessageType<'this>> {
            self.submsg_required_opt()
        }
        ...
        type Field52MessageType<'this>: self::_puroro_root::full_coverage2::_puroro_nested::msg::_puroro_traits::SubmsgTrait
            where Self: 'this;
        fn submsg_optional<'this>(&'this self) -> ::std::option::Option<Self::Field52MessageType<'this>> {
            self.submsg_optional_opt()
        }
        ...
        T: MsgTrait,
    {
        ...
        type Field51MessageType<'this> where Self: 'this = T::Field51MessageType<'this>;
        fn submsg_required_opt<'this>(&'this self) -> ::std::option::Option<Self::Field51MessageType<'this>> {
            self.as_ref().and_then(|msg| msg.submsg_required_opt())
        }
        type Field52MessageType<'this> where Self: 'this = T::Field52MessageType<'this>;
        fn submsg_optional_opt<'this>(&'this self) -> ::std::option::Option<Self::Field52MessageType<'this>> {
