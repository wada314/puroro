...
type Field43RepeatedType<'this> = ::puroro::ClonedSlice<'this, self::_puroro_root::full_coverage2::Enum>;
...
impl<'bump> MsgBumpalo<'bump> {
    pub fn new_in(bump: &'bump ::puroro::bumpalo::Bump) -> Self {
        ...
        Self {
            ...
            bytes_required: ::puroro::internal::NoAllocBumpVec::new_in(bump),
            bytes_optional: ::puroro::internal::NoAllocBumpVec::new_in(bump),
            bytes_repeated: ::puroro::internal::NoAllocBumpVec::new_in(bump),
            string_required: ::puroro::internal::NoAllocBumpString::new_in(bump),
    ...
    pub fn bytes_repeated<'this>(&'this self) -> ::puroro::AsRefSlice<'this, ::puroro::internal::NoAllocBumpVec<u8>, [u8] {
        ::puroro::internal::utils::BorrowedIter::new(self.bytes_repeated.iter())
    }
    ...
    pub fn string_repeated<'this>(&'this self) -> ::puroro::AsRefSlice<'this, ::puroro::internal::NoAllocBumpStr, str {
        ::puroro::internal::utils::BorrowedIter::new(self.string_repeated.iter())
    }
    ...
    pub fn enum_repeated<'this>(&'this self) -> self::_puroro_root::full_coverage2::Enum {
    ...
    pub fn submsg_repeated<'this>(&'this self) -> &'this self::_puroro_root::full_coverage2::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'this> {
        let field: &::puroro::internal::NoAllocBumpVec<&'this self::_puroro_root::full_coverage2::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'this>> = unsafe {
    ...
    pub fn i64_repeated<'this>(&'this self) -> i64 {
    ...
    pub fn u32_repeated<'this>(&'this self) -> u32 {
    ...
    pub fn u64_repeated<'this>(&'this self) -> u64 {
    ...
    pub fn s32_repeated<'this>(&'this self) -> i32 {
    ...
    pub fn s64_repeated<'this>(&'this self) -> i64 {
    ...
    pub fn fixed32_repeated<'this>(&'this self) -> u32 {
    ...
    pub fn fixed64_repeated<'this>(&'this self) -> u64 {
    ...
    pub fn sfixed32_repeated<'this>(&'this self) -> i32 {
    ...
    pub fn sfixed64_repeated<'this>(&'this self) -> i64 {
    ...
    pub fn f64_repeated<'this>(&'this self) -> f64 {
...
pub mod _puroro_traits {
    ...
    type Field3RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn i32_repeated<'this>(&'this self) -> Self::Field3RepeatedType<'this> {
        self.as_ref().map(|msg| msg.i32_repeated().into_iter()).into_iter().flatten()
    }
    fn float_required_opt<'this>(&'this self) -> ::std::option::Option<f32> {
    ...
    type Field13RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn float_repeated<'this>(&'this self) -> Self::Field13RepeatedType<'this> {
        self.as_ref().map(|msg| msg.float_repeated().into_iter()).into_iter().flatten()
    }
    fn bytes_required_opt<'this>(&'this self) -> ::std::option::Option<&'this [u8]> {
    ...
    type Field23RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn bytes_repeated<'this>(&'this self) -> Self::Field23RepeatedType<'this> {
        self.as_ref().map(|msg| msg.bytes_repeated().into_iter()).into_iter().flatten()
    }
    fn string_required_opt<'this>(&'this self) -> ::std::option::Option<&'this str> {
    ...
    type Field33RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn string_repeated<'this>(&'this self) -> Self::Field33RepeatedType<'this> {
        self.as_ref().map(|msg| msg.string_repeated().into_iter()).into_iter().flatten()
    }
    fn enum_required_opt<'this>(&'this self) -> ::std::option::Option<self::_puroro_root::full_coverage2::Enum> {
    ...
    type Field43RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn enum_repeated<'this>(&'this self) -> Self::Field43RepeatedType<'this> {
        self.as_ref().map(|msg| msg.enum_repeated().into_iter()).into_iter().flatten()
    }
    ...
    type Field53RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn submsg_repeated<'this>(&'this self) -> Self::Field53RepeatedType<'this> {
        self.as_ref().map(|msg| msg.submsg_repeated().into_iter()).into_iter().flatten()
    }
    fn i64_required_opt<'this>(&'this self) -> ::std::option::Option<i64> {
    ...
    type Field103RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn i64_repeated<'this>(&'this self) -> Self::Field103RepeatedType<'this> {
        self.as_ref().map(|msg| msg.i64_repeated().into_iter()).into_iter().flatten()
    }
    fn u32_required_opt<'this>(&'this self) -> ::std::option::Option<u32> {
    ...
    type Field113RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn u32_repeated<'this>(&'this self) -> Self::Field113RepeatedType<'this> {
        self.as_ref().map(|msg| msg.u32_repeated().into_iter()).into_iter().flatten()
    }
    fn u64_required_opt<'this>(&'this self) -> ::std::option::Option<u64> {
    ...
    type Field123RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn u64_repeated<'this>(&'this self) -> Self::Field123RepeatedType<'this> {
        self.as_ref().map(|msg| msg.u64_repeated().into_iter()).into_iter().flatten()
    }
    fn s32_required_opt<'this>(&'this self) -> ::std::option::Option<i32> {
    ...
    type Field133RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn s32_repeated<'this>(&'this self) -> Self::Field133RepeatedType<'this> {
        self.as_ref().map(|msg| msg.s32_repeated().into_iter()).into_iter().flatten()
    }
    fn s64_required_opt<'this>(&'this self) -> ::std::option::Option<i64> {
    ...
    type Field143RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn s64_repeated<'this>(&'this self) -> Self::Field143RepeatedType<'this> {
        self.as_ref().map(|msg| msg.s64_repeated().into_iter()).into_iter().flatten()
    }
    fn fixed32_required_opt<'this>(&'this self) -> ::std::option::Option<u32> {
    ...
    type Field153RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn fixed32_repeated<'this>(&'this self) -> Self::Field153RepeatedType<'this> {
        self.as_ref().map(|msg| msg.fixed32_repeated().into_iter()).into_iter().flatten()
    }
    fn fixed64_required_opt<'this>(&'this self) -> ::std::option::Option<u64> {
    ...
    type Field163RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn fixed64_repeated<'this>(&'this self) -> Self::Field163RepeatedType<'this> {
        self.as_ref().map(|msg| msg.fixed64_repeated().into_iter()).into_iter().flatten()
    }
    fn sfixed32_required_opt<'this>(&'this self) -> ::std::option::Option<i32> {
    ...
    type Field173RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn sfixed32_repeated<'this>(&'this self) -> Self::Field173RepeatedType<'this> {
        self.as_ref().map(|msg| msg.sfixed32_repeated().into_iter()).into_iter().flatten()
    }
    fn sfixed64_required_opt<'this>(&'this self) -> ::std::option::Option<i64> {
    ...
    type Field183RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn sfixed64_repeated<'this>(&'this self) -> Self::Field183RepeatedType<'this> {
        self.as_ref().map(|msg| msg.sfixed64_repeated().into_iter()).into_iter().flatten()
    }
    fn f64_required_opt<'this>(&'this self) -> ::std::option::Option<f64> {
    ...
    type Field193RepeatedType<'this> where Self: 'this =
        ...
        >;
    fn f64_repeated<'this>(&'this self) -> Self::Field193RepeatedType<'this> {
        self.as_ref().map(|msg| msg.f64_repeated().into_iter()).into_iter().flatten()
    }
    }
}
