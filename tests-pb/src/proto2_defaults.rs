...
pub mod _puroro_simple_impl {
    ...
    impl Msg {
        ...
        pub fn i32_default(&self) -> i32 {
            self.i32_default_opt().unwrap_or(0)
        }
        ...
        pub fn u32_default(&self) -> u32 {
            self.u32_default_opt().unwrap_or(0)
        }
        ...
        pub fn i64_default(&self) -> i64 {
            self.i64_default_opt().unwrap_or(0)
        }
        ...
        pub fn u64_default(&self) -> u64 {
            self.u64_default_opt().unwrap_or(0)
        }
        ...
        pub fn f32_default(&self) -> f32 {
            self.f32_default_opt().unwrap_or(0.0f32)
        }
        ...
        pub fn bool_default(&self) -> bool {
            self.bool_default_opt().unwrap_or(false)
        }
        ...
        pub fn bytes_default(&self) -> &'_ [u8] {
            self.bytes_default_opt().unwrap_or(b"")
        }
