...
impl ::puroro::internal::FieldProperties for MsgFieldProperties<3> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Int32;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = 42;
}
...
impl ::puroro::internal::FieldProperties for MsgFieldProperties<5> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Int32;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = 2147483647;
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<6> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Int32;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = -2147483648;
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<7> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Int32;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = 83;
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<8> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Int32;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = 291;
}
...
impl ::puroro::internal::FieldProperties for MsgFieldProperties<15> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::UInt32;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = 4294967295;
}
...
impl ::puroro::internal::FieldProperties for MsgFieldProperties<25> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Int64;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = 9223372036854775807;
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<26> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Int64;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = -9223372036854775808;
}
...
impl ::puroro::internal::FieldProperties for MsgFieldProperties<35> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::UInt64;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = 18446744073709551615;
}
...
impl ::puroro::internal::FieldProperties for MsgFieldProperties<42> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Float;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = 0f32;
}
...
impl ::puroro::internal::FieldProperties for MsgFieldProperties<47> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Float;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = 42f32;
}
...
impl ::puroro::internal::FieldProperties for MsgFieldProperties<49> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Float;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = 0.25f32;
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<50> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Float;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = 150f32;
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<51> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Float;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = f32::INFINITY;
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<52> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Float;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = f32::NEG_INFINITY;
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<53> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Float;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = f32::NAN;
}
...
impl ::puroro::internal::FieldProperties for MsgFieldProperties<62> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Bool;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = true;
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<63> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Bool;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = false;
}
...
impl ::puroro::internal::FieldProperties for MsgFieldProperties<73> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::String;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = "abc";
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<74> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::String;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = "\u{3042}\u{3044}\u{3046}";
}
...
impl ::puroro::internal::FieldProperties for MsgFieldProperties<82> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Bytes;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = b"";
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<83> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Bytes;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = b"\x61\x62\x63";
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<84> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Bytes;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = b"\xe3\x81\x82\xe3\x81\x84\xe3\x81\x86";
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<85> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Bytes;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = b"\x5c";
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<86> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Bytes;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = b"\x09";
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<87> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Bytes;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = b"\x0d\x0a";
}
...
impl ::puroro::internal::FieldProperties for MsgFieldProperties<92> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Enum2<self::_puroro_root::proto2_defaults::MyEnum>;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = self::_puroro_root::proto2_defaults::MyEnum::One;
}
impl ::puroro::internal::FieldProperties for MsgFieldProperties<93> {
    ...
    type LabelTag = ::puroro::tags::Optional;
    type TypeTag = ::puroro::tags::Enum2<self::_puroro_root::proto2_defaults::MyEnum>;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = self::_puroro_root::proto2_defaults::MyEnum::FourtyTwo;
}
