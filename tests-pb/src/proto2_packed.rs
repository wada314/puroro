...
type ExplicitlyPackedRepeatedType<'this> where Self: 'this =
    ::puroro::CloneThenIntoRepeatedField<
        'this,
        RepeatedType,
        ScalarType,
...
fn explicitly_packed<'this>(&'this self) -> Self::ExplicitlyPackedRepeatedType<'this> {
    ...
    type ExplicitlyNotPackedRepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<i32>;
    fn explicitly_not_packed<'this>(&'this self) -> Self::ExplicitlyNotPackedRepeatedType<'this> {
        ::puroro::internal::impls::empty::EmptyRepeatedField::new()
    }
    type NotAnnotatedRepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<i32>;
    fn not_annotated<'this>(&'this self) -> Self::NotAnnotatedRepeatedType<'this> {
        ::puroro::internal::impls::empty::EmptyRepeatedField::new()
    }
}
...
for <'a> &'a RepeatedType: ::puroro::RepeatedField<'a> + 
    ::std::iter::IntoIterator<Item = &'a ScalarType>,
{
    type ExplicitlyPackedRepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<i32>;
    fn explicitly_packed<'this>(&'this self) -> Self::ExplicitlyPackedRepeatedType<'this> {
        ::puroro::internal::impls::empty::EmptyRepeatedField::new()
    }

type ExplicitlyNotPackedRepeatedType<'this> where Self: 'this =
    ::puroro::CloneThenIntoRepeatedField<
        'this,
        RepeatedType,
        ScalarType,
...
type NotAnnotatedRepeatedType<'this> where Self: 'this =
    ::puroro::CloneThenIntoRepeatedField<
        'this,
        RepeatedType,
        ScalarType,
...
impl<'bump> MsgBumpalo<'bump> {
    ...
    pub fn explicitly_packed_mut<'this>(&'this mut self) -> ::puroro::internal::RefMutBumpVec<'bump, 'this, i32> {
        unsafe { self.explicitly_packed.as_mut_vec_in(self._bump) }
    }
    pub fn explicitly_not_packed_mut<'this>(&'this mut self) -> ::puroro::internal::RefMutBumpVec<'bump, 'this, i32> {
        unsafe { self.explicitly_not_packed.as_mut_vec_in(self._bump) }
    }
    pub fn not_annotated_mut<'this>(&'this mut self) -> ::puroro::internal::RefMutBumpVec<'bump, 'this, i32> {
    ...
    T: MsgTrait
{
    ...
    pub fn append_explicitly_packed<ScalarType, RepeatedType>(self, value: RepeatedType)
...
for <'a> &'a RepeatedType: ::puroro::RepeatedField<'a> + 
    ::std::iter::IntoIterator<Item = &'a ScalarType>,
    {
        MsgBuilder((self.0, MsgSingleField1 { explicitly_packed: value}))
    }

    pub fn append_explicitly_not_packed<ScalarType, RepeatedType>(self, value: RepeatedType)
...
for <'a> &'a RepeatedType: ::puroro::RepeatedField<'a> + 
    ::std::iter::IntoIterator<Item = &'a ScalarType>,
    {
        MsgBuilder((self.0, MsgSingleField2 { explicitly_not_packed: value}))
    }

    pub fn append_not_annotated<ScalarType, RepeatedType>(self, value: RepeatedType)
...
for <'a> &'a RepeatedType: ::puroro::RepeatedField<'a> + 
    ::std::iter::IntoIterator<Item = &'a ScalarType>,
    {
        MsgBuilder((self.0, MsgSingleField3 { not_annotated: value}))
    }
...
pub mod _puroro_traits {
    ...
    macro_rules! msg_delegate {
        ($ty:ty) => {
            ...
            type ExplicitlyPackedRepeatedType<'this> where Self: 'this = <$ty>::ExplicitlyPackedRepeatedType<'this>;
            fn explicitly_packed<'this>(&'this self) -> Self::ExplicitlyPackedRepeatedType<'this> {
                (**self).explicitly_packed()
            }
    
            type ExplicitlyNotPackedRepeatedType<'this> where Self: 'this = <$ty>::ExplicitlyNotPackedRepeatedType<'this>;
            fn explicitly_not_packed<'this>(&'this self) -> Self::ExplicitlyNotPackedRepeatedType<'this> {
                (**self).explicitly_not_packed()
            }
    
            type NotAnnotatedRepeatedType<'this> where Self: 'this = <$ty>::NotAnnotatedRepeatedType<'this>;
            fn not_annotated<'this>(&'this self) -> Self::NotAnnotatedRepeatedType<'this> {
                (**self).not_annotated()
            }
        };
        ...
        U: MsgTrait,
    {
        ...
        fn explicitly_packed<'this>(&'this self) -> Self::ExplicitlyPackedRepeatedType<'this>
        {
            ::puroro::internal::impls::either::EitherRepeatedField::new(self
                .as_ref()
                .map_left(
                    |t| <T as MsgTrait>::explicitly_packed(t)
                )
                .map_right(
                    |u| <U as MsgTrait>::explicitly_packed(u)
                )
            )
        }
        type ExplicitlyNotPackedRepeatedType<'this> where Self: 'this
        ...
        fn explicitly_not_packed<'this>(&'this self) -> Self::ExplicitlyNotPackedRepeatedType<'this>
        {
            ::puroro::internal::impls::either::EitherRepeatedField::new(self
                .as_ref()
                .map_left(
                    |t| <T as MsgTrait>::explicitly_not_packed(t)
                )
                .map_right(
                    |u| <U as MsgTrait>::explicitly_not_packed(u)
                )
            )
        }
        type NotAnnotatedRepeatedType<'this> where Self: 'this
        ...
        fn not_annotated<'this>(&'this self) -> Self::NotAnnotatedRepeatedType<'this>
        {
            ::puroro::internal::impls::either::EitherRepeatedField::new(self
                .as_ref()
                .map_left(
                    |t| <T as MsgTrait>::not_annotated(t)
                )
                .map_right(
                    |u| <U as MsgTrait>::not_annotated(u)
                )
            )
        }
        ...
        T: MsgTrait,
    {
        ...
        type ExplicitlyPackedRepeatedType<'this> where Self: 'this =
            ::puroro::internal::impls::option::OptionRepeatedField<T::ExplicitlyPackedRepeatedType<'this>>;
        fn explicitly_packed<'this>(&'this self) -> Self::ExplicitlyPackedRepeatedType<'this> {
            ::puroro::internal::impls::option::OptionRepeatedField::new(self.as_ref().map(|msg| msg.explicitly_packed()))
        }
    
        type ExplicitlyNotPackedRepeatedType<'this> where Self: 'this =
            ::puroro::internal::impls::option::OptionRepeatedField<T::ExplicitlyNotPackedRepeatedType<'this>>;
        fn explicitly_not_packed<'this>(&'this self) -> Self::ExplicitlyNotPackedRepeatedType<'this> {
            ::puroro::internal::impls::option::OptionRepeatedField::new(self.as_ref().map(|msg| msg.explicitly_not_packed()))
        }
    
        type NotAnnotatedRepeatedType<'this> where Self: 'this =
            ::puroro::internal::impls::option::OptionRepeatedField<T::NotAnnotatedRepeatedType<'this>>;
        fn not_annotated<'this>(&'this self) -> Self::NotAnnotatedRepeatedType<'this> {
            ::puroro::internal::impls::option::OptionRepeatedField::new(self.as_ref().map(|msg| msg.not_annotated()))
        }
    }
}
