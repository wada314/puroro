...
impl self::_puroro::internal::oneof_type::OneofUnion for GroupOne {
    ...
    fn case_ref<B: self::_puroro::bitvec::BitSlice>(
        ...
        let case_opt = <_puroro_root::oneofs3::msg::GroupOneCase as OneofCase>::from_bitslice(bits);
        ...
        match case {
            Self::Case::G1Int32 => {
                ...
                <self::_puroro::internal::oneof_field_type::NumericalField<
                    i32,
                    self::_puroro::tags::Int32,
                > as OneofFieldType>::deser_from_iter(
                    unsafe { &mut self.g1_int32 }, field_data
                )?;
            }
            Self::Case::G1String => {
                let _ = <Self>::g1_string_mut(self, bitvec);
                <self::_puroro::internal::oneof_field_type::StringField as OneofFieldType>::deser_from_iter(
...
impl GroupTwo {
    ...
    pub(crate) fn g2_submsg_mut<B: self::_puroro::bitvec::BitSlice>(
        &mut self,
        bits: &mut B,
    ) -> &mut _puroro_root::oneofs3::Submsg {
        use self::_puroro::internal::oneof_field_type::OneofFieldType;
        use self::_puroro::internal::oneof_type::{OneofCase, OneofUnion};
        use ::std::mem::ManuallyDrop;
        #[allow(unused)]
...
impl self::_puroro::internal::oneof_type::OneofUnion for GroupTwo {
    ...
    fn case_ref<B: self::_puroro::bitvec::BitSlice>(
        ...
        use self::_puroro::internal::oneof_type::{OneofCase, OneofCaseRef};
        let case_opt = <_puroro_root::oneofs3::msg::GroupTwoCase as OneofCase>::from_bitslice(bits);
        case_opt.map(|case| OneofCaseRef::from_union_and_case(self, case))
    }
        ...
        match case {
            Self::Case::G2F32 => {
                ...
                <self::_puroro::internal::oneof_field_type::NumericalField<
                    ...
                    self::_puroro::tags::Float,
                > as OneofFieldType>::deser_from_iter(
                    unsafe { &mut self.g2_f32 }, field_data
                )?;
            }
            Self::Case::G2String => {
            ...
            Self::Case::G2Submsg => {
                ...
                <self::_puroro::internal::oneof_field_type::HeapMessageField<
                    _puroro_root::oneofs3::Submsg,
                > as OneofFieldType>::deser_from_iter(
                    unsafe { &mut self.g2_submsg }, field_data
                )?;
            }
        }
        Ok(())
...
impl self::_puroro::internal::oneof_type::OneofUnion for GroupThree {
    ...
    fn case_ref<B: self::_puroro::bitvec::BitSlice>(
        ...
        use self::_puroro::internal::oneof_type::{OneofCase, OneofCaseRef};
        let case_opt =
            <_puroro_root::oneofs3::msg::GroupThreeCase as OneofCase>::from_bitslice(bits);
        case_opt.map(|case| OneofCaseRef::from_union_and_case(self, case))
    }
        ...
        match case {
            Self::Case::G3Int32 => {
                ...
                <self::_puroro::internal::oneof_field_type::NumericalField<
                    ...
                    self::_puroro::tags::Int32,
                > as OneofFieldType>::deser_from_iter(
                    unsafe { &mut self.g3_int32 }, field_data
                )?;
            }
        }
        Ok(())
