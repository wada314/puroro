...
pub mod _puroro_simple_impl {
    ...
    impl Msg {
        ...
        pub fn i32_unlabeled(&self) -> i32 {
            self.i32_unlabeled_opt().unwrap_or(0)
        }
        ...
        pub fn float_unlabeled(&self) -> f32 {
            self.float_unlabeled_opt().unwrap_or(0.0f32)
        }
        ...
        pub fn bytes_unlabeled(&self) -> &'_ [u8] {
            self.bytes_unlabeled_opt().unwrap_or(b"")
        }
        ...
        pub fn enum_unlabeled(&self) -> self::_puroro_root::full_coverage3::Enum {
            self.enum_unlabeled_opt()
                .unwrap_or(self::_puroro_root::full_coverage3::Enum::Zeroth)
        }
        ...
        pub fn i64_unlabeled(&self) -> i64 {
            self.i64_unlabeled_opt().unwrap_or(0)
        }
        ...
        pub fn u32_unlabeled(&self) -> u32 {
            self.u32_unlabeled_opt().unwrap_or(0)
        }
        ...
        pub fn u64_unlabeled(&self) -> u64 {
            self.u64_unlabeled_opt().unwrap_or(0)
        }
        ...
        pub fn s32_unlabeled(&self) -> i32 {
            self.s32_unlabeled_opt().unwrap_or(0)
        }
        ...
        pub fn s64_unlabeled(&self) -> i64 {
            self.s64_unlabeled_opt().unwrap_or(0)
        }
        ...
        pub fn fixed32_unlabeled(&self) -> u32 {
            self.fixed32_unlabeled_opt().unwrap_or(0)
        }
        ...
        pub fn fixed64_unlabeled(&self) -> u64 {
            self.fixed64_unlabeled_opt().unwrap_or(0)
        }
        ...
        pub fn sfixed32_unlabeled(&self) -> i32 {
            self.sfixed32_unlabeled_opt().unwrap_or(0)
        }
        ...
        pub fn sfixed64_unlabeled(&self) -> i64 {
            self.sfixed64_unlabeled_opt().unwrap_or(0)
        }
        ...
        pub fn f64_unlabeled(&self) -> f64 {
            self.f64_unlabeled_opt().unwrap_or(0.0f64)
        }
