    ...
    BT: ::puroro::internal::impls::bumpalo::BumpTypes + ::std::fmt::Debug + ::std::cmp::PartialEq,
{
            ...
            + ::std::cmp::PartialEq,
    {
        ...
        pub fn enum_repeated<'this>(
            &'this self,
        ) -> impl 'this + ::std::iter::Iterator<Item = self::_puroro_root::full_coverage3::Enum>
        {
        ...
        pub fn submsg_unlabeled<'this>(&'this self) -> ::std::option::Option<&'this self::_puroro_root::full_coverage3::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<BT::ChildsBumpTypes<'this>>>{
        ...
        pub fn submsg_optional<'this>(&'this self) -> ::std::option::Option<&'this self::_puroro_root::full_coverage3::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<BT::ChildsBumpTypes<'this>>>{
