    ...
    Self: super::_puroro_traits::MsgTrait,
{
        ...
        W: ::std::io::Write,
    {
        ...
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::Unlabeled, ::puroro::tags::Message<<Self as super::_puroro_traits::MsgTrait>::Field51MessageType<'_>>
        >::ser_field(
...
fn submsg_unlabeled_opt<'this>(&'this self) -> ::std::option::Option<Self::Field51MessageType<'this>> {
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        ...
        type Field51MessageType<'this>: self::_puroro_root::full_coverage3::_puroro_nested::msg::_puroro_traits::SubmsgTrait +
            ::puroro::Message<self::_puroro_root::full_coverage3::_puroro_nested::msg::_puroro_simple_impl::Submsg>
            where Self: 'this;
        fn submsg_unlabeled_opt<'this>(&'this self) -> ::std::option::Option<Self::Field51MessageType<'this>> {
            ::std::option::Option::None
        }
        ...
        U: MsgTrait,
    {
        ...
        fn i32_unlabeled<'this>(&'this self) -> i32 {
            self.i32_unlabeled_opt().unwrap_or_else(|| self.1.i32_unlabeled() )
        }
        fn i32_optional_opt<'this>(&'this self) -> Option<i32>
        {
        ...
        fn float_unlabeled<'this>(&'this self) -> f32 {
            self.float_unlabeled_opt().unwrap_or_else(|| self.1.float_unlabeled() )
        }
        fn float_optional_opt<'this>(&'this self) -> Option<f32>
        {
        ...
        fn bytes_unlabeled<'this>(&'this self) -> &'this [u8] {
            self.bytes_unlabeled_opt().unwrap_or_else(|| self.1.bytes_unlabeled() )
        }
        fn bytes_optional_opt<'this>(&'this self) -> Option<&'this [u8]>
        {
        ...
        fn string_unlabeled<'this>(&'this self) -> &'this str {
            self.string_unlabeled_opt().unwrap_or_else(|| self.1.string_unlabeled() )
        }
        fn string_optional_opt<'this>(&'this self) -> Option<&'this str>
        {
        ...
        fn enum_unlabeled<'this>(&'this self) -> self::_puroro_root::full_coverage3::Enum {
            self.enum_unlabeled_opt().unwrap_or_else(|| self.1.enum_unlabeled() )
        }
        fn enum_optional_opt<'this>(&'this self) -> Option<self::_puroro_root::full_coverage3::Enum>
        {
        ...
        fn submsg_unlabeled_opt<'this>(&'this self) -> Option<Self::Field51MessageType<'this>>
        {
            if <T as MsgTrait>::has_submsg_unlabeled(&self.0) ||
                <U as MsgTrait>::has_submsg_unlabeled(&self.1)
            {
                Some((
        ...
        fn i64_unlabeled<'this>(&'this self) -> i64 {
            self.i64_unlabeled_opt().unwrap_or_else(|| self.1.i64_unlabeled() )
        }
        fn i64_optional_opt<'this>(&'this self) -> Option<i64>
        {
        ...
        fn u32_unlabeled<'this>(&'this self) -> u32 {
            self.u32_unlabeled_opt().unwrap_or_else(|| self.1.u32_unlabeled() )
        }
        fn u32_optional_opt<'this>(&'this self) -> Option<u32>
        {
        ...
        fn u64_unlabeled<'this>(&'this self) -> u64 {
            self.u64_unlabeled_opt().unwrap_or_else(|| self.1.u64_unlabeled() )
        }
        fn u64_optional_opt<'this>(&'this self) -> Option<u64>
        {
        ...
        fn s32_unlabeled<'this>(&'this self) -> i32 {
            self.s32_unlabeled_opt().unwrap_or_else(|| self.1.s32_unlabeled() )
        }
        fn s32_optional_opt<'this>(&'this self) -> Option<i32>
        {
        ...
        fn s64_unlabeled<'this>(&'this self) -> i64 {
            self.s64_unlabeled_opt().unwrap_or_else(|| self.1.s64_unlabeled() )
        }
        fn s64_optional_opt<'this>(&'this self) -> Option<i64>
        {
        ...
        fn fixed32_unlabeled<'this>(&'this self) -> u32 {
            self.fixed32_unlabeled_opt().unwrap_or_else(|| self.1.fixed32_unlabeled() )
        }
        fn fixed32_optional_opt<'this>(&'this self) -> Option<u32>
        {
        ...
        fn fixed64_unlabeled<'this>(&'this self) -> u64 {
            self.fixed64_unlabeled_opt().unwrap_or_else(|| self.1.fixed64_unlabeled() )
        }
        fn fixed64_optional_opt<'this>(&'this self) -> Option<u64>
        {
        ...
        fn sfixed32_unlabeled<'this>(&'this self) -> i32 {
            self.sfixed32_unlabeled_opt().unwrap_or_else(|| self.1.sfixed32_unlabeled() )
        }
        fn sfixed32_optional_opt<'this>(&'this self) -> Option<i32>
        {
        ...
        fn sfixed64_unlabeled<'this>(&'this self) -> i64 {
            self.sfixed64_unlabeled_opt().unwrap_or_else(|| self.1.sfixed64_unlabeled() )
        }
        fn sfixed64_optional_opt<'this>(&'this self) -> Option<i64>
        {
        ...
        fn f64_unlabeled<'this>(&'this self) -> f64 {
            self.f64_unlabeled_opt().unwrap_or_else(|| self.1.f64_unlabeled() )
        }
        fn f64_optional_opt<'this>(&'this self) -> Option<f64>
        {
        ...
        U: MsgTrait,
    {
        ...
        fn bytes_unlabeled<'this>(&'this self) -> &'this [u8] {
            self.as_ref().either(
                |t| <T as MsgTrait>::bytes_unlabeled(t),
                |u| <U as MsgTrait>::bytes_unlabeled(u),
            )
        }
        fn bytes_optional_opt<'this>(&'this self) -> ::std::option::Option<&'this [u8]>
        {
        ...
        fn submsg_unlabeled<'this>(&'this self) -> Self::Field51MessageType<'this> {
            self.as_ref().either(
                |t| ::puroro::Either::Left(<T as MsgTrait>::submsg_unlabeled(t)),
                |u| ::puroro::Either::Right(<U as MsgTrait>::submsg_unlabeled(u)),
            )
        }
        ...
        T: MsgTrait,
    {
        ...
        fn i32_unlabeled<'this>(&'this self) -> i32 {
            self.as_ref().map_or(, |msg| msg.i32_unlabeled())
        }
        fn i32_optional_opt<'this>(&'this self) -> ::std::option::Option<i32> {
        ...
        fn float_unlabeled<'this>(&'this self) -> f32 {
            self.as_ref().map_or(, |msg| msg.float_unlabeled())
        }
        fn float_optional_opt<'this>(&'this self) -> ::std::option::Option<f32> {
        ...
        fn bytes_unlabeled<'this>(&'this self) -> &'this [u8] {
            self.as_ref().map_or(, |msg| msg.bytes_unlabeled())
        }
        fn bytes_optional_opt<'this>(&'this self) -> ::std::option::Option<&'this [u8]> {
        ...
        fn string_unlabeled<'this>(&'this self) -> &'this str {
            self.as_ref().map_or(, |msg| msg.string_unlabeled())
        }
        fn string_optional_opt<'this>(&'this self) -> ::std::option::Option<&'this str> {
        ...
        fn enum_unlabeled<'this>(&'this self) -> self::_puroro_root::full_coverage3::Enum {
            self.as_ref().map_or(, |msg| msg.enum_unlabeled())
        }
        fn enum_optional_opt<'this>(&'this self) -> ::std::option::Option<self::_puroro_root::full_coverage3::Enum> {
        ...
        fn i64_unlabeled<'this>(&'this self) -> i64 {
            self.as_ref().map_or(, |msg| msg.i64_unlabeled())
        }
        fn i64_optional_opt<'this>(&'this self) -> ::std::option::Option<i64> {
        ...
        fn u32_unlabeled<'this>(&'this self) -> u32 {
            self.as_ref().map_or(, |msg| msg.u32_unlabeled())
        }
        fn u32_optional_opt<'this>(&'this self) -> ::std::option::Option<u32> {
        ...
        fn u64_unlabeled<'this>(&'this self) -> u64 {
            self.as_ref().map_or(, |msg| msg.u64_unlabeled())
        }
        fn u64_optional_opt<'this>(&'this self) -> ::std::option::Option<u64> {
        ...
        fn s32_unlabeled<'this>(&'this self) -> i32 {
            self.as_ref().map_or(, |msg| msg.s32_unlabeled())
        }
        fn s32_optional_opt<'this>(&'this self) -> ::std::option::Option<i32> {
        ...
        fn s64_unlabeled<'this>(&'this self) -> i64 {
            self.as_ref().map_or(, |msg| msg.s64_unlabeled())
        }
        fn s64_optional_opt<'this>(&'this self) -> ::std::option::Option<i64> {
        ...
        fn fixed32_unlabeled<'this>(&'this self) -> u32 {
            self.as_ref().map_or(, |msg| msg.fixed32_unlabeled())
        }
        fn fixed32_optional_opt<'this>(&'this self) -> ::std::option::Option<u32> {
        ...
        fn fixed64_unlabeled<'this>(&'this self) -> u64 {
            self.as_ref().map_or(, |msg| msg.fixed64_unlabeled())
        }
        fn fixed64_optional_opt<'this>(&'this self) -> ::std::option::Option<u64> {
        ...
        fn sfixed32_unlabeled<'this>(&'this self) -> i32 {
            self.as_ref().map_or(, |msg| msg.sfixed32_unlabeled())
        }
        fn sfixed32_optional_opt<'this>(&'this self) -> ::std::option::Option<i32> {
        ...
        fn sfixed64_unlabeled<'this>(&'this self) -> i64 {
            self.as_ref().map_or(, |msg| msg.sfixed64_unlabeled())
        }
        fn sfixed64_optional_opt<'this>(&'this self) -> ::std::option::Option<i64> {
        ...
        fn f64_unlabeled<'this>(&'this self) -> f64 {
            self.as_ref().map_or(, |msg| msg.f64_unlabeled())
        }
        fn f64_optional_opt<'this>(&'this self) -> ::std::option::Option<f64> {
