...
pub struct Msg {
    ...
    submsg_unlabeled: ::std::option::Option<::std::boxed::Box<self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_simple_impl::Submsg>>,
    submsg_repeated: ::std::vec::Vec<self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_simple_impl::Submsg>,
...
impl Msg {
    ...
    pub fn submsg_unlabeled_mut(&mut self) -> &mut ::std::option::Option<::std::boxed::Box<self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_simple_impl::Submsg>> {
        &mut self.submsg_unlabeled
    }
    pub fn submsg_repeated_mut(&mut self) -> &mut ::std::vec::Vec<self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_simple_impl::Submsg> {
        &mut self.submsg_repeated
    }
    pub fn enum_unlabeled_mut(&mut self) -> &mut self::_puroro_root::ser_tests3::Enum {
        &mut self.enum_unlabeled
    }
    pub fn enum_repeated_mut(&mut self) -> &mut ::std::vec::Vec<self::_puroro_root::ser_tests3::Enum> {
...
type Field7ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_simple_impl::Submsg;
...
{
    static DEFAULT_VALUE: ::puroro::once_cell::sync::Lazy< self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_simple_impl::Submsg
    > = ::puroro::once_cell::sync::Lazy::new(|| { ::std::default::Default::default()
    });

    &DEFAULT_VALUE
}
type Field8ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_simple_impl::Submsg;
    ...
    Self: super::_puroro_traits::MsgTrait,
{
        ...
        W: ::std::io::Write,
    {
        ...
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::Unlabeled, ::puroro::tags::Message<<Self as super::_puroro_traits::MsgTrait>::Field7ScalarGetterType<'_>>
        >::ser_field(
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        f.debug_struct("Msg")
            ...
            .field("enum_repeated", &<Self as super::_puroro_traits::MsgTrait>::enum_repeated(self)
                .into_iter()
                .collect::<::std::vec::Vec<_>>())
            .field("very_large_field_number", &<Self as super::_puroro_traits::MsgTrait>::very_large_field_number(self))
            .finish()
    }
}
    ...
    ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    ...
    fn string_unlabeled_default_value<'this>(&'this self) -> Self::Field5ScalarGetterType<'this> {
    ...
    fn submsg_unlabeled_default_value<'this>(&'this self) -> Self::Field7ScalarGetterType<'this> {
    ...
    fn enum_unlabeled_default_value<'this>(&'this self) -> self::_puroro_root::ser_tests3::Enum {
...
where
ScalarType: self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_traits::SubmsgTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
...
ScalarType: self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_traits::SubmsgTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    ...
    fn submsg_unlabeled_opt<'this>(&'this self) -> ::std::option::Option<Self::Field7ScalarGetterType<'this>> {
...
pub struct MsgBumpalo<'bump> {
    ...
    submsg_unlabeled: ::std::option::Option<::puroro::internal::NoAllocBumpBox<self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'bump>>>,
    submsg_repeated: ::puroro::internal::NoAllocBumpVec<self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'bump>>,
...
impl<'bump> MsgBumpalo<'bump> {
    ...
    pub fn enum_unlabeled_opt<'this>(&'this self) -> ::std::option::Option<self::_puroro_root::ser_tests3::Enum> {
    ...
    pub fn submsg_repeated_mut<'this>(&'this mut self) -> ::puroro::internal::RefMutBumpVec<'bump, 'this, self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'bump>> {
    ...
    pub fn enum_unlabeled_mut<'this>(&'this mut self) -> &'this mut self::_puroro_root::ser_tests3::Enum {
        if !self.has_enum_unlabeled() {
            self.enum_unlabeled = ::std::default::Default::default();
        }
        &mut self.enum_unlabeled
    }
    pub fn enum_repeated_mut<'this>(&'this mut self) -> ::puroro::internal::RefMutBumpVec<'bump, 'this, self::_puroro_root::ser_tests3::Enum> {
...
type Field7ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'this>
;
fn submsg_unlabeled_opt<'this>(&'this self) -> Option<Self::Field7ScalarGetterType<'this>> {
    <Self>::submsg_unlabeled_opt(self)
}
type Field8ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'this>
;
...
type Field10RepeatedType<'this> where Self: 'this =
    ::puroro::CloneThenIntoRepeatedField<'this, ::puroro::internal::NoAllocBumpVec<self::_puroro_root::ser_tests3::Enum>, self::_puroro_root::ser_tests3::Enum, self::_puroro_root::ser_tests3::Enum>;
...
ScalarType: ::std::convert::Into<f32> +
    ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MsgBuilder((self.0, MsgSingleField3 { float_unlabeled: value}))
    }
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MsgBuilder((self.0, MsgSingleField5 { string_unlabeled: value}))
    }
...
ScalarType: self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_traits::SubmsgTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MsgBuilder((self.0, MsgSingleField7 { submsg_unlabeled: value}))
    }
...
ScalarType: ::std::convert::Into<self::_puroro_root::ser_tests3::Enum> +
    ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MsgBuilder((self.0, MsgSingleField9 { enum_unlabeled: value}))
    }
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        ...
        type Field7ScalarGetterType<'this>: self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_traits::SubmsgTrait
            where Self: 'this;
        ...
        type Field8ScalarGetterType<'this>: self::_puroro_root::ser_tests3::_puroro_nested::msg::_puroro_traits::SubmsgTrait
            where Self: 'this;
