...
pub struct Test3 {
    _bitfield: ::puroro::bitvec::array::BitArray<
        ...
        [u32; (0 + 31) / 32],
    >,
    c: ::std::option::Option<::std::boxed::Box<self::_puroro_root::official_samples2::_puroro_simple_impl::Test1>>,
}
...
impl Test3 {
    ...
    pub fn c_opt(&self) -> ::std::option::Option<&'_ self::_puroro_root::official_samples2::_puroro_simple_impl::Test1> {
        self.c.as_deref()
    }
    ...
    pub fn c(&self) -> ::std::option::Option<&'_ self::_puroro_root::official_samples2::_puroro_simple_impl::Test1> {
        self.c_opt()
    }
    pub fn clear_c(&mut self) {
        self.c = ::std::default::Default::default();
    }
    pub fn c_mut(&mut self) -> &'_ mut self::_puroro_root::official_samples2::_puroro_simple_impl::Test1 {
        if !self.has_c() {
            self.c = ::std::default::Default::default();
        }
...
type CMessageType<'this> where Self: 'this = &'this self::_puroro_root::official_samples2::_puroro_simple_impl::Test1;
...
impl ::puroro::internal::de::DeserMessageFromBytesIter for Test3 {
        ...
        I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>
    {
        ...
        match field_number {
            3 => {
                DeserFieldFromBytesIter::<
                    ::puroro::tags::Optional, ::puroro::tags::Message<::std::boxed::Box<self::_puroro_root::official_samples2::_puroro_simple_impl::Test1>>
    ...
    Self: super::_puroro_traits::Test3Trait,
{
    ...
    {
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::Optional, ::puroro::tags::Message<<Self as super::_puroro_traits::Test3Trait>::CMessageType<'_>>
        >::ser_field(
...
ScalarType:
    self::_puroro_root::official_samples2::_puroro_traits::Test1Trait,
{
    pub c: ScalarType,
}
...
pub struct Test3Bumpalo<'bump> {
    ...
    _bitfield: ::puroro::bitvec::array::BitArray<
        ...
        [u32; (0 + 31) / 32],
    >,
    c: ::std::option::Option<::puroro::internal::NoAllocBumpBox<self::_puroro_root::official_samples2::_puroro_impls::Test1Bumpalo<'bump>>>,
}
...
impl<'bump> Test3Bumpalo<'bump> {
    ...
    pub fn c_opt<'this>(&'this self) -> ::std::option::Option<&'this self::_puroro_root::official_samples2::_puroro_impls::Test1Bumpalo<'this>> {
        self.c.as_ref().map(|x| unsafe { ::std::mem::transmute(::std::ops::Deref::deref(x)) })
    }
    pub fn c<'this>(&'this self) -> ::std::option::Option<&'this self::_puroro_root::official_samples2::_puroro_impls::Test1Bumpalo<'this>> {
        self.c_opt()
    }
    ...
    pub fn c_mut<'this>(&'this mut self) -> &'this mut self::_puroro_root::official_samples2::_puroro_impls::Test1Bumpalo<'bump> {
        if !self.has_c() {
            self.c = ::std::default::Default::default();
        }
        let bump = self._bump;
...
type CMessageType<'this> where Self: 'this = &'this self::_puroro_root::official_samples2::_puroro_impls::Test1Bumpalo<'this>;
fn c_opt<'this>(&'this self) -> Option<Self::CMessageType<'this>> {
    <Self>::c_opt(self)
}
}
...
impl<'bump> ::puroro::internal::de::DeserMessageFromBytesIter for Test3Bumpalo<'bump> {
        ...
        I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>
    {
        ...
        match field_number {
            3 => {
                DeserFieldFromBytesIter::<
                    ::puroro::tags::Optional, ::puroro::tags::Message<::puroro::internal::NoAllocBumpBox<self::_puroro_root::official_samples2::_puroro_impls::Test1Bumpalo<'bump>>>
...
impl Test3TemplateFieldTypes for ::puroro::SimpleImpl {
    type Alloc = ();
    type CType = ::std::option::Option<::std::boxed::Box<self::_puroro_root::official_samples2::_puroro_simple_impl::Test1>>;
