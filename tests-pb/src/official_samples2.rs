...
fn a_default_value<'this>(&'this self) ->
    i32
{
    ...
    Self: super::_puroro_traits::Test1Trait
{
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        f.debug_struct("Test1")
            .field("a", &<Self as super::_puroro_traits::Test1Trait>::a_opt(self))
            .finish()
    }
}
...
fn b_default_value<'this>(&'this self) ->
    ...
    Self: super::_puroro_traits::Test2Trait
{
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        f.debug_struct("Test2")
            .field("b", &<Self as super::_puroro_traits::Test2Trait>::b_opt(self))
            .finish()
    }
}
...
impl Test3 {
    ...
    pub fn c_mut(&mut self) -> &mut ::std::option::Option<::std::boxed::Box<self::_puroro_root::official_samples2::_puroro_simple_impl::Test1>> {
        &mut self.c
    }
}

impl super::_puroro_traits::Test3Trait for Test3 {
type Field3ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::official_samples2::_puroro_simple_impl::Test1;
fn c_opt<'this>(&'this self) -> Option<Self::Field3ScalarGetterType<'this>> {
    self.c.as_ref().map(|x| x.as_ref())
}

fn c_default_value<'this>(&'this self) ->
    Self::Field3ScalarGetterType<'this>
{
    static DEFAULT_VALUE: ::puroro::once_cell::sync::Lazy< self::_puroro_root::official_samples2::_puroro_simple_impl::Test1
    ...
    Self: super::_puroro_traits::Test3Trait,
{
    ...
    {
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::Optional, ::puroro::tags::Message<<Self as super::_puroro_traits::Test3Trait>::Field3ScalarGetterType<'_>>
        >::ser_field(
    ...
    Self: super::_puroro_traits::Test4Trait
{
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        f.debug_struct("Test4")
            .field("d", &<Self as super::_puroro_traits::Test4Trait>::d(self)
                .into_iter()
...
where
ScalarType: self::_puroro_root::official_samples2::_puroro_traits::Test1Trait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub c: ScalarType,
}
...
ScalarType: self::_puroro_root::official_samples2::_puroro_traits::Test1Trait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    type Field3ScalarGetterType<'this> where Self: 'this = &'this ScalarType;
...
type Field3ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::official_samples2::_puroro_impls::Test1Bumpalo<'this>
;
fn c_opt<'this>(&'this self) -> Option<Self::Field3ScalarGetterType<'this>> {
    <Self>::c_opt(self)
}
...
pub mod _puroro_traits {
        ...
        T: Test2Trait,
    {
        type Field2ScalarGetterType<'this> where Self: 'this =
            ...
            >;
        fn b_opt<'this>(&'this self) -> ::std::option::Option<Self::Field2ScalarGetterType<'this>> {
            self.as_ref().and_then(|msg| msg.b_opt().map(|val| ::puroro::Either::Left(val)))
        }
        ...
        U: Test2Trait,
    {
        ...
        {
            self.as_ref().either(
                |t| <T as Test2Trait>::b_opt(t).map(
                    |t| ::puroro::Either::Left(t)
                ),
                |u| <U as Test2Trait>::b_opt(u).map(
    ...
    macro_rules! test3_delegate {
        ($ty:ty) => {
            type Field3ScalarGetterType<'this> where Self: 'this = 
        ...
        T: Test3Trait,
    {
        type Field3ScalarGetterType<'this> where Self: 'this =
            ...
            >;
        fn c_opt<'this>(&'this self) -> ::std::option::Option<Self::Field3ScalarGetterType<'this>> {
            self.as_ref().and_then(|msg| msg.c_opt().map(|val| ::puroro::Either::Left(val)))
        }
    ...
    where
        ...
        U: Test3Trait,
    {
        type Field3ScalarGetterType<'this> where Self: 'this = ::puroro::Either<
        ...
        T: Test4Trait
    {
        ...
        type Field4RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<i32>;
        fn d<'this>(&'this self) -> Self::Field4RepeatedType<'this> {
