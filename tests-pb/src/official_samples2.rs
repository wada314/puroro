...
type Field3MessageType<'this> where Self: 'this = &'this self::_puroro_root::official_samples2::_puroro_simple_impl::Test1;
    ...
    Self: super::_puroro_traits::Test3Trait,
{
    ...
    {
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::Optional, ::puroro::tags::Message<<Self as super::_puroro_traits::Test3Trait>::Field3MessageType<'_>>
        >::ser_field(
...
type Field3MessageType<'this> where Self: 'this = &'this self::_puroro_root::official_samples2::_puroro_impls::Test1Bumpalo<'this>;
fn c_opt<'this>(&'this self) -> Option<Self::Field3MessageType<'this>> {
    <Self>::c_opt(self)
}
}
...
pub mod _puroro_traits {
        ...
        U: Test1Trait,
    {
        ...
        fn a<'this>(&'this self) -> i32 {
            self.a_opt().unwrap_or_else(|| self.1.a() )
        }
        ...
        U: Test1Trait,
    {
        ...
        fn a<'this>(&'this self) -> i32 {
            self.as_ref().either(
                |t| <T as Test1Trait>::a(t),
                |u| <U as Test1Trait>::a(u),
            )
        }
        ...
        U: Test2Trait,
    {
        ...
        fn b<'this>(&'this self) -> &'this str {
            self.b_opt().unwrap_or_else(|| self.1.b() )
        }
        ...
        U: Test2Trait,
    {
        ...
        fn b<'this>(&'this self) -> &'this str {
            self.as_ref().either(
                |t| <T as Test2Trait>::b(t),
                |u| <U as Test2Trait>::b(u),
            )
        }
    ...
    {type Field3MessageType<'this> where Self: 'this = (
        ...
        fn c_opt<'this>(&'this self) -> Option<Self::Field3MessageType<'this>>
        {
            if <T as Test3Trait>::has_c(&self.0) ||
                <U as Test3Trait>::has_c(&self.1)
            {
                Some((
                    <T as Test3Trait>::c(&self.0),
                    <U as Test3Trait>::c(&self.1)
                ))
            } else {
                None
            }
        ...
        U: Test3Trait,
    {
        ...
        fn c<'this>(&'this self) -> Self::Field3MessageType<'this> {
            self.as_ref().either(
                |t| ::puroro::Either::Left(<T as Test3Trait>::c(t)),
                |u| ::puroro::Either::Right(<U as Test3Trait>::c(u)),
            )
        }
    ...
    where
        T: Test3Trait,
    {
        type Field3MessageType<'this> where Self: 'this = ::std::option::Option<T::Field3MessageType<'this>>;
        fn c_opt<'this>(&'this self) -> ::std::option::Option<Self::Field3MessageType<'this>> {
