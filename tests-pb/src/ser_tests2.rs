...
pub mod _puroro_impls {
    ...
    impl<T> ::std::convert::From<::std::option::Option<T>> for MsgSingleField5<T>
    where
        T: ::std::ops::Deref<Target = str>
            + ::std::clone::Clone
            + ::std::cmp::PartialEq
    ...
    impl<T> ::puroro::internal::SerializableMessageToIoWrite for MsgSingleField7<T>
    where
        T: self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_traits::SubmsgTrait
            + ::std::clone::Clone
            + ::std::cmp::PartialEq
    ...
    impl<T> ::puroro::internal::SerializableMessageToIoWrite for MsgSingleField8<T>
    where
        T: self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_traits::SubmsgTrait
            + ::std::clone::Clone
            + ::std::cmp::PartialEq
    ...
    impl ::puroro::internal::SerializableMessageToIoWrite for MsgSingleField10 {
        fn ser<W>(&self, out: &mut W) -> ::puroro::Result<()>
        where
            W: ::std::io::Write,
        {
