...
impl Msg {
    ...
    pub fn submsg_optional_opt(&self) -> ::std::option::Option<&'_ self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg> {
    ...
    pub fn submsg_optional(&self) -> ::std::option::Option<&'_ self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg> {
        self.submsg_optional_opt()
    }
    pub fn submsg_repeated(&self) -> &'_[self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg] {
        &self.submsg_repeated
    }
    pub fn enum_optional_opt(&self) -> ::std::option::Option<self::_puroro_root::ser_tests2::Enum> {
    ...
    pub fn very_large_field_number_opt(&self) -> ::std::option::Option<i32> {
        if self._bitfield.get(4).map_or(false, |v| *v) {
            ::std::option::Option::Some(
                self.very_large_field_number.clone().inner()
            )
        } else {
            ::std::option::Option::None
        }
    ...
    pub fn very_large_field_number(&self) -> i32 {
        self.very_large_field_number_opt().unwrap_or(
            ::std::default::Default::default()
        )
    }
    ...
    pub fn submsg_optional_mut(&mut self) -> &'_ mut self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg {
        if !self.has_submsg_optional() {
            self.submsg_optional = ::std::default::Default::default();
        }
        self.submsg_optional.get_or_insert_with(::std::default::Default::default)
    }
    pub fn submsg_repeated_mut(&mut self) -> &'_ mut ::std::vec::Vec<self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg> {
    ...
    pub fn enum_repeated_mut(&mut self) -> &'_ mut ::std::vec::Vec<self::_puroro_root::ser_tests2::Enum> {
...
type SubmsgOptionalMessageType<'this> where Self: 'this = &'this self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg;
fn submsg_optional_opt<'this>(&'this self) -> Option<Self::SubmsgOptionalMessageType<'this>> {
    <self::Msg>::submsg_optional_opt(self)
}
type SubmsgRepeatedMessageType<'this> where Self: 'this = &'this self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg;
    ...
    Self: super::_puroro_traits::MsgTrait
{
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        f.debug_struct("Msg")
            ...
            .field("very_large_field_number", &self.very_large_field_number_opt())
            .finish()
    }
}
...
fn i32_optional_opt<'this>(&'this self) -> ::std::option::Option<i32> {
    ...
    type EnumRepeatedRepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<self::_puroro_root::ser_tests2::Enum>;
    fn enum_repeated<'this>(&'this self) -> Self::EnumRepeatedRepeatedType<'this> {
        ::puroro::internal::impls::empty::EmptyRepeatedField::new()
    }
}
...
type SubmsgOptionalMessageType<'this> where Self: 'this = &'this self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'this>;
fn submsg_optional_opt<'this>(&'this self) -> Option<Self::SubmsgOptionalMessageType<'this>> {
    <Self>::submsg_optional_opt(self)
}
type SubmsgRepeatedMessageType<'this> where Self: 'this = &'this self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'this>;
type SubmsgRepeatedRepeatedType<'this> where Self: 'this =
...
where
    T: MsgTemplateFieldTypes,
    B: ::puroro::internal::BitVec,
    <T as MsgTemplateFieldTypes>::VeryLargeFieldNumberType: ::std::clone::Clone,_unesc_opt
{
    pub fn very_large_field_number_opt(&self) -> ::std::option::Option<T::VeryLargeFieldNumberType> {
        #[allow(unused)]
        use ::std::option::Option::{Some, None};
...
impl MsgTemplateFieldTypes for ::puroro::SimpleImpl {
    ...
    type SubmsgOptionalType = ::std::option::Option<::std::boxed::Box<self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg>>;
    type SubmsgRepeatedType = ::std::vec::Vec<self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg>;
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        ...
        fn very_large_field_number<'this>(&'this self) -> i32 {
            self.very_large_field_number_opt().unwrap_or_else(::std::default::Default::default)
        }
