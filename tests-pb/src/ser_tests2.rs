...
where
ScalarType: self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_traits::SubmsgTrait +
...
pub mod _puroro_traits {
        ...
        U: MsgTrait,
    {
        ...
        fn very_large_field_number<'this>(&'this self) -> i32 {
            self.very_large_field_number_opt()
                .unwrap_or_else(|| self.1.very_large_field_number())
        }
    }
        ...
        T: MsgTrait,
    {
        ...
        where
            Self: 'this,
        = ::std::option::Option<T::Field7MessageType<'this>>;
        fn submsg_optional_opt<'this>(
            &'this self,
        ) -> ::std::option::Option<Self::Field7MessageType<'this>> {
            self.as_ref()
    ...
    pub mod msg {
        ...
        pub mod _puroro_impls {
                    ...
                    + ::std::fmt::Debug,
            {
                fn i32_optional_opt<'this>(&'this self) -> ::std::option::Option<i32> {
                    ::std::option::Option::Some(
                        <Self as super::_puroro_traits::SubmsgTrait>::i32_optional(self),
                    )
                }
