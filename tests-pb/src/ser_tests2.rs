...
pub struct Msg {
    ...
    submsg_optional: ::std::option::Option<::std::boxed::Box<self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg>>,
    submsg_repeated: ::std::vec::Vec<self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg>,
...
impl Msg {
    ...
    pub fn submsg_optional_mut(&mut self) -> &mut ::std::option::Option<::std::boxed::Box<self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg>> {
        &mut self.submsg_optional
    }
    pub fn submsg_repeated_mut(&mut self) -> &mut ::std::vec::Vec<self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg> {
        &mut self.submsg_repeated
    }
    pub fn enum_optional_mut(&mut self) -> &mut ::std::option::Option<self::_puroro_root::ser_tests2::Enum> {
        &mut self.enum_optional
    }
    pub fn enum_repeated_mut(&mut self) -> &mut ::std::vec::Vec<self::_puroro_root::ser_tests2::Enum> {
...
type Field2RepeatedType<'this> = ::puroro::CloneThenIntoRepeatedField<
    'this,
    ::std::vec::Vec<i32>,
    i32,
    i32,
...
type Field4RepeatedType<'this> = ::puroro::CloneThenIntoRepeatedField<
    'this,
    ::std::vec::Vec<f32>,
    f32,
    f32,
...
type Field5ScalarGetterType<'this> where Self: 'this = &'this ::std::string::String;
...
type Field6ScalarGetterType<'this> where Self: 'this = &'this ::std::string::String;
type Field6RepeatedType<'this> = &'this [::std::string::String];

fn string_repeated<'this>(&'this self) -> Self::Field6RepeatedType<'this> {
    &self.string_repeated
}
type Field7ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg;
...
{
    static DEFAULT_VALUE: ::puroro::once_cell::sync::Lazy< self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg
    > = ::puroro::once_cell::sync::Lazy::new(|| { ::std::default::Default::default()
    });

    &DEFAULT_VALUE
}
type Field8ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_simple_impl::Submsg;
...
fn very_large_field_number_default_value<'this>(&'this self) ->
    i32
{
    ...
    Self: super::_puroro_traits::MsgTrait,
{
        ...
        W: ::std::io::Write,
    {
        ...
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::Optional, ::puroro::tags::Message<<Self as super::_puroro_traits::MsgTrait>::Field7ScalarGetterType<'_>>
        >::ser_field(
        ...
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::Repeated, ::puroro::tags::Message<<Self as super::_puroro_traits::MsgTrait>::Field8ScalarGetterType<'_>>
        >::ser_field(
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        f.debug_struct("Msg")
            ...
            .field("enum_repeated", &<Self as super::_puroro_traits::MsgTrait>::enum_repeated(self)
                .into_iter()
                .collect::<::std::vec::Vec<_>>())
            .field("very_large_field_number", &<Self as super::_puroro_traits::MsgTrait>::very_large_field_number_opt(self))
            .finish()
    }
}
    ...
    ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    ...
    fn string_optional_default_value<'this>(&'this self) -> Self::Field5ScalarGetterType<'this> {
    ...
    type Field7ScalarGetterType<'this> where Self: 'this =
        <() as super::_puroro_traits::MsgTrait>::Field7ScalarGetterType<'this>;

    fn submsg_optional_default_value<'this>(&'this self) -> Self::Field7ScalarGetterType<'this> {
        <() as super::_puroro_traits::MsgTrait>::submsg_optional_default_value(&())
    }
    type Field8ScalarGetterType<'this> where Self: 'this =
    ...
    fn very_large_field_number_default_value<'this>(&'this self) -> i32 {
        <() as super::_puroro_traits::MsgTrait>::very_large_field_number_default_value(&())
    }
}
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    ...
    type Field5ScalarGetterType<'this> where Self: 'this = &'this ScalarType;
    fn string_optional_opt<'this>(&'this self) -> ::std::option::Option<Self::Field5ScalarGetterType<'this>> {
    ...
    ::std::iter::IntoIterator<Item = &'a ScalarType>,
{
    ...
    type Field6ScalarGetterType<'this> where Self: 'this = &'this ScalarType;
    type Field6RepeatedType<'this> where Self: 'this = &'this RepeatedType;
...
where
ScalarType: self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_traits::SubmsgTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
...
ScalarType: self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_traits::SubmsgTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    ...
    type Field7ScalarGetterType<'this> where Self: 'this = &'this ScalarType;
    fn submsg_optional_opt<'this>(&'this self) -> ::std::option::Option<Self::Field7ScalarGetterType<'this>> {
    ...
    ::std::iter::IntoIterator<Item = &'a ScalarType>,
{
    ...
    type Field8ScalarGetterType<'this> where Self: 'this = &'this ScalarType;
...
impl<ScalarType> ::puroro::Message<super::Msg>
for MsgSingleField9<ScalarType>
where
...
impl<ScalarType> ::puroro::Message<super::Msg>
for MsgSingleField536870911<ScalarType>
where
...
pub struct MsgBumpalo<'bump> {
    ...
    submsg_optional: ::std::option::Option<::puroro::internal::NoAllocBumpBox<self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'bump>>>,
    submsg_repeated: ::puroro::internal::NoAllocBumpVec<self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'bump>>,
...
impl<'bump> MsgBumpalo<'bump> {
    ...
    pub fn enum_optional_opt<'this>(&'this self) -> ::std::option::Option<self::_puroro_root::ser_tests2::Enum> {
    ...
    pub fn very_large_field_number_opt<'this>(&'this self) -> ::std::option::Option<i32> {
        if self._bitfield.get(4).map_or(false, |v| *v) {
            ::std::option::Option::Some(
                self.very_large_field_number.inner()
            )
        } else {
            ::std::option::Option::None
        }
    ...
    pub fn submsg_repeated_mut<'this>(&'this mut self) -> ::puroro::internal::RefMutBumpVec<'bump, 'this, self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'bump>> {
        unsafe { self.submsg_repeated.as_mut_vec_in(self._bump) }
    }
    pub fn clear_enum_optional(&mut self) {
        self._bitfield.set(3, false);
    }
    pub fn enum_optional_mut<'this>(&'this mut self) -> &'this mut self::_puroro_root::ser_tests2::Enum {
    ...
    pub fn enum_repeated_mut<'this>(&'this mut self) -> ::puroro::internal::RefMutBumpVec<'bump, 'this, self::_puroro_root::ser_tests2::Enum> {
...
type Field7ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'this>
;
fn submsg_optional_opt<'this>(&'this self) -> Option<Self::Field7ScalarGetterType<'this>> {
    <Self>::submsg_optional_opt(self)
}
type Field8ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_impls::SubmsgBumpalo<'this>
;
...
type Field10RepeatedType<'this> where Self: 'this =
    ::puroro::CloneThenIntoRepeatedField<'this, ::puroro::internal::NoAllocBumpVec<self::_puroro_root::ser_tests2::Enum>, self::_puroro_root::ser_tests2::Enum, self::_puroro_root::ser_tests2::Enum>;
...
ScalarType: ::std::convert::Into<i32> +
    ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MsgBuilder((self.0, MsgSingleField1 { i32_optional: value}))
    }
...
for <'a> &'a RepeatedType: ::puroro::RepeatedField<'a> + 
    ::std::iter::IntoIterator<Item = &'a ScalarType>,
    {
        MsgBuilder((self.0, MsgSingleField2 { i32_repeated: value}))
    }
...
ScalarType: ::std::convert::Into<f32> +
    ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MsgBuilder((self.0, MsgSingleField3 { float_optional: value}))
    }
...
for <'a> &'a RepeatedType: ::puroro::RepeatedField<'a> + 
    ::std::iter::IntoIterator<Item = &'a ScalarType>,
    {
        MsgBuilder((self.0, MsgSingleField4 { float_repeated: value}))
    }
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MsgBuilder((self.0, MsgSingleField5 { string_optional: value}))
    }
...
for <'a> &'a RepeatedType: ::puroro::RepeatedField<'a> + 
    ::std::iter::IntoIterator<Item = &'a ScalarType>,
    {
        MsgBuilder((self.0, MsgSingleField6 { string_repeated: value}))
    }
...
ScalarType: self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_traits::SubmsgTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MsgBuilder((self.0, MsgSingleField7 { submsg_optional: value}))
    }
...
for <'a> &'a RepeatedType: ::puroro::RepeatedField<'a> + 
    ::std::iter::IntoIterator<Item = &'a ScalarType>,
    {
        MsgBuilder((self.0, MsgSingleField8 { submsg_repeated: value}))
    }
...
ScalarType: ::std::convert::Into<self::_puroro_root::ser_tests2::Enum> +
    ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MsgBuilder((self.0, MsgSingleField9 { enum_optional: value}))
    }
...
for <'a> &'a RepeatedType: ::puroro::RepeatedField<'a> + 
    ::std::iter::IntoIterator<Item = &'a ScalarType>,
    {
        MsgBuilder((self.0, MsgSingleField10 { enum_repeated: value}))
    }

    pub fn append_very_large_field_number<ScalarType>(self, value: ScalarType)
...
ScalarType: ::std::convert::Into<i32> +
    ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MsgBuilder((self.0, MsgSingleField536870911 { very_large_field_number: value}))
    }
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        ...
        fn very_large_field_number<'this>(&'this self) -> i32 {
            self.very_large_field_number_opt().unwrap_or(::std::default::Default::default())
        }
    ...
    macro_rules! msg_delegate {
        ($ty:ty) => {
            ...
            fn very_large_field_number_default_value<'this>(&'this self) -> i32
            {
                <$ty as MsgTrait>::very_large_field_number_default_value(self)
            }
        };
    }
        ...
        T: MsgTrait
    {
        ...
        type Field6RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field6ScalarGetterType<'this>>;
        fn string_repeated<'this>(&'this self) -> Self::Field6RepeatedType<'this> {
            ::puroro::internal::impls::empty::EmptyRepeatedField::new()
        }
        ...
        type Field8RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field8ScalarGetterType<'this>>;
        fn submsg_repeated<'this>(&'this self) -> Self::Field8RepeatedType<'this> {
            ::puroro::internal::impls::empty::EmptyRepeatedField::new()
        }
        ...
        type Field10RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<self::_puroro_root::ser_tests2::Enum>;
        fn enum_repeated<'this>(&'this self) -> Self::Field10RepeatedType<'this> {
            ::puroro::internal::impls::empty::EmptyRepeatedField::new()
        }
        ...
        T: MsgTrait,
    {
        ...
        type Field5ScalarGetterType<'this> where Self: 'this =
            ::puroro::Either<
                T::Field5ScalarGetterType<'this>,&'this str
            >;
        fn string_optional_opt<'this>(&'this self) -> ::std::option::Option<Self::Field5ScalarGetterType<'this>> {
        ...
        type Field6ScalarGetterType<'this> where Self: 'this =
            ::puroro::Either<
                T::Field6ScalarGetterType<'this>,&'this str
            >;
        type Field6RepeatedType<'this> where Self: 'this =
            ::puroro::internal::impls::option::EitherLeftRepeatedField<
                ::std::iter::Flatten<
                    ::std::option::IntoIter<
                        T::Field6RepeatedType<'this>
                    >
                >,&'this str
            >;
        fn string_repeated<'this>(&'this self) -> Self::Field6RepeatedType<'this> {
        ...
        fn very_large_field_number_opt<'this>(&'this self) -> ::std::option::Option<i32> {
            self.as_ref().and_then(|msg| msg.very_large_field_number_opt())
        }
        ...
        U: MsgTrait,
    {
        ...
        }type Field5ScalarGetterType<'this> where Self: 'this = ::puroro::Either<
        ...
        }type Field6ScalarGetterType<'this> where Self: 'this = ::puroro::Either<
        ...
        fn string_repeated<'this>(&'this self) -> Self::Field6RepeatedType<'this>
        {
            ...
            ::std::option::Option<<T as MsgTrait>::Field7ScalarGetterType<'this>>,
            ::std::option::Option<<U as MsgTrait>::Field7ScalarGetterType<'this>>,
        );
        fn submsg_optional_opt<'this>(&'this self) -> Option<Self::Field7ScalarGetterType<'this>>
        {
            match (
        ...
        }type Field8ScalarGetterType<'this> where Self: 'this = ::puroro::Either<
        ...
        fn very_large_field_number_default_value<'this>(&'this self) -> i32 {
            self.1.very_large_field_number_default_value()
        }
        ...
        U: MsgTrait,
    {
        ...
        type Field7ScalarGetterType<'this> where Self: 'this = ::puroro::Either<
        ...
        fn very_large_field_number_default_value<'this>(&'this self) -> i32 {
            self.as_ref().either(
                |t| <T as MsgTrait>::very_large_field_number_default_value(t),
                |u| <U as MsgTrait>::very_large_field_number_default_value(u),
            )
        }
    }
}
...
pub mod _puroro_nested {
    pub mod msg {
            ...
            Self: super::_puroro_traits::SubmsgTrait
        {
            fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                f.debug_struct("Submsg")
                    .field("i32_optional", &<Self as super::_puroro_traits::SubmsgTrait>::i32_optional_opt(self))
                    .finish()
            }
        }
        ...
        ScalarType: ::std::convert::Into<i32> +
            ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
            {
                SubmsgBuilder((self.0, SubmsgSingleField1 { i32_optional: value}))
            }
        ...
        pub mod _puroro_traits {
            ...
            macro_rules! submsg_delegate {
                ($ty:ty) => {
                    ...
                    fn i32_optional_default_value<'this>(&'this self) -> i32
                    {
                        <$ty as SubmsgTrait>::i32_optional_default_value(self)
                    }
                };
            }
                ...
                U: SubmsgTrait,
            {
                ...
                fn i32_optional_default_value<'this>(&'this self) -> i32 {
                    self.as_ref().either(
                        |t| <T as SubmsgTrait>::i32_optional_default_value(t),
                        |u| <U as SubmsgTrait>::i32_optional_default_value(u),
                    )
                }
            }
        }
