...
where
    Self: ::puroro_internal::GetImplStruct,
    <Self as ::puroro_internal::GetImplStruct>::Type:
        self::_puroro_root::ser_tests2::_puroro_traits::MsgTrait,
{
    fn i32_optional<'this>(&'this self) -> ::std::option::Option<i32> {
        <<Self as ::puroro_internal::GetImplStruct>::Type
            as self::_puroro_root::ser_tests2::_puroro_traits::MsgTrait
        >::i32_optional(&self.0)
    }
...
mod _puroro_impls {
    ...
    pub struct Msg_Simple {
        ...
        pub submsg_optional: ::std::option::Option<
            ::std::boxed::Box<
                self::_puroro_root::ser_tests2::_puroro_nested::msg::Submsg<
                    ::puroro::tags::SimpleImpl,
                >,
            >,
        >,
        pub submsg_repeated: ::std::vec::Vec<
            self::_puroro_root::ser_tests2::_puroro_nested::msg::Submsg<::puroro::tags::SimpleImpl>,
        >,
...
pub mod _puroro_nested {
    pub mod msg {
                ...
                self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_traits::SubmsgTrait,
        {
            fn i32_optional<'this>(&'this self) -> ::std::option::Option<i32> {
                <<Self as ::puroro_internal::GetImplStruct>::Type
                    as self::_puroro_root::ser_tests2::_puroro_nested::msg::_puroro_traits::SubmsgTrait
                >::i32_optional(&self.0)
            }
        }
