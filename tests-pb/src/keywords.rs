...
where
    ...
    <T as MsgTemplateFieldTypes>::TypeType: ::std::clone::Clone,_unesc_opt
{
    pub fn type_opt(&self) -> ::std::option::Option<T::TypeType> {
        #[allow(unused)]
...
where
    ...
    <T as MsgTemplateFieldTypes>::TypeType: ::std::default::Default,
{
    fn default() -> Self {
        Self {
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        fn r#type<'this>(&'this self) -> i32 {
            self.type_opt().unwrap_or_else(::std::default::Default::default)
        }
        ...
        U: MsgTrait,
    {
        ...
        fn type_opt<'this>(&'this self) -> Option<i32>
        {
            <U as MsgTrait>::type_opt(&self.1)
                .or_else(|| <T as MsgTrait>::type_opt(&self.0))
        }
