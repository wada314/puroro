    ...
    impl ::puroro::internal::se::SerMessageToIoWrite for Msg {
            ...
            W: ::std::io::Write,
        {
            ::puroro::internal::se::SerFieldToIoWrite::<
                ::puroro::tags::OneofField,
                ::puroro::tags::Int32,
            >::ser_field(self.g1_int32_opt(), 1, out, true)?;
            ::puroro::internal::se::SerFieldToIoWrite::<
                ::puroro::tags::OneofField,
                ::puroro::tags::String,
            >::ser_field(self.g1_string_opt(), 2, out, true)?;
            ::puroro::internal::se::SerFieldToIoWrite::<
                ::puroro::tags::OneofField,
                ::puroro::tags::Float,
            >::ser_field(self.g2_f32_opt(), 3, out, true)?;
            ::puroro::internal::se::SerFieldToIoWrite::<
                ::puroro::tags::OneofField,
                ::puroro::tags::String,
            ...
            ::puroro::internal::se::SerFieldToIoWrite::<
                ::puroro::tags::OneofField,
                ::puroro::tags::Int32,
            >::ser_field(self.g3_int32_opt(), 6, out, true)?;
    ...
    pub mod msg {
        ...
        pub mod _puroro_oneofs {
                ...
                T: 'msg + ?Sized + self::_puroro_root::oneofs3::_puroro_traits::MsgTrait,
            {
                G2F32(f32),
                G2String(&'msg str),
                G2Submsg(<T as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::G2SubmsgMessageType<'msg>),
            }
                ...
                T: 'msg + ?Sized + self::_puroro_root::oneofs3::_puroro_traits::MsgTrait,
            {
                ...
                pub fn g2_submsg(self) -> ::std::option::Option<<T as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::G2SubmsgMessageType<'msg>>{
                    match self {
            ...
            where
                f32: ::std::fmt::Debug,
                &'msg str: ::std::fmt::Debug,
                <T as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::G2SubmsgMessageType<
                    'msg,
                >: ::std::fmt::Debug,
                T: 'msg + ?Sized + self::_puroro_root::oneofs3::_puroro_traits::MsgTrait,
            {
