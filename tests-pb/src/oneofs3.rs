...
pub mod _puroro_impls {
    ...
    impl<T> ::puroro::Message<super::Msg> for MsgSingleField2<T> where
        T: ::std::ops::Deref<Target = str>
            + ::std::clone::Clone
            + ::std::cmp::PartialEq
            + ::std::fmt::Debug
    ...
    impl<T> super::_puroro_traits::MsgTrait for MsgSingleField2<T>
    where
        T: ::std::ops::Deref<Target = str>
            + ::std::clone::Clone
            + ::std::cmp::PartialEq
    ...
    impl<T> ::puroro::internal::SerializableMessageToIoWrite for MsgSingleField2<T>
    where
        T: ::std::ops::Deref<Target = str>
            + ::std::clone::Clone
            + ::std::cmp::PartialEq
    ...
    impl<T> ::std::convert::From<T> for MsgSingleField2<T>
    where
        T: ::std::ops::Deref<Target = str>
            + ::std::clone::Clone
            + ::std::cmp::PartialEq
    ...
    impl<T> ::puroro::Message<super::Msg> for MsgSingleField4<T> where
        T: ::std::ops::Deref<Target = str>
            + ::std::clone::Clone
            + ::std::cmp::PartialEq
            + ::std::fmt::Debug
    ...
    impl<T> super::_puroro_traits::MsgTrait for MsgSingleField4<T>
    where
        T: ::std::ops::Deref<Target = str>
            + ::std::clone::Clone
            + ::std::cmp::PartialEq
    ...
    impl<T> ::puroro::internal::SerializableMessageToIoWrite for MsgSingleField4<T>
    where
        T: ::std::ops::Deref<Target = str>
            + ::std::clone::Clone
            + ::std::cmp::PartialEq
    ...
    impl<T> ::std::convert::From<T> for MsgSingleField4<T>
    where
        T: ::std::ops::Deref<Target = str>
            + ::std::clone::Clone
            + ::std::cmp::PartialEq
    ...
    where
        T: self::_puroro_root::oneofs3::_puroro_traits::SubmsgTrait
            + ::std::clone::Clone
            + ::std::cmp::PartialEq
            + ::std::fmt::Debug,
    {
        ...
        T: ::puroro::internal::SerializableMessageToIoWrite,
    {
        ...
        {
            use ::puroro::internal::impls::single_field::se::SerFieldToIoWrite;
            SerFieldToIoWrite::<::puroro::tags::OneofField, ::puroro::tags::Message<T>>::ser_field::<
                T,
                _,
                _,
            >(&self.g2_submsg, 5, out)?;
            ::std::result::Result::Ok(())
        }
    }
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        ...
        fn g1_string<'this>(
            ...
            <Self as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::Field2StringType<
                'this,
            >,
        > {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupOne as E;
        ...
        fn g2_string<'this>(
            ...
            <Self as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::Field4StringType<
                'this,
            >,
        > {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
    ...
    pub mod msg {
        ...
        pub mod _puroro_oneofs {
            ...
            > {
                G1Int32(i32),
                G1String(
                    <T as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::Field2StringType<
                        'msg,
                    >,
                ),
            }
                ...
                GroupTwo<'msg, T>
            {
                ...
                pub fn g2_string(
                    ...
                    <T as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::Field4StringType<
                        'msg,
                    >,
                > {
                    match self {
