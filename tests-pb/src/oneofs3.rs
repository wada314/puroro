...
pub struct Msg {
    ...
    group_one: ::std::option::Option<
        super::_puroro_nested::msg::_puroro_oneofs::GroupOne<::puroro::internal::Bare<i32>, ::puroro::internal::Bare<::std::string::String>>
    >,
    group_two: ::std::option::Option<
        super::_puroro_nested::msg::_puroro_oneofs::GroupTwo<::puroro::internal::Bare<f32>, ::puroro::internal::Bare<::std::string::String>, ::puroro::internal::Bare<::std::boxed::Box<self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg>>>
    >,
...
impl Msg {
    ...
    pub fn g2_string(&self) -> &'_ str {
        self.g2_string_opt().unwrap_or(
            ::std::default::Default::default()
        )
    }
    pub fn g2_submsg_opt(&self) -> ::std::option::Option<&'_ self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg> {
        use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
        #[allow(unused_imports)]
        use ::std::option::Option::{Some,  None};
    ...
    pub fn g2_submsg(&self) -> ::std::option::Option<&'_ self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg> {
        self.g2_submsg_opt()
    }
    ...
    pub fn g3_int32(&self) -> i32 {
        self.g3_int32_opt().unwrap_or(
            ::std::default::Default::default()
        )
    }
    pub fn group_one(&self) ->
        ::std::option::Option<
            super::_puroro_nested::msg::_puroro_oneofs::GroupOne<i32, &'_ str>
        >
    {
        use super::_puroro_nested::msg::_puroro_oneofs::GroupOne as E;
        #[allow(unused_imports)]
        ...
        match &self.group_one {
            Some(E::G1Int32(ref val)) => Some(
                E::G1Int32(
                    val.clone().inner()
                )
            ),
            Some(E::G1String(ref val)) => Some(
                E::G1String(
                    val
                )
            ),
    ...
    pub fn group_two(&self) ->
        ::std::option::Option<
            super::_puroro_nested::msg::_puroro_oneofs::GroupTwo<f32, &'_ str, &'_ self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg>
        >
    {
        use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
        #[allow(unused_imports)]
        ...
        match &self.group_two {
            Some(E::G2F32(ref val)) => Some(
                E::G2F32(
                    val.clone().inner()
                )
            ),
            Some(E::G2String(ref val)) => Some(
                E::G2String(
                    val
                )
            ),
            Some(E::G2Submsg(ref val)) => Some(
                E::G2Submsg(
                    val
                )
            ),
    ...
    pub fn group_three(&self) ->
        ::std::option::Option<
            super::_puroro_nested::msg::_puroro_oneofs::GroupThree<i32>
        >
    {
        use super::_puroro_nested::msg::_puroro_oneofs::GroupThree as E;
        #[allow(unused_imports)]
    ...
    pub fn g2_submsg_mut(&mut self) -> &'_ mut self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg
    {
        use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
        #[allow(unused_imports)]
        use ::std::option::Option::{Some, None};
...
type G2SubmsgMessageType<'this> where Self: 'this = &'this self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg;
        ...
        I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>
    {
        ...
        match field_number {
            1 => {
                ...
                if !matches!(
                    &self.group_one,
                    ::std::option::Option::Some(E::G1Int32(_)))
                {
                    self.group_one = ::std::option::Option::Some(
                        E::G1Int32(
                            ::std::default::Default::default()
                        )
                    );
            ...
            2 => {
                ...
                if !matches!(
                    &self.group_one,
                    ::std::option::Option::Some(E::G1String(_)))
                {
                    self.group_one = ::std::option::Option::Some(
                        E::G1String(
                            ::std::default::Default::default()
            ...
            3 => {
                ...
                if !matches!(
                    &self.group_two,
                    ::std::option::Option::Some(E::G2F32(_)))
                {
                    self.group_two = ::std::option::Option::Some(
                        E::G2F32(
                            ::std::default::Default::default()
                        )
                    );
            ...
            4 => {
                ...
                if !matches!(
                    &self.group_two,
                    ::std::option::Option::Some(E::G2String(_)))
                {
                    self.group_two = ::std::option::Option::Some(
                        E::G2String(
                            ::std::default::Default::default()
            ...
            5 => {
                ...
                if !matches!(
                    &self.group_two,
                    ::std::option::Option::Some(E::G2Submsg(_)))
                {
                    self.group_two = ::std::option::Option::Some(
                        E::G2Submsg(
                            ::std::default::Default::default()
            ...
            6 => {
                ...
                {
                    self.group_three = ::std::option::Option::Some(
                        E::G3Int32(
                            ::std::default::Default::default()
                        )
                    );
    ...
    Self: super::_puroro_traits::MsgTrait,
{
        ...
        W: ::std::io::Write,
    {
        ...
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::OneofField, ::puroro::tags::Message<<Self as super::_puroro_traits::MsgTrait>::G2SubmsgMessageType<'_>>
        >::ser_field(
...
ScalarType:
    self::_puroro_root::oneofs3::_puroro_traits::SubmsgTrait,
{
type G2SubmsgMessageType<'this> where Self: 'this = &'this ScalarType;

fn g2_submsg_opt<'this>(&'this self) -> ::std::option::Option<Self::G2SubmsgMessageType<'this>> {
...
pub struct MsgBumpalo<'bump> {
    ...
    >,
    group_one: ::std::option::Option<
        super::_puroro_nested::msg::_puroro_oneofs::GroupOne<::puroro::internal::Bare<i32>, ::puroro::internal::Bare<::puroro::internal::NoAllocBumpString>>
    >,
    group_two: ::std::option::Option<
        super::_puroro_nested::msg::_puroro_oneofs::GroupTwo<::puroro::internal::Bare<f32>, ::puroro::internal::Bare<::puroro::internal::NoAllocBumpString>, ::puroro::internal::Bare<::puroro::internal::NoAllocBumpBox<self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'bump>>>>
    >,
    group_three: ::std::option::Option<
        super::_puroro_nested::msg::_puroro_oneofs::GroupThree<::puroro::internal::Bare<i32>>
    >,
...
impl<'bump> MsgBumpalo<'bump> {
    ...
    pub fn g2_submsg_opt<'this>(&'this self) -> ::std::option::Option<&'this self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'this>> {
        use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
        #[allow(unused_imports)]
        use ::std::option::Option::{Some, None};
        if let Some(E::G2Submsg(ref val)) = &self.group_two {
    ...
    pub fn g2_submsg<'this>(&'this self) -> ::std::option::Option<&'this self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'this>> {
        self.g2_submsg_opt()
    }
    ...
    pub fn group_two(&self) ->
        Option<
            super::_puroro_nested::msg::_puroro_oneofs::GroupTwo<f32, &'_ str, &'_ self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'_>>
        >
    {
        use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
        #[allow(unused_imports)]
...
type G2SubmsgMessageType<'this> where Self: 'this = &'this self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'this>;
fn g2_submsg_opt<'this>(&'this self) -> Option<Self::G2SubmsgMessageType<'this>> {
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        fn g1_int32<'this>(&'this self) -> i32 {
            self.g1_int32_opt().unwrap_or_else(::std::default::Default::default)
        }
        ...
        fn g1_string<'this>(&'this self) -> &'this str {
            self.g1_string_opt().unwrap_or_else(::std::default::Default::default)
        }
        ...
        fn g2_f32<'this>(&'this self) -> f32 {
            self.g2_f32_opt().unwrap_or_else(::std::default::Default::default)
        }
        ...
        fn g2_string<'this>(&'this self) -> &'this str {
            self.g2_string_opt().unwrap_or_else(::std::default::Default::default)
        }
        ...
        type G2SubmsgMessageType<'this>: self::_puroro_root::oneofs3::_puroro_traits::SubmsgTrait
            where Self: 'this;
        fn g2_submsg<'this>(&'this self) -> ::std::option::Option<Self::G2SubmsgMessageType<'this>> {
            self.g2_submsg_opt()
        }
        ...
        fn g3_int32<'this>(&'this self) -> i32 {
            self.g3_int32_opt().unwrap_or_else(::std::default::Default::default)
        }
        ...
        fn group_one<'this>(&'this self) ->
            ::std::option::Option<
                super::_puroro_nested::msg::_puroro_oneofs::
                    GroupOne<i32, &'this str>
            >
        {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupOne as E;
        ...
        fn group_two<'this>(&'this self) ->
            ::std::option::Option<
                super::_puroro_nested::msg::_puroro_oneofs::
                    GroupTwo<f32, &'this str, Self::G2SubmsgMessageType<'this>>
            >
        {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
    ...
    macro_rules! msg_delegate {
        ($ty:ty) => {
            ...
            type G2SubmsgMessageType<'this> where Self: 'this = <$ty>::G2SubmsgMessageType<'this>;
        ...
        U: MsgTrait,
    {
        ...
        {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupOne as E;
            if let ::std::option::Option::Some(E::G1Int32(val)) =
                self.group_one()
            {
        ...
        {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupOne as E;
            if let ::std::option::Option::Some(E::G1String(val)) =
                self.group_one()
            {
                ::std::option::Option::Some(val)
            } else {
        ...
        {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
            if let ::std::option::Option::Some(E::G2F32(val)) =
                self.group_two()
            {
                ::std::option::Option::Some(val)
            } else {
        ...
        {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
            if let ::std::option::Option::Some(E::G2String(val)) =
                self.group_two()
            {
                ::std::option::Option::Some(val)
            } else {
        ...
        {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
            if let ::std::option::Option::Some(E::G2Submsg(val)) =
                self.group_two()
            {
                ::std::option::Option::Some(val)
            } else {
        ...
        {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupThree as E;
            if let ::std::option::Option::Some(E::G3Int32(val)) =
                self.group_three()
            {
                ::std::option::Option::Some(val)
            } else {
    ...
    where
        ...
        U: MsgTrait,
    {
        type G2SubmsgMessageType<'this> where Self: 'this = ::puroro::Either<
    ...
    where
        T: MsgTrait,
    {
        type G2SubmsgMessageType<'this> where Self: 'this = T::G2SubmsgMessageType<'this>;
    }
    ...
    pub mod msg {
        ...
        pub mod _puroro_oneofs {
                ...
                G1String: ::std::clone::Clone,
            {
                fn clone(&self) -> Self {
                    match self {
                        Self::G1Int32(ref v) => Self::G1Int32(
                            <G1Int32 as ::std::clone::Clone>::clone(v)
                        ),
                        Self::G1String(ref v) => Self::G1String(
                            <G1String as ::std::clone::Clone>::clone(v)
                        ),
                    }
                }
            }
                ...
                G2Submsg: ::std::clone::Clone,
            {
                fn clone(&self) -> Self {
                    match self {
                        Self::G2F32(ref v) => Self::G2F32(
                            <G2F32 as ::std::clone::Clone>::clone(v)
                        ),
                        Self::G2String(ref v) => Self::G2String(
                            <G2String as ::std::clone::Clone>::clone(v)
                        ),
                        Self::G2Submsg(ref v) => Self::G2Submsg(
                            <G2Submsg as ::std::clone::Clone>::clone(v)
                        ),
                    }
                }
            }
                ...
                G3Int32: ::std::clone::Clone,
            {
                fn clone(&self) -> Self {
                    match self {
                        Self::G3Int32(ref v) => Self::G3Int32(
                            <G3Int32 as ::std::clone::Clone>::clone(v)
                        ),
                    }
                }
            }
