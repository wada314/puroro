...
pub struct Msg {
    ...
    >,
    pub group_three: ::std::option::Option<
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "g1_int32",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <Msg as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "i32_unlabeled",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <Submsg as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
            ]
...
pub mod _puroro_impls {
    mod _puroro_root {
        pub use super::super::_puroro_root::*;
    }use super::_puroro_traits::*;impl MsgTrait for () {
...
pub struct MsgBumpalo<'bump> {
    ...
    >,
    group_one: 
        super::_puroro_nested::msg::_puroro_bumpalo_oneofs::GroupOne
        <'bump>
        ,
    group_two: 
        super::_puroro_nested::msg::_puroro_bumpalo_oneofs::GroupTwo
        <'bump>
        ,
    group_three: 
        super::_puroro_nested::msg::_puroro_bumpalo_oneofs::GroupThree
        ,
}
...
type Field5MessageType<'this> where Self: 'this = &'this self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'bump>;
    fn group_one<'this>(&'this self) ->
        Option<
            super::_puroro_nested::msg::_puroro_oneofs::GroupOne
            <'this, ::puroro::internal::bool::False>
        ...
        match oneof_index {
            ...
            1 => ::std::option::Option::Some(
                F::G3Int32(unsafe { 
                    ...
                    self.group_three.G3Int32.clone()
        ...
        I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>
    {
        ...
        match field_number {
            ...
            5 => {
                ...
                DeserFieldFromBytesIter::<
                    ::puroro::tags::OneofField, ::puroro::tags::Message<::puroro::bumpalo::boxed::Box<'bump, self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'bump>>>
                >::deser_field(field_value_mut_ref, data, &self._bump)
            }
            6 => {
                use super::_puroro_nested::msg::_puroro_bumpalo_oneofs::GroupThree as E;
...
impl<'bump> ::puroro::internal::impls::bumpalo::BumpaloClone<'bump> for MsgBumpalo<'bump> {
    fn clone_in(&self, bump: &'bump ::puroro::bumpalo::Bump) -> Self {
        Self { 
            ...
            group_one: ::puroro::internal::impls::bumpalo::BumpaloClone::clone_in(&self.group_one, bump),
            group_two: ::puroro::internal::impls::bumpalo::BumpaloClone::clone_in(&self.group_two, bump),
            group_three: ::puroro::internal::impls::bumpalo::BumpaloClone::clone_in(&self.group_three, bump),
        }
    }
...
impl<'bump> ::puroro::internal::impls::bumpalo::BumpaloClone<'bump> for SubmsgBumpalo<'bump> {
    fn clone_in(&self, bump: &'bump ::puroro::bumpalo::Bump) -> Self {
        Self { 
            _bump: bump,
            _bitfield: self._bitfield,
            i32_unlabeled: ::puroro::internal::impls::bumpalo::BumpaloClone::clone_in(&self.i32_unlabeled, bump),
        }
    }
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        ...
        type Field5MessageType<'this>:
            self::_puroro_root::oneofs3::_puroro_traits::SubmsgTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug
            where Self: 'this;
...
pub mod _puroro_nested {
    pub mod msg {
        ...
        pub mod _puroro_oneofs {
            ...
            {
                G1Int32(i32),
                G1String(<IsOwned as ::puroro::internal::bool::BoolType>::Choose<::std::string::String, &'msg str>),
            }
                ...
                IsOwned: ::puroro::internal::bool::BoolType,
            {
                ...
                pub fn g1_string(self) -> ::std::option::Option<<IsOwned as ::puroro::internal::bool::BoolType>::Choose<::std::string::String, &'msg str>> {
                    match self {
                ...
                T: 'msg + ?Sized + self::_puroro_root::oneofs3::_puroro_traits::MsgTrait,
            {
                ...
                pub fn g2_string(self) -> ::std::option::Option<<IsOwned as ::puroro::internal::bool::BoolType>::Choose<::std::string::String, &'msg str>> {
                    match self {
        ...
        pub mod _puroro_bumpalo_oneofs {
            ...
            pub(crate) union GroupOne<'bump> {
                _None: (),
                G1Int32: i32,
                G1String: ::std::mem::ManuallyDrop<::puroro::bumpalo::collections::String<'bump>>,
            }
            ...
            pub(crate) union GroupTwo<'bump> {
                _None: (),
                G2F32: f32,
                G2String: ::std::mem::ManuallyDrop<::puroro::bumpalo::collections::String<'bump>>,
                G2Submsg: ::std::mem::ManuallyDrop<::puroro::bumpalo::boxed::Box<'bump, self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'bump>>>,
            }
