...
type Field5MessageType<'this> where Self: 'this = &'this self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg;
    ...
    Self: super::_puroro_traits::MsgTrait,
{
        ...
        W: ::std::io::Write,
    {
        ...
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::OneofField, ::puroro::tags::Message<<Self as super::_puroro_traits::MsgTrait>::Field5MessageType<'_>>
        >::ser_field(
...
type Field5MessageType<'this> where Self: 'this = &'this self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'this>;
    fn group_one<'this>(&'this self) ->
        Option<
            super::_puroro_nested::msg::_puroro_oneofs::GroupOne
            <'this>
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        ...
        type Field5MessageType<'this>: self::_puroro_root::oneofs3::_puroro_traits::SubmsgTrait +
            ::puroro::Message<self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg>
            where Self: 'this;
        ...
        fn g2_submsg_opt<'this>(&'this self) -> Option<<Self as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::Field5MessageType<'this>> {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
            self.group_two().and_then(|oneof| {
                #[allow(irrefutable_let_patterns)]
        ...
        U: MsgTrait,
    {
        ...
        fn g1_int32<'this>(&'this self) -> i32 {
            self.g1_int32_opt().unwrap_or_else(|| self.1.g1_int32() )
        }
        
        fn g1_string<'this>(&'this self) -> &'this str {
            self.g1_string_opt().unwrap_or_else(|| self.1.g1_string() )
        }
        
        fn g2_f32<'this>(&'this self) -> f32 {
            self.g2_f32_opt().unwrap_or_else(|| self.1.g2_f32() )
        }
        
        fn g2_string<'this>(&'this self) -> &'this str {
            self.g2_string_opt().unwrap_or_else(|| self.1.g2_string() )
        }type Field5MessageType<'this> where Self: 'this = (
        ...
        fn g2_submsg<'this>(&'this self) -> Self::Field5MessageType<'this> {
            (
                <T as MsgTrait>::g2_submsg(&self.0),
                <U as MsgTrait>::g2_submsg(&self.1)
            )
        }
        
        fn g3_int32<'this>(&'this self) -> i32 {
            self.g3_int32_opt().unwrap_or_else(|| self.1.g3_int32() )
        }
        fn group_one<'this>(&'this self) ->
            Option<
                super::_puroro_nested::msg::_puroro_oneofs::GroupOne
        ...
        U: MsgTrait,
    {
        ...
        fn g2_submsg<'this>(&'this self) -> Self::Field5MessageType<'this> {
            self.as_ref().either(
                |t| ::puroro::Either::Left(<T as MsgTrait>::g2_submsg(t)),
                |u| ::puroro::Either::Right(<U as MsgTrait>::g2_submsg(u)),
            )
        }
    ...
    {
        fn g1_int32<'this>(&'this self) -> i32 {
            self.as_ref().map_or(, |msg| msg.g1_int32())
        }
        fn g1_string<'this>(&'this self) -> &'this str {
            self.as_ref().map_or(, |msg| msg.g1_string())
        }
        fn g2_f32<'this>(&'this self) -> f32 {
            self.as_ref().map_or(, |msg| msg.g2_f32())
        }
        fn g2_string<'this>(&'this self) -> &'this str {
            self.as_ref().map_or(, |msg| msg.g2_string())
        }
        type Field5MessageType<'this> where Self: 'this = ::std::option::Option<T::Field5MessageType<'this>>;
        fn g2_submsg<'this>(&'this self) -> Self::Field5MessageType<'this> {
            self.as_ref().and_then(|msg| msg.g2_submsg_opt())
        }
        fn g3_int32<'this>(&'this self) -> i32 {
            self.as_ref().map_or(, |msg| msg.g3_int32())
        }
        fn group_one<'this>(&'this self) ->
            Option<
                super::_puroro_nested::msg::_puroro_oneofs::GroupOne
    ...
    pub mod msg {
        ...
        pub mod _puroro_oneofs {
                ...
                T: 'msg + ?Sized + self::_puroro_root::oneofs3::_puroro_traits::MsgTrait,
            {
                ...
                pub fn g2_submsg(self) -> ::std::option::Option<<T as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::Field5MessageType<'msg>> {
                    match self {
            ...
            where
                f32: ::std::fmt::Debug,
                &'msg str: ::std::fmt::Debug,
                <T as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::Field5MessageType<'msg>: ::std::fmt::Debug,
                T: 'msg + ?Sized + self::_puroro_root::oneofs3::_puroro_traits::MsgTrait,
            {
                fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                    match self {
            ...
            where
                f32: ::std::clone::Clone,
                &'msg str: ::std::clone::Clone,
                <T as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::Field5MessageType<'msg>: ::std::clone::Clone,
                T: 'msg + ?Sized + self::_puroro_root::oneofs3::_puroro_traits::MsgTrait,
            {
                fn clone(&self) -> Self {
                    match self {
            ...
            where
                ...
                &'msg str: ::std::cmp::PartialEq,
                <T as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::Field5MessageType<'msg>: ::std::cmp::PartialEq,
                T: 'msg + ?Sized + self::_puroro_root::oneofs3::_puroro_traits::MsgTrait,
            {
                fn eq(&self, rhs: &Self) -> bool {
                    match (self, rhs) {
        ...
        pub mod _puroro_private_oneofs {
            ...
            pub(crate) enum GroupTwoBumpalo<'bump> {
                ...
                G2Submsg(::puroro::internal::Bare<::puroro::internal::NoAllocBumpBox<self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'bump>>>),
            }
