...
pub struct MsgSimple {pub g1_int32: i32,pub g1_string: ::std::string::String,pub g2_f32: f32,pub g2_string: ::std::string::String,pub g2_submsg: ::std::option::Option<::std::boxed::Box<self::_puroro_root::oneofs3::_puroro_impls::SubmsgSimple>>,pub g3_int32: i32,
        ...
        I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>
    {
        match field_number {
            ...
            5 => {
                ...
                ::puroro_internal::impls::simple::de::DeserFieldFromBytesIter::<
                    ::puroro::tags::OneofItem, ::puroro::tags::Message<self::_puroro_root::oneofs3::_puroro_impls::SubmsgSimple>
                >::deser_field(field_value_mut_ref, data)
            }
            6 => {
...
impl ::puroro::SerToIoWrite for MsgSimple {
        ...
        W: ::std::io::Write
    {
        ...
        ::puroro_internal::impls::simple::se::SerFieldToIoWrite::<
            ::puroro::tags::Unlabeled, ::puroro::tags::Message<self::_puroro_root::oneofs3::_puroro_impls::SubmsgSimple>
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait: ::std::clone::Clone {
        type Field5MessageType<'this>: 'this + self::_puroro_root::oneofs3::_puroro_traits::SubmsgTrait;
        fn group_one<'this>(&'this self) ->
            ::std::option::Option<
                super::_puroro_nested::msg::_puroro_oneofs::GroupOne
                <'this>
...
pub mod _puroro_nested {
    pub mod msg {
        ...
        pub mod _puroro_oneofs {
            ...
            pub enum GroupTwo
            <'msg, T: self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>
            {
                G2F32(f32),
            ...
            pub enum GroupTwo_Simple
            {
                ...
                G2Submsg(::std::boxed::Box<self::_puroro_root::oneofs3::_puroro_impls::SubmsgSimple>),
            }
            
            impl<'msg> ::std::convert::From<&'msg GroupTwo_Simple> 
            for GroupTwo
                <'msg, self::_puroro_root::oneofs3::_puroro_impls::MsgSimple>
            {
