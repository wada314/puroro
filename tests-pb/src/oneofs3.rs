...
impl Msg {
    ...
    pub fn g2_submsg_mut(&mut self) -> &mut ::std::boxed::Box<self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg>
    {
        use super::_puroro_nested::msg::_puroro_private_oneofs::GroupTwoSimple as E;
        if !matches!(
            &self.group_two,
...
type Field5ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg;

fn g2_submsg_default_value<'this>(&'this self) ->
    Self::Field5ScalarGetterType<'this>
{
    static DEFAULT_VALUE: ::puroro::once_cell::sync::Lazy< self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg
        ...
        I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>
    {
        ...
        match field_number {
            ...
            5 => {
                ...
                DeserFieldFromBytesIter::<
                    ::puroro::tags::OneofField, ::puroro::tags::Message<::std::boxed::Box<self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg>>
                >::deser_field(field_value_mut_ref, data)
            }
            6 => {
                use super::_puroro_nested::msg::_puroro_private_oneofs::GroupThreeSimple as E;
...
where
ScalarType: self::_puroro_root::oneofs3::_puroro_traits::SubmsgTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
...
;
type Field5ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'this>
;
    fn group_one<'this>(&'this self) ->
        Option<
            super::_puroro_nested::msg::_puroro_oneofs::GroupOne
        ...
        I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>
    {
        ...
        match field_number {
            ...
            5 => {
                ...
                DeserFieldFromBytesIter::<
                    ::puroro::tags::OneofField, ::puroro::tags::Message<::puroro::internal::NoAllocBumpBox<self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'bump>>>,
                >::deser_field(field_value_mut_ref, data, self._bump)
            }
            6 => {
                use super::_puroro_nested::msg::_puroro_private_oneofs::GroupThreeBumpalo as E;
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        ...
        fn g1_string_opt<'this>(&'this self) -> Option<<Self as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::Field2ScalarGetterType<'this>> {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupOne as E;
            self.group_one().and_then(|oneof| {
                #[allow(irrefutable_let_patterns)]
        ...
        fn g2_string_opt<'this>(&'this self) -> Option<<Self as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::Field4ScalarGetterType<'this>> {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
            self.group_two().and_then(|oneof| {
                #[allow(irrefutable_let_patterns)]
        ...
        fn g2_submsg_opt<'this>(&'this self) -> Option<<Self as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait>::Field5ScalarGetterType<'this>> {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
            self.group_two().and_then(|oneof| {
                #[allow(irrefutable_let_patterns)]
    ...
    pub mod msg {
        ...
        pub mod _puroro_private_oneofs {
            ...
            pub(crate) enum GroupTwoSimple {
                ...
                G2Submsg(::std::boxed::Box<self::_puroro_root::oneofs3::_puroro_simple_impl::Submsg>),
            }
