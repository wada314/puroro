...
impl Msg {
    pub fn group_one(
        ...
        <self::_puroro_root::oneofs3::msg::GroupOne as self::_puroro::internal::oneof_type::OneofUnion>::CaseRef<
            '_,
        >,
    > {
    ...
    pub fn group_two(
        ...
        <self::_puroro_root::oneofs3::msg::GroupTwo as self::_puroro::internal::oneof_type::OneofUnion>::CaseRef<
            '_,
        >,
    > {
        use self::_puroro::internal::oneof_type::OneofUnion as _;
    ...
    pub fn group_three(
        ...
        <self::_puroro_root::oneofs3::msg::GroupThree as self::_puroro::internal::oneof_type::OneofUnion>::CaseRef<
            '_,
        >,
    > {
        use self::_puroro::internal::oneof_type::OneofUnion as _;
