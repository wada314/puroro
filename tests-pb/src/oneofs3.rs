...
pub struct Msg {
    ...
    g1_int32: self::_puroro::internal::field_types::SingularVariantField<i32, self::_puroro::tags::Int32>,
    ...
    g2_submsg: self::_puroro::internal::field_types::SingularHeapMessageField<_puroro_root::oneofs3::Submsg>,
    // Singular, Variant(Int32)
    g3_int32: self::_puroro::internal::field_types::SingularVariantField<i32, self::_puroro::tags::Int32>,
...
impl Msg {
    ...
    pub fn g2_submsg(&self) -> Option<&_puroro_root::oneofs3::Submsg> {
        <self::_puroro::internal::field_types::SingularHeapMessageField<_puroro_root::oneofs3::Submsg> as self::_puroro::internal::field_types::FieldType>::get_field(
