...
pub mod _puroro_impls {
    ...
    impl<'bump> super::_puroro_traits::MsgTrait for MsgBumpalo<'bump> {
        fn g1_int32<'this>(&'this self) -> i32 {
            self.g1_int32_opt().unwrap_or_default()
        }
        fn g1_string<'this>(&'this self) -> &'this str {
            self.g1_string_opt().unwrap_or_default()
        }
        fn g2_f32<'this>(&'this self) -> f32 {
            self.g2_f32_opt().unwrap_or_default()
        }
        fn g2_string<'this>(&'this self) -> &'this str {
            self.g2_string_opt().unwrap_or_default()
        }
        type Field5MessageType<'this>
        where
            Self: 'this,
        ...
        fn g2_submsg<'this>(&'this self) -> Self::Field5MessageType<'this> {
            <self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'this>>::default_instance()
            /*
            use ::puroro::once_cell::unsync::Lazy;
            static BUMP: Lazy<::puroro::bumpalo::Bump> = Lazy::new(::puroro::bumpalo::Bump::new);
            static DEFAULT_VALUE: Lazy<self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'this>> =
                Lazy::new(|| self::_puroro_root::oneofs3::_puroro_impls::SubmsgBumpalo<'this>::new_in(&BUMP));
            &DEFAULT_VALUE*/
        }
...
pub mod _puroro_traits {
        ...
        T: MsgTrait,
    {
        fn g1_int32<'this>(&'this self) -> i32 {
            self.as_ref()
                .map_or(::std::default::Default::default(), |msg| msg.g1_int32())
        }
        fn g1_string<'this>(&'this self) -> &'this str {
            self.as_ref()
                .map_or(::std::default::Default::default(), |msg| msg.g1_string())
        }
        fn g2_f32<'this>(&'this self) -> f32 {
            self.as_ref()
                .map_or(::std::default::Default::default(), |msg| msg.g2_f32())
        }
        fn g2_string<'this>(&'this self) -> &'this str {
            self.as_ref()
                .map_or(::std::default::Default::default(), |msg| msg.g2_string())
        }
        type Field5MessageType<'this>
        where
            Self: 'this,
        = ::std::option::Option<T::Field5MessageType<'this>>;
        fn g2_submsg<'this>(&'this self) -> Self::Field5MessageType<'this> {
            self.as_ref().and_then(|msg| msg.g2_submsg_opt())
        }
        fn g3_int32<'this>(&'this self) -> i32 {
            self.as_ref()
                .map_or(::std::default::Default::default(), |msg| msg.g3_int32())
        }
        fn group_one<'this>(
            &'this self,
        ) -> Option<super::_puroro_nested::msg::_puroro_oneofs::GroupOne<'this>> {
