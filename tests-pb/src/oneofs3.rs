...
where
    Self: ::puroro_internal::GetImplStruct,
    <Self as ::puroro_internal::GetImplStruct>::Type:
        self::_puroro_root::oneofs3::_puroro_traits::MsgTrait,
{
    type Field5MessageType<'this> = <
        <Self as ::puroro_internal::GetImplStruct>::Type
        as self::_puroro_root::oneofs3::_puroro_traits::MsgTrait
        ...
        self::_puroro_root::oneofs3::_puroro_traits::SubmsgTrait,
{
    fn i32_unlabeled<'this>(&'this self) -> i32 {
        <<Self as ::puroro_internal::GetImplStruct>::Type
            as self::_puroro_root::oneofs3::_puroro_traits::SubmsgTrait
...
mod _puroro_impls {
    ...
    pub struct Msg_Simple {
        ...
        pub g2_submsg: ::std::option::Option<
            ::std::boxed::Box<self::_puroro_root::oneofs3::Submsg<::puroro::tags::SimpleImpl>>,
        >,
        pub g3_int32: i32,
        pub group_one:
...
pub mod _puroro_nested {
    pub mod msg {
        ...
        pub mod _puroro_oneofs {
            ...
            enum GroupTwo<'msg, T: self::_puroro_root::oneofs3::_puroro_traits::MsgTrait> {
                G2F32(f32),
            ...
            impl<'msg> ::std::convert::From<&'msg GroupTwo_Simple>
                for GroupTwo<'msg, self::_puroro_root::oneofs3::Msg<::puroro::tags::SimpleImpl>>
            {
