...
impl Msg {
    ...
    pub fn recursive_unlabeled_mut(&mut self) -> &mut ::std::option::Option<::std::boxed::Box<self::_puroro_root::self_recursive::_puroro_simple_impl::Msg>> {
        &mut self.recursive_unlabeled
    }
}

impl super::_puroro_traits::MsgTrait for Msg {
type Field1MessageType<'this> where Self: 'this = &'this self::_puroro_root::self_recursive::_puroro_simple_impl::Msg;
    ...
    Self: super::_puroro_traits::MsgTrait,
{
        ...
        W: ::std::io::Write,
    {
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::Unlabeled, ::puroro::tags::Message<<Self as super::_puroro_traits::MsgTrait>::Field1MessageType<'_>>
        >::ser_field(
    ...
    Self: super::_puroro_traits::MsgTrait
{
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        f.debug_struct("Msg")
            .field("recursive_unlabeled", &<Self as super::_puroro_traits::MsgTrait>::recursive_unlabeled(self))
            .finish()
    }
}
...
fn recursive_unlabeled_opt<'this>(&'this self) -> ::std::option::Option<Self::Field1MessageType<'this>> {
...
type Field1MessageType<'this> where Self: 'this = &'this self::_puroro_root::self_recursive::_puroro_impls::MsgBumpalo<'this>;
fn recursive_unlabeled_opt<'this>(&'this self) -> Option<Self::Field1MessageType<'this>> {
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        type Field1MessageType<'this>: self::_puroro_root::self_recursive::_puroro_traits::MsgTrait
            where Self: 'this;
        fn recursive_unlabeled<'this>(&'this self) -> ::std::option::Option<Self::Field1MessageType<'this>> {
            self.recursive_unlabeled_opt()
        }
