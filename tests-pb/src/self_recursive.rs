...
pub mod _puroro_traits {
        ...
        U: MsgTrait,
    {
        ...
        fn recursive_unlabeled_opt<'this>(&'this self) -> Option<Self::Field1MessageType<'this>> {
            if <T as MsgTrait>::has_recursive_unlabeled(&self.0)
                || <U as MsgTrait>::has_recursive_unlabeled(&self.1)
            {
                Some((
        ...
        U: MsgTrait,
    {
        ...
        fn recursive_unlabeled<'this>(&'this self) -> Self::Field1MessageType<'this> {
            self.as_ref().either(
                |t| ::puroro::Either::Left(<T as MsgTrait>::recursive_unlabeled(t)),
                |u| ::puroro::Either::Right(<U as MsgTrait>::recursive_unlabeled(u)),
            )
        }
    }
        ...
        T: MsgTrait,
    {
        ...
        where
            Self: 'this,
        = ::std::option::Option<T::Field1MessageType<'this>>;
        fn recursive_unlabeled_opt<'this>(
            &'this self,
        ) -> ::std::option::Option<Self::Field1MessageType<'this>> {
            self.as_ref()
                .and_then(|msg| msg.recursive_unlabeled_opt())
