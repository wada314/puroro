...
pub struct ConflictCase {
    fields: self::_root::message::_fields::ConflictCaseFields<
    ...
    TThisIsOneofField: self::_pinternal::OneofFieldType,
{
    pub(crate) fn this_is_oneof_field<B: self::_pinternal::BitSlice>(
        ...
        let field_opt = matches!(
            case_opt, Some(self::_root::message::_case::ConflictCase:: < >
            ::ThisIsOneofField(()))
        )
    ...
    pub(crate) fn this_is_oneof_field_mut<B: self::_pinternal::BitSlice>(
        ...
        use self::_pinternal::OneofFieldType;
        let case_opt = OneofCase::from_bitslice(bits);
        if let Some(self::_root::message::_case::ConflictCase::ThisIsOneofField(()))
            = case_opt {} else {
            <Self as OneofUnion>::clear(self, bits);
            let index = OneofCase::into_u32(
                self::_root::message::_case::ConflictCase::ThisIsOneofField(()),
            );
...
where
    TThisIsOneofField: self::_pinternal::OneofFieldType,
{
    type Case = self::_root::message::_case::ConflictCase;
    type CaseRef<'a> = self::_root::message::_case::ConflictCase::<
