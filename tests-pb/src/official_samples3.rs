...
impl Test3 {
    ...
    pub fn c_mut(&mut self) -> &mut ::std::option::Option<::std::boxed::Box<self::_puroro_root::official_samples3::_puroro_simple_impl::Test1>> {
        &mut self.c
    }
}

impl super::_puroro_traits::Test3Trait for Test3 {
type Field3ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::official_samples3::_puroro_simple_impl::Test1;
...
{
    static DEFAULT_VALUE: ::puroro::once_cell::sync::Lazy< self::_puroro_root::official_samples3::_puroro_simple_impl::Test1
    ...
    Self: super::_puroro_traits::Test3Trait,
{
    ...
    {
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::Unlabeled, ::puroro::tags::Message<<Self as super::_puroro_traits::Test3Trait>::Field3ScalarGetterType<'_>>
        >::ser_field(
...
where
ScalarType: self::_puroro_root::official_samples3::_puroro_traits::Test1Trait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub c: ScalarType,
}
...
type Field3ScalarGetterType<'this> where Self: 'this = &'this self::_puroro_root::official_samples3::_puroro_impls::Test1Bumpalo<'this>
;
fn c_opt<'this>(&'this self) -> Option<Self::Field3ScalarGetterType<'this>> {
    <Self>::c_opt(self)
}
