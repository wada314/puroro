...
pub mod _puroro_impls {
    ...
    impl<'bump, BT> ::puroro::BumpaloMessage<'bump> for Test1Bumpalo<BT>
    where
        BT: ::puroro::BumpTypes + ::std::fmt::Debug + ::std::cmp::PartialEq,
    {
        type BumpTypes = BT;
    ...
    impl<'bump, BT> ::puroro::BumpaloMessage<'bump> for Test2Bumpalo<BT>
    where
        BT: ::puroro::BumpTypes + ::std::fmt::Debug + ::std::cmp::PartialEq,
    {
        type BumpTypes = BT;
        ...
        BT: ::puroro::BumpTypes + ::std::fmt::Debug + ::std::cmp::PartialEq,
    {
        ...
        c: ::std::option::Option<
            ::puroro::bumpalo::boxed::Box<
                'static,
                self::_puroro_root::official_samples3::_puroro_impls::Test1Bumpalo<BT::AsStatic>,
            >,
        >,
    ...
    impl<'bump, BT> ::puroro::BumpaloMessage<'bump> for Test3Bumpalo<BT>
    where
        BT: ::puroro::BumpTypes + ::std::fmt::Debug + ::std::cmp::PartialEq,
    {
        type BumpTypes = BT;
        ...
        BT: ::puroro::BumpTypes + ::std::fmt::Debug + ::std::cmp::PartialEq,
    {
        ...
        where
            Self: 'this,
        = &'this self::_puroro_root::official_samples3::_puroro_impls::Test1Bumpalo<BT>;
        fn c_opt<'this>(&'this self) -> Option<Self::Field3MessageType<'this>> {
    ...
    impl<'bump, BT> ::puroro::BumpaloMessage<'bump> for Test4Bumpalo<BT>
    where
        BT: ::puroro::BumpTypes + ::std::fmt::Debug + ::std::cmp::PartialEq,
    {
        type BumpTypes = BT;
