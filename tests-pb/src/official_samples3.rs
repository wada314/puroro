...
type Field3MessageType<'this> where Self: 'this = &'this self::_puroro_root::official_samples3::_puroro_simple_impl::Test1;
    ...
    Self: super::_puroro_traits::Test3Trait,
{
    ...
    {
        ::puroro::internal::se::SerFieldToIoWrite::<
            ::puroro::tags::Unlabeled, ::puroro::tags::Message<<Self as super::_puroro_traits::Test3Trait>::Field3MessageType<'_>>
        >::ser_field(
...
type Field3MessageType<'this> where Self: 'this = &'this self::_puroro_root::official_samples3::_puroro_impls::Test1Bumpalo<'this>;
fn c_opt<'this>(&'this self) -> Option<Self::Field3MessageType<'this>> {
    <Self>::c_opt(self)
}
}
