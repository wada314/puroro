...
pub struct Test1Template<Fields, Shared>
    where Fields: Test1TemplateFieldTypes
{
    _shared: Shared,
...
pub struct Test2Template<Fields, Shared>
    where Fields: Test2TemplateFieldTypes
{
    _shared: Shared,
...
pub struct Test3Template<Fields, Shared>
    where Fields: Test3TemplateFieldTypes
{
    _shared: Shared,
...
impl ::puroro::internal::FieldProperties for Test3FieldProperties<3> {
    ...
    const OPTIONAL_FIELD_BITFIELD_INDEX: usize = 0;
    type LabelTag = ::puroro::tags::Unlabeled;
    type TypeTag = ::puroro::tags::Message<self::_puroro_root::official_samples3::Test1MessageProperties>;
    const DEFAULT_VALUE: <Self::TypeTag as tags::FieldTypeTag>::DefaultValueType = ::std::default::Default::default();
}
...
pub struct Test4Template<Fields, Shared>
    where Fields: Test4TemplateFieldTypes
{
    _shared: Shared,
