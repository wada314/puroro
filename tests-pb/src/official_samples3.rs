...
pub mod _puroro_simple_impl {
    ...
    impl super::_puroro_traits::Test3Trait for Test3 {
        ...
        fn c<'this>(&'this self) -> Self::Field3MessageType<'this> {
            self.c_opt().unwrap_or(
        <self::_puroro_root::official_samples3::_puroro_simple_impl::Test1>::default_instance()
    )
        }
    }
...
pub mod _puroro_impls {
    ...
    impl<'bump> Test1Bumpalo<'bump> {
        ...
        pub fn default_instance() -> &'static self::Test1Bumpalo<'static> {
    ...
    impl<'bump> Test2Bumpalo<'bump> {
        ...
        pub fn default_instance() -> &'static self::Test2Bumpalo<'static> {
            use ::puroro::bumpalo::Bump;
            use ::puroro::once_cell::sync::Lazy;
            static BUMP: Lazy<Bump> = Lazy::new(|| Bump::new());
    ...
    impl<'bump> Test3Bumpalo<'bump> {
        ...
        pub fn default_instance() -> &'static self::Test3Bumpalo<'static> {
            use ::puroro::bumpalo::Bump;
            use ::puroro::once_cell::sync::Lazy;
            static BUMP: Lazy<Bump> = Lazy::new(|| Bump::new());
    ...
    impl<'bump> super::_puroro_traits::Test3Trait for Test3Bumpalo<'bump> {
        ...
        fn c<'this>(&'this self) -> Self::Field3MessageType<'this> {
            self.c_opt().unwrap_or(
        <self::_puroro_root::official_samples3::_puroro_impls::Test1Bumpalo<'this>>::default_instance()
    )
        }
    }
    ...
    impl<'bump> Test4Bumpalo<'bump> {
        ...
        pub fn default_instance() -> &'static self::Test4Bumpalo<'static> {
            use ::puroro::bumpalo::Bump;
            use ::puroro::once_cell::sync::Lazy;
            static BUMP: Lazy<Bump> = Lazy::new(|| Bump::new());
...
pub mod _puroro_traits {
        ...
        T: Test1Trait,
    {
        ...
        fn a<'this>(&'this self) -> i32 {
            self.as_ref()
                .map_or(::std::default::Default::default(), |msg| msg.a())
        }
    }
        ...
        T: Test2Trait,
    {
        ...
        fn b<'this>(&'this self) -> &'this str {
            self.as_ref()
                .map_or(::std::default::Default::default(), |msg| msg.b())
        }
    }
        ...
        U: Test3Trait,
    {
        ...
        fn c_opt<'this>(&'this self) -> Option<Self::Field3MessageType<'this>> {
            if <T as Test3Trait>::has_c(&self.0) || <U as Test3Trait>::has_c(&self.1) {
                Some((<T as Test3Trait>::c(&self.0), <U as Test3Trait>::c(&self.1)))
            } else {
                None
            }
        }
        ...
        fn c<'this>(&'this self) -> Self::Field3MessageType<'this> {
            (<T as Test3Trait>::c(&self.0), <U as Test3Trait>::c(&self.1))
        }
    }
        ...
        T: Test3Trait,
    {
        ...
        where
            Self: 'this,
        = ::std::option::Option<T::Field3MessageType<'this>>;
        fn c_opt<'this>(&'this self) -> ::std::option::Option<Self::Field3MessageType<'this>> {
            self.as_ref()
                .and_then(|msg| msg.c_opt())
