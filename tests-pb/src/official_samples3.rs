...
pub struct Test3 {
    ...
    c: self::_puroro::internal::field_types::SingularHeapMessageField<_puroro_root::official_samples3::Test1>,
...
impl Test3 {
    ...
    pub fn c(&self) -> Option<&_puroro_root::official_samples3::Test1> {
        <self::_puroro::internal::field_types::SingularHeapMessageField<_puroro_root::official_samples3::Test1> as self::_puroro::internal::field_types::FieldType>::get_field(
...
impl self::_puroro::Message for Test3 {
    fn from_bytes_iter<I: ::std::iter::Iterator<Item=::std::io::Result<u8>>>(iter: I) -> self::_puroro::Result<Self> {
        ...
        while peekable.peek().is_some() {
            ...
            match number {
                3 => <
                    self::_puroro::internal::field_types::SingularHeapMessageField<_puroro_root::official_samples3::Test1> as self::_puroro::internal::field_types::FieldType
                >::deser_from_iter(
                    &mut msg.c,
                    &mut msg._bitfield,
                    field_data,
