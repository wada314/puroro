...
type Field5MessageType<'this> where Self: 'this = &'this self::_puroro_root::oneofs2::_puroro_impls::SubmsgBumpalo<'bump>;
    fn group_one<'this>(&'this self) ->
        Option<
            super::_puroro_nested::msg::_puroro_oneofs::GroupOne
            <'this, ::puroro::internal::bool::False>
        ...
        I: ::std::iter::Iterator<Item = ::std::io::Result<u8>>
    {
        ...
        match field_number {
            ...
            5 => {
                ...
                DeserFieldFromBytesIter::<
                    ::puroro::tags::OneofField, ::puroro::tags::Message<::puroro::bumpalo::boxed::Box<'bump, self::_puroro_root::oneofs2::_puroro_impls::SubmsgBumpalo<'bump>>>
                >::deser_field(field_value_mut_ref, data, &self._bump)
            }
            6 => {
                use super::_puroro_nested::msg::_puroro_bumpalo_oneofs::GroupThree as E;
...
impl<'bump> ::puroro::internal::impls::bumpalo::BumpaloClone<'bump> for SubmsgBumpalo<'bump> {
    fn clone_in(&self, bump: &'bump ::puroro::bumpalo::Bump) -> Self {
        Self { 
            _bump: bump,
            _bitfield: self._bitfield,
            i32_optional: ::puroro::internal::impls::bumpalo::BumpaloClone::clone_in(&self.i32_optional, bump),
        }
    }
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        ...
        type Field5MessageType<'this>:
            self::_puroro_root::oneofs2::_puroro_traits::SubmsgTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug
            where Self: 'this;
    ...
    pub mod msg {
        ...
        pub mod _puroro_bumpalo_oneofs {
            ...
            pub(crate) union GroupTwo<'bump> {
                ...
                G2Submsg: ::std::mem::ManuallyDrop<::puroro::bumpalo::boxed::Box<'bump, self::_puroro_root::oneofs2::_puroro_impls::SubmsgBumpalo<'bump>>>,
            }
