...
type Field5MessageType<'this> where Self: 'this = &'this self::_puroro_root::oneofs2::_puroro_simple_impl::Submsg;
...
type Field5MessageType<'this> where Self: 'this = &'this self::_puroro_root::oneofs2::_puroro_impls::SubmsgBumpalo<'this>;
    fn group_one<'this>(&'this self) ->
        Option<
            super::_puroro_nested::msg::_puroro_oneofs::GroupOne
            <'this>
...
pub mod _puroro_traits {
    ...
    pub trait MsgTrait {
        ...
        fn g2_submsg_opt<'this>(&'this self) -> Option<<Self as self::_puroro_root::oneofs2::_puroro_traits::MsgTrait>::Field5MessageType<'this>> {
            use super::_puroro_nested::msg::_puroro_oneofs::GroupTwo as E;
            self.group_two().and_then(|oneof| {
                #[allow(irrefutable_let_patterns)]
    ...
    pub mod msg {
        ...
        pub mod _puroro_oneofs {
                ...
                T: 'msg + ?Sized + self::_puroro_root::oneofs2::_puroro_traits::MsgTrait,
            {
                ...
                pub fn g2_submsg(self) -> ::std::option::Option<<T as self::_puroro_root::oneofs2::_puroro_traits::MsgTrait>::Field5MessageType<'msg>> {
                    match self {
            ...
            where
                f32: ::std::fmt::Debug,
                &'msg str: ::std::fmt::Debug,
                <T as self::_puroro_root::oneofs2::_puroro_traits::MsgTrait>::Field5MessageType<'msg>: ::std::fmt::Debug,
                T: 'msg + ?Sized + self::_puroro_root::oneofs2::_puroro_traits::MsgTrait,
            {
                fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                    match self {
            ...
            where
                f32: ::std::clone::Clone,
                &'msg str: ::std::clone::Clone,
                <T as self::_puroro_root::oneofs2::_puroro_traits::MsgTrait>::Field5MessageType<'msg>: ::std::clone::Clone,
                T: 'msg + ?Sized + self::_puroro_root::oneofs2::_puroro_traits::MsgTrait,
            {
                fn clone(&self) -> Self {
                    match self {
            ...
            where
                ...
                &'msg str: ::std::cmp::PartialEq,
                <T as self::_puroro_root::oneofs2::_puroro_traits::MsgTrait>::Field5MessageType<'msg>: ::std::cmp::PartialEq,
                T: 'msg + ?Sized + self::_puroro_root::oneofs2::_puroro_traits::MsgTrait,
            {
                fn eq(&self, rhs: &Self) -> bool {
                    match (self, rhs) {
        ...
        pub mod _puroro_private_oneofs {
            ...
            pub(crate) enum GroupTwoBumpalo<'bump> {
                ...
                G2Submsg(::puroro::internal::Bare<::puroro::internal::NoAllocBumpBox<self::_puroro_root::oneofs2::_puroro_impls::SubmsgBumpalo<'bump>>>),
            }
