...
pub struct Msg {
    group_one: self::_puroro_root::oneofs2::msg::group_one,
    group_two: self::_puroro_root::oneofs2::msg::group_two,
    group_three: self::_puroro_root::oneofs2::msg::group_three,
