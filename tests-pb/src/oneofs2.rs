...
pub mod _puroro_simple_impl {
    ...
    pub struct Msg {
        ...
        group_one: super::_puroro_nested::msg::_puroro_private_oneofs::GroupOneSimple,
        group_two: super::_puroro_nested::msg::_puroro_private_oneofs::GroupTwoSimple,
        group_three: super::_puroro_nested::msg::_puroro_private_oneofs::GroupThreeSimple,
    }
    ...
    impl Msg {
        ...
        pub fn g1_string_mut(&mut self) -> &'_ mut ::std::string::String {
            ...
            if !matches!(&self.group_one, E::G1String(_)) {
                self.group_one = E::G1String(::std::default::Default::default());
            }
            match &mut self.group_one {
                E::G1String(ref mut v) => v,
                _ => unreachable!(),
            }
        }
        ...
        pub fn g2_string_mut(&mut self) -> &'_ mut ::std::string::String {
            ...
            if !matches!(&self.group_two, E::G2String(_)) {
                self.group_two = E::G2String(::std::default::Default::default());
            }
            match &mut self.group_two {
                E::G2String(ref mut v) => v,
                _ => unreachable!(),
            }
        }
        pub fn g2_submsg_mut(
            &mut self,
        ) -> &'_ mut self::_puroro_root::oneofs2::_puroro_simple_impl::Submsg {
            use super::_puroro_nested::msg::_puroro_private_oneofs::GroupTwoSimple as E;
            if !matches!(&self.group_two, E::G2Submsg(_)) {
                self.group_two = E::G2Submsg(::std::default::Default::default());
            }
            match &mut self.group_two {
                E::G2Submsg(ref mut v) => v,
                _ => unreachable!(),
            }
        }
    ...
    impl ::puroro::internal::se::SerMessageToIoWrite for Msg {
            ...
            W: ::std::io::Write,
        {
            ::puroro::internal::se::SerFieldToIoWrite::<
                ::puroro::tags::OneofField,
                ::puroro::tags::Int32,
            >::ser_field(self.g1_int32_opt(), 1, out, false)?;
            ::puroro::internal::se::SerFieldToIoWrite::<
                ::puroro::tags::OneofField,
                ::puroro::tags::String,
            >::ser_field(self.g1_string_opt(), 2, out, false)?;
            ::puroro::internal::se::SerFieldToIoWrite::<
                ::puroro::tags::OneofField,
                ::puroro::tags::Float,
            >::ser_field(self.g2_f32_opt(), 3, out, false)?;
            ::puroro::internal::se::SerFieldToIoWrite::<
                ::puroro::tags::OneofField,
                ::puroro::tags::String,
            >::ser_field(self.g2_string_opt(), 4, out, false)?;
            ::puroro::internal::se::SerFieldToIoWrite::<
                ::puroro::tags::OneofField,
                ::puroro::tags::Message<
                    <Self as super::_puroro_traits::MsgTrait>::G2SubmsgMessageType<'_>,
                >,
            >::ser_field(self.g2_submsg_opt(), 5, out, false)?;
            ::puroro::internal::se::SerFieldToIoWrite::<
                ::puroro::tags::OneofField,
                ::puroro::tags::Int32,
            >::ser_field(self.g3_int32_opt(), 6, out, false)?;
    ...
    impl ::puroro::internal::se::SerMessageToIoWrite for Submsg {
            ...
            W: ::std::io::Write,
        {
            ::puroro::internal::se::SerFieldToIoWrite::<
                ...
                ::puroro::tags::Int32,
            >::ser_field(self.i32_optional_opt(), 1, out, false)?;
            ::std::result::Result::Ok(())
        }
    }
    ...
    pub mod msg {
        ...
        pub mod _puroro_oneofs {
                ...
                T: 'msg + ?Sized + self::_puroro_root::oneofs2::_puroro_traits::MsgTrait,
            {
                G2F32(f32),
                G2String(&'msg str),
                G2Submsg(<T as self::_puroro_root::oneofs2::_puroro_traits::MsgTrait>::G2SubmsgMessageType<'msg>),
            }
                ...
                T: 'msg + ?Sized + self::_puroro_root::oneofs2::_puroro_traits::MsgTrait,
            {
                ...
                pub fn g2_submsg(self) -> ::std::option::Option<<T as self::_puroro_root::oneofs2::_puroro_traits::MsgTrait>::G2SubmsgMessageType<'msg>>{
                    match self {
            ...
            where
                f32: ::std::fmt::Debug,
                &'msg str: ::std::fmt::Debug,
                <T as self::_puroro_root::oneofs2::_puroro_traits::MsgTrait>::G2SubmsgMessageType<
                    'msg,
                >: ::std::fmt::Debug,
                T: 'msg + ?Sized + self::_puroro_root::oneofs2::_puroro_traits::MsgTrait,
            {
        ...
        pub mod _puroro_private_oneofs {
            ...
            impl ::std::default::Default for GroupOneSimple {
                fn default() -> Self {
                    Self::_None
                }
            }
            ...
            impl ::std::default::Default for GroupTwoSimple {
                fn default() -> Self {
                    Self::_None
                }
            }
            ...
            impl ::std::default::Default for GroupThreeSimple {
                fn default() -> Self {
                    Self::_None
                }
            }
