...
impl Msg {
    pub fn group_one(
        ...
        self::_puroro_root::oneofs2::msg::GroupOneCase::<i32, &str>,
    > {
    ...
    pub fn group_two(
        ...
        self::_puroro_root::oneofs2::msg::GroupTwoCase::<
            f32,
            &str,
            &self::_puroro_root::oneofs2::Submsg,
        >,
    ...
    pub fn group_three(
        &self,
    ) -> ::std::option::Option<self::_puroro_root::oneofs2::msg::GroupThreeCase::<i32>> {
        use self::_puroro::internal::oneof_type::OneofUnion as _;
...
impl ::std::clone::Clone for Msg {
    fn clone(&self) -> Self {
        Self {
            group_one: self::_puroro::internal::oneof_type::OneofUnion::clone(
                &self.group_one,
                &self._bitfield,
            ),
            group_two: self::_puroro::internal::oneof_type::OneofUnion::clone(
                &self.group_two,
                &self._bitfield,
            ),
            group_three: self::_puroro::internal::oneof_type::OneofUnion::clone(
                &self.group_three,
                &self._bitfield,
            ),
