    ...
    fn met_field<T: ::puroro::deserializer::stream::LengthDelimitedDeserializer>(
        ...
        match field {
            ::puroro::deserializer::stream::Field::Variant(variant) => match field_number {
                ...
                2 => {
                    *MaybeRepeatedField::last_mut(&mut self.supported_features) = variant.to_native::<::puroro::tags::UInt64>()?;
                }
...
pub struct File {
    ...
    pub generated_code_info: ::std::option::Optional<::std::boxed::Box<super::super::super::super::google::protobuf::GeneratedCodeInfo>>,
}
    ...
    fn met_field<T: ::puroro::deserializer::stream::LengthDelimitedDeserializer>(
        ...
        match field {
            ...
            ::puroro::deserializer::stream::Field::LengthDelimited(ldd) => match field_number {
                ...
                2 => {
                    *MaybeRepeatedField::last_mut(&mut self.insertion_point) 
                        = ldd.deserialize_as_chars().collect::<::puroro::Result<_>>()?;
                }
                15 => {
                    *MaybeRepeatedField::last_mut(&mut self.content) 
                        = ldd.deserialize_as_chars().collect::<::puroro::Result<_>>()?;
                }
                16 => {
...
pub struct CodeGeneratorRequest {
    ...
    pub compiler_version: ::std::option::Optional<::std::boxed::Box<super::super::super::google::protobuf::compiler::Version>>,
}
...
impl<'a> ::puroro::deserializer::stream::MessageDeserializeEventHandler for &'a mut CodeGeneratorRequest {
    ...
    fn met_field<T: ::puroro::deserializer::stream::LengthDelimitedDeserializer>(
        ...
        match field {
            ...
            ::puroro::deserializer::stream::Field::LengthDelimited(ldd) => match field_number {
                1 => {
                    *MaybeRepeatedField::last_mut(&mut self.file_to_generate) 
                        = ldd.deserialize_as_chars().collect::<::puroro::Result<_>>()?;
                }
                2 => {
                    *MaybeRepeatedField::last_mut(&mut self.parameter) 
                        = ldd.deserialize_as_chars().collect::<::puroro::Result<_>>()?;
                }
                15 => {
...
impl<'a> ::puroro::deserializer::stream::MessageDeserializeEventHandler for &'a mut Version {
    ...
    fn met_field<T: ::puroro::deserializer::stream::LengthDelimitedDeserializer>(
        ...
        match field {
            ::puroro::deserializer::stream::Field::Variant(variant) => match field_number {
                1 => {
                    *MaybeRepeatedField::last_mut(&mut self.major) = variant.to_native::<::puroro::tags::Int32>()?;
                }
                2 => {
                    *MaybeRepeatedField::last_mut(&mut self.minor) = variant.to_native::<::puroro::tags::Int32>()?;
                }
                3 => {
                    *MaybeRepeatedField::last_mut(&mut self.patch) = variant.to_native::<::puroro::tags::Int32>()?;
                }
