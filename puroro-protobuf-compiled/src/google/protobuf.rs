...
pub struct FileDescriptorSet {
    pub file: ::std::vec::Vec<self::_puroro_root::google::protobuf::_puroro_simple_impl::FileDescriptorProto>,
}
...
type Field1MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::FileDescriptorProto;
type Field1RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
    ...
    ::std::slice::Iter<'this, self::_puroro_root::google::protobuf::_puroro_simple_impl::FileDescriptorProto>>;
...
impl ::puroro::MessageRepresentativeImpl for FileDescriptorSet {
    fn descriptor() -> &'static ::puroro::desc::MessageDescriptor {
        ...
        static LAZY_FIELD_DESCRIPTOR_ARRAY: Lazy<[::puroro::desc::FieldDescriptor; 1]> = Lazy::new(|| {
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "file",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <FileDescriptorSet as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
...
pub struct FileDescriptorProto {
    ...
    pub message_type: ::std::vec::Vec<self::_puroro_root::google::protobuf::_puroro_simple_impl::DescriptorProto>,
    pub enum_type: ::std::vec::Vec<self::_puroro_root::google::protobuf::_puroro_simple_impl::EnumDescriptorProto>,
    pub service: ::std::vec::Vec<self::_puroro_root::google::protobuf::_puroro_simple_impl::ServiceDescriptorProto>,
    pub extension: ::std::vec::Vec<self::_puroro_root::google::protobuf::_puroro_simple_impl::FieldDescriptorProto>,
    pub options: ::std::option::Option<::std::boxed::Box<self::_puroro_root::google::protobuf::_puroro_simple_impl::FileOptions>>,
    pub source_code_info: ::std::option::Option<::std::boxed::Box<self::_puroro_root::google::protobuf::_puroro_simple_impl::SourceCodeInfo>>,
...
fn name<'this>(&'this self) -> Option<&'this str> {
    self.name.as_ref().map(|v| v.as_ref())
}
fn package<'this>(&'this self) -> Option<&'this str> {
...
type Field4MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::DescriptorProto;
type Field4RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
    ...
    ::std::slice::Iter<'this, self::_puroro_root::google::protobuf::_puroro_simple_impl::DescriptorProto>>;
...
type Field5MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::EnumDescriptorProto;
type Field5RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
    ...
    ::std::slice::Iter<'this, self::_puroro_root::google::protobuf::_puroro_simple_impl::EnumDescriptorProto>>;
...
type Field6MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::ServiceDescriptorProto;
type Field6RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
    ...
    ::std::slice::Iter<'this, self::_puroro_root::google::protobuf::_puroro_simple_impl::ServiceDescriptorProto>>;

fn service<'this>(&'this self) -> Self::Field6RepeatedType<'this> {
    ::puroro::internal::impls::simple::BorrowedIter::new(self.service.iter())
}
type Field7MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::FieldDescriptorProto;
type Field7RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
    ...
    ::std::slice::Iter<'this, self::_puroro_root::google::protobuf::_puroro_simple_impl::FieldDescriptorProto>>;
...
type Field8MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::FileOptions;
fn options<'this>(&'this self) -> Option<Self::Field8MessageType<'this>> {
    self.options.as_ref().map(|v| v.as_ref())
}
type Field9MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::SourceCodeInfo;
fn source_code_info<'this>(&'this self) -> Option<Self::Field9MessageType<'this>> {
    self.source_code_info.as_ref().map(|v| v.as_ref())
}
fn syntax<'this>(&'this self) -> Option<&'this str> {
...
impl ::puroro::MessageRepresentativeImpl for FileDescriptorProto {
    fn descriptor() -> &'static ::puroro::desc::MessageDescriptor {
        use ::puroro::once_cell::sync::Lazy;
        static LAZY_FIELD_DESCRIPTOR_ARRAY: Lazy<[::puroro::desc::FieldDescriptor; 12]> = Lazy::new(|| {
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "name",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <FileDescriptorProto as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
type Field2MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::FieldDescriptorProto;
...
type Field6MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::FieldDescriptorProto;
type Field6RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
    self::_puroro_root::google::protobuf::_puroro_simple_impl::FieldDescriptorProto,
    ::std::slice::Iter<'this, self::_puroro_root::google::protobuf::_puroro_simple_impl::FieldDescriptorProto>>;
...
type Field3MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::DescriptorProto;
type Field3RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
    self::_puroro_root::google::protobuf::_puroro_simple_impl::DescriptorProto,
    ::std::slice::Iter<'this, self::_puroro_root::google::protobuf::_puroro_simple_impl::DescriptorProto>>;
...
type Field4MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::EnumDescriptorProto;
type Field4RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
    self::_puroro_root::google::protobuf::_puroro_simple_impl::EnumDescriptorProto,
    ::std::slice::Iter<'this, self::_puroro_root::google::protobuf::_puroro_simple_impl::EnumDescriptorProto>>;
...
type Field8MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::OneofDescriptorProto;
type Field8RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
    ...
    ::std::slice::Iter<'this, self::_puroro_root::google::protobuf::_puroro_simple_impl::OneofDescriptorProto>>;
...
type Field7MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::MessageOptions;
...
impl ::puroro::MessageRepresentativeImpl for DescriptorProto {
    fn descriptor() -> &'static ::puroro::desc::MessageDescriptor {
        use ::puroro::once_cell::sync::Lazy;
        static LAZY_FIELD_DESCRIPTOR_ARRAY: Lazy<[::puroro::desc::FieldDescriptor; 10]> = Lazy::new(|| {
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "name",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <DescriptorProto as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
pub struct ExtensionRangeOptions {
    pub uninterpreted_option: ::std::vec::Vec<self::_puroro_root::google::protobuf::_puroro_simple_impl::UninterpretedOption>,
}
...
type Field999MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::UninterpretedOption;
type Field999RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
    ...
    ::std::slice::Iter<'this, self::_puroro_root::google::protobuf::_puroro_simple_impl::UninterpretedOption>>;
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        ...
                        number: 999,
                        lazy_containing_type: Lazy::new(|| <ExtensionRangeOptions as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
            ]
...
pub struct FieldDescriptorProto {
    ...
    pub r#type: ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_descriptor_proto::Type>,
    ...
    pub options: ::std::option::Option<::std::boxed::Box<self::_puroro_root::google::protobuf::_puroro_simple_impl::FieldOptions>>,
...
fn label<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::field_descriptor_proto::Label> {
    Clone::clone(&self.label)
}
fn r#type<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::field_descriptor_proto::Type> {
    Clone::clone(&self.r#type)
}
fn type_name<'this>(&'this self) -> Option<&'this str> {
    self.type_name.as_ref().map(|v| v.as_ref())
}
fn extendee<'this>(&'this self) -> Option<&'this str> {
    self.extendee.as_ref().map(|v| v.as_ref())
}
fn default_value<'this>(&'this self) -> Option<&'this str> {
    self.default_value.as_ref().map(|v| v.as_ref())
}
fn oneof_index<'this>(&'this self) -> Option<i32> {
    Clone::clone(&self.oneof_index)
}
fn json_name<'this>(&'this self) -> Option<&'this str> {
    self.json_name.as_ref().map(|v| v.as_ref())
}
type Field8MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::FieldOptions;
fn options<'this>(&'this self) -> Option<Self::Field8MessageType<'this>> {
    self.options.as_ref().map(|v| v.as_ref())
}
...
impl ::puroro::MessageRepresentativeImpl for FieldDescriptorProto {
    fn descriptor() -> &'static ::puroro::desc::MessageDescriptor {
        use ::puroro::once_cell::sync::Lazy;
        static LAZY_FIELD_DESCRIPTOR_ARRAY: Lazy<[::puroro::desc::FieldDescriptor; 11]> = Lazy::new(|| {
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "name",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <FieldDescriptorProto as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
pub struct OneofDescriptorProto {
    pub name: ::std::option::Option<::std::string::String>,
    pub options: ::std::option::Option<::std::boxed::Box<self::_puroro_root::google::protobuf::_puroro_simple_impl::OneofOptions>>,
}
...
type Field2MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::OneofOptions;
...
impl ::puroro::MessageRepresentativeImpl for OneofDescriptorProto {
    fn descriptor() -> &'static ::puroro::desc::MessageDescriptor {
        use ::puroro::once_cell::sync::Lazy;
        static LAZY_FIELD_DESCRIPTOR_ARRAY: Lazy<[::puroro::desc::FieldDescriptor; 2]> = Lazy::new(|| {
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "name",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <OneofDescriptorProto as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
type Field2RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
    ...
    ::std::slice::Iter<'this, self::_puroro_root::google::protobuf::_puroro_simple_impl::EnumValueDescriptorProto>>;

fn value<'this>(&'this self) -> Self::Field2RepeatedType<'this> {
    ::puroro::internal::impls::simple::BorrowedIter::new(self.value.iter())
}
type Field3MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::EnumOptions;
...
impl ::puroro::MessageRepresentativeImpl for EnumDescriptorProto {
    fn descriptor() -> &'static ::puroro::desc::MessageDescriptor {
        use ::puroro::once_cell::sync::Lazy;
        static LAZY_FIELD_DESCRIPTOR_ARRAY: Lazy<[::puroro::desc::FieldDescriptor; 5]> = Lazy::new(|| {
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "name",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <EnumDescriptorProto as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
pub struct EnumValueDescriptorProto {
    pub name: ::std::option::Option<::std::string::String>,
    pub number: ::std::option::Option<i32>,
    pub options: ::std::option::Option<::std::boxed::Box<self::_puroro_root::google::protobuf::_puroro_simple_impl::EnumValueOptions>>,
}
...
type Field3MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::EnumValueOptions;
fn options<'this>(&'this self) -> Option<Self::Field3MessageType<'this>> {
    self.options.as_ref().map(|v| v.as_ref())
}
}
...
impl ::puroro::MessageRepresentativeImpl for EnumValueDescriptorProto {
    fn descriptor() -> &'static ::puroro::desc::MessageDescriptor {
        use ::puroro::once_cell::sync::Lazy;
        static LAZY_FIELD_DESCRIPTOR_ARRAY: Lazy<[::puroro::desc::FieldDescriptor; 3]> = Lazy::new(|| {
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "name",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <EnumValueDescriptorProto as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
pub struct ServiceDescriptorProto {
    pub name: ::std::option::Option<::std::string::String>,
    pub method: ::std::vec::Vec<self::_puroro_root::google::protobuf::_puroro_simple_impl::MethodDescriptorProto>,
    pub options: ::std::option::Option<::std::boxed::Box<self::_puroro_root::google::protobuf::_puroro_simple_impl::ServiceOptions>>,
}
...
type Field2MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::MethodDescriptorProto;
type Field2RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
    self::_puroro_root::google::protobuf::_puroro_simple_impl::MethodDescriptorProto,
    ::std::slice::Iter<'this, self::_puroro_root::google::protobuf::_puroro_simple_impl::MethodDescriptorProto>>;

fn method<'this>(&'this self) -> Self::Field2RepeatedType<'this> {
    ::puroro::internal::impls::simple::BorrowedIter::new(self.method.iter())
}
type Field3MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::ServiceOptions;
fn options<'this>(&'this self) -> Option<Self::Field3MessageType<'this>> {
    self.options.as_ref().map(|v| v.as_ref())
}
}
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "name",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <ServiceDescriptorProto as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
pub struct MethodDescriptorProto {
    ...
    pub options: ::std::option::Option<::std::boxed::Box<self::_puroro_root::google::protobuf::_puroro_simple_impl::MethodOptions>>,
...
fn input_type<'this>(&'this self) -> Option<&'this str> {
    self.input_type.as_ref().map(|v| v.as_ref())
}
fn output_type<'this>(&'this self) -> Option<&'this str> {
    self.output_type.as_ref().map(|v| v.as_ref())
}
type Field4MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::MethodOptions;
...
fn client_streaming<'this>(&'this self) -> Option<bool> {
    ...
    .or(
        <() as super::_puroro_traits::MethodDescriptorProtoTrait>::client_streaming(&())
    )
}
fn server_streaming<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.server_streaming)
    .or(
        <() as super::_puroro_traits::MethodDescriptorProtoTrait>::server_streaming(&())
    )
}
}
...
impl ::puroro::MessageRepresentativeImpl for MethodDescriptorProto {
    fn descriptor() -> &'static ::puroro::desc::MessageDescriptor {
        use ::puroro::once_cell::sync::Lazy;
        static LAZY_FIELD_DESCRIPTOR_ARRAY: Lazy<[::puroro::desc::FieldDescriptor; 6]> = Lazy::new(|| {
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "name",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <MethodDescriptorProto as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
impl ::puroro::internal::SerializableMessageToIoWrite for MethodDescriptorProto {
        ...
        W: ::std::io::Write
    {
        ...
        if <Self as super::_puroro_traits::MethodDescriptorProtoTrait>::client_streaming(self) !=
            <() as super::_puroro_traits::MethodDescriptorProtoTrait>::client_streaming(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::MethodDescriptorProtoTrait>::server_streaming(self) !=
            <() as super::_puroro_traits::MethodDescriptorProtoTrait>::server_streaming(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
...
fn java_package<'this>(&'this self) -> Option<&'this str> {
    self.java_package.as_ref().map(|v| v.as_ref())
}
fn java_outer_classname<'this>(&'this self) -> Option<&'this str> {
...
fn java_multiple_files<'this>(&'this self) -> Option<bool> {
    ...
    .or(
        <() as super::_puroro_traits::FileOptionsTrait>::java_multiple_files(&())
    )
}
...
fn java_string_check_utf8<'this>(&'this self) -> Option<bool> {
    ...
    .or(
        <() as super::_puroro_traits::FileOptionsTrait>::java_string_check_utf8(&())
    )
}
fn optimize_for<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::file_options::OptimizeMode> {
    Clone::clone(&self.optimize_for)
    .or(
        <() as super::_puroro_traits::FileOptionsTrait>::optimize_for(&())
    )
}
fn go_package<'this>(&'this self) -> Option<&'this str> {
...
fn cc_generic_services<'this>(&'this self) -> Option<bool> {
    ...
    .or(
        <() as super::_puroro_traits::FileOptionsTrait>::cc_generic_services(&())
    )
}
fn java_generic_services<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.java_generic_services)
    .or(
        <() as super::_puroro_traits::FileOptionsTrait>::java_generic_services(&())
    )
}
fn py_generic_services<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.py_generic_services)
    .or(
        <() as super::_puroro_traits::FileOptionsTrait>::py_generic_services(&())
    )
}
fn php_generic_services<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.php_generic_services)
    .or(
        <() as super::_puroro_traits::FileOptionsTrait>::php_generic_services(&())
    )
}
fn deprecated<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.deprecated)
    .or(
        <() as super::_puroro_traits::FileOptionsTrait>::deprecated(&())
    )
}
fn cc_enable_arenas<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.cc_enable_arenas)
    .or(
        <() as super::_puroro_traits::FileOptionsTrait>::cc_enable_arenas(&())
    )
}
fn objc_class_prefix<'this>(&'this self) -> Option<&'this str> {
    self.objc_class_prefix.as_ref().map(|v| v.as_ref())
}
fn csharp_namespace<'this>(&'this self) -> Option<&'this str> {
    self.csharp_namespace.as_ref().map(|v| v.as_ref())
}
fn swift_prefix<'this>(&'this self) -> Option<&'this str> {
    self.swift_prefix.as_ref().map(|v| v.as_ref())
}
fn php_class_prefix<'this>(&'this self) -> Option<&'this str> {
    self.php_class_prefix.as_ref().map(|v| v.as_ref())
}
fn php_namespace<'this>(&'this self) -> Option<&'this str> {
    self.php_namespace.as_ref().map(|v| v.as_ref())
}
fn php_metadata_namespace<'this>(&'this self) -> Option<&'this str> {
    self.php_metadata_namespace.as_ref().map(|v| v.as_ref())
}
fn ruby_package<'this>(&'this self) -> Option<&'this str> {
...
impl ::puroro::MessageRepresentativeImpl for FileOptions {
    fn descriptor() -> &'static ::puroro::desc::MessageDescriptor {
        use ::puroro::once_cell::sync::Lazy;
        static LAZY_FIELD_DESCRIPTOR_ARRAY: Lazy<[::puroro::desc::FieldDescriptor; 21]> = Lazy::new(|| {
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "java_package",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <FileOptions as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
impl ::puroro::internal::SerializableMessageToIoWrite for FileOptions {
        ...
        W: ::std::io::Write
    {
        ...
        if <Self as super::_puroro_traits::FileOptionsTrait>::java_multiple_files(self) !=
            <() as super::_puroro_traits::FileOptionsTrait>::java_multiple_files(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::FileOptionsTrait>::java_string_check_utf8(self) !=
            <() as super::_puroro_traits::FileOptionsTrait>::java_string_check_utf8(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::FileOptionsTrait>::optimize_for(self) !=
            <() as super::_puroro_traits::FileOptionsTrait>::optimize_for(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Enum2<self::_puroro_root::google::protobuf::_puroro_nested::file_options::OptimizeMode>
        ...
        if <Self as super::_puroro_traits::FileOptionsTrait>::cc_generic_services(self) !=
            <() as super::_puroro_traits::FileOptionsTrait>::cc_generic_services(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::FileOptionsTrait>::java_generic_services(self) !=
            <() as super::_puroro_traits::FileOptionsTrait>::java_generic_services(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::FileOptionsTrait>::py_generic_services(self) !=
            <() as super::_puroro_traits::FileOptionsTrait>::py_generic_services(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::FileOptionsTrait>::php_generic_services(self) !=
            <() as super::_puroro_traits::FileOptionsTrait>::php_generic_services(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::FileOptionsTrait>::deprecated(self) !=
            <() as super::_puroro_traits::FileOptionsTrait>::deprecated(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::FileOptionsTrait>::cc_enable_arenas(self) !=
            <() as super::_puroro_traits::FileOptionsTrait>::cc_enable_arenas(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
...
fn message_set_wire_format<'this>(&'this self) -> Option<bool> {
    ...
    .or(
        <() as super::_puroro_traits::MessageOptionsTrait>::message_set_wire_format(&())
    )
}
fn no_standard_descriptor_accessor<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.no_standard_descriptor_accessor)
    .or(
        <() as super::_puroro_traits::MessageOptionsTrait>::no_standard_descriptor_accessor(&())
    )
}
fn deprecated<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.deprecated)
    .or(
        <() as super::_puroro_traits::MessageOptionsTrait>::deprecated(&())
    )
}
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        ...
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <MessageOptions as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
impl ::puroro::internal::SerializableMessageToIoWrite for MessageOptions {
    ...
    {
        use ::puroro::internal::impls::simple::se::SerFieldToIoWrite;
        if <Self as super::_puroro_traits::MessageOptionsTrait>::message_set_wire_format(self) !=
            <() as super::_puroro_traits::MessageOptionsTrait>::message_set_wire_format(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::MessageOptionsTrait>::no_standard_descriptor_accessor(self) !=
            <() as super::_puroro_traits::MessageOptionsTrait>::no_standard_descriptor_accessor(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::MessageOptionsTrait>::deprecated(self) !=
            <() as super::_puroro_traits::MessageOptionsTrait>::deprecated(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
...
fn ctype<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Ctype> {
    Clone::clone(&self.ctype)
    .or(
        <() as super::_puroro_traits::FieldOptionsTrait>::ctype(&())
    )
}
fn packed<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.packed)
}
fn jstype<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Jstype> {
    Clone::clone(&self.jstype)
    .or(
        <() as super::_puroro_traits::FieldOptionsTrait>::jstype(&())
    )
}
fn lazy<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.lazy)
    .or(
        <() as super::_puroro_traits::FieldOptionsTrait>::lazy(&())
    )
}
fn deprecated<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.deprecated)
    .or(
        <() as super::_puroro_traits::FieldOptionsTrait>::deprecated(&())
    )
}
fn weak<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.weak)
    .or(
        <() as super::_puroro_traits::FieldOptionsTrait>::weak(&())
    )
}
type Field999MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::UninterpretedOption;
type Field999RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
...
impl ::puroro::MessageRepresentativeImpl for FieldOptions {
    fn descriptor() -> &'static ::puroro::desc::MessageDescriptor {
        use ::puroro::once_cell::sync::Lazy;
        static LAZY_FIELD_DESCRIPTOR_ARRAY: Lazy<[::puroro::desc::FieldDescriptor; 7]> = Lazy::new(|| {
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "ctype",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <FieldOptions as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
impl ::puroro::internal::SerializableMessageToIoWrite for FieldOptions {
    ...
    {
        use ::puroro::internal::impls::simple::se::SerFieldToIoWrite;
        if <Self as super::_puroro_traits::FieldOptionsTrait>::ctype(self) !=
            <() as super::_puroro_traits::FieldOptionsTrait>::ctype(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Enum2<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Ctype>
        ...
        if <Self as super::_puroro_traits::FieldOptionsTrait>::jstype(self) !=
            <() as super::_puroro_traits::FieldOptionsTrait>::jstype(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Enum2<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Jstype>
        ...
        if <Self as super::_puroro_traits::FieldOptionsTrait>::lazy(self) !=
            <() as super::_puroro_traits::FieldOptionsTrait>::lazy(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::FieldOptionsTrait>::deprecated(self) !=
            <() as super::_puroro_traits::FieldOptionsTrait>::deprecated(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::FieldOptionsTrait>::weak(self) !=
            <() as super::_puroro_traits::FieldOptionsTrait>::weak(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "uninterpreted_option",
                        number: 999,
                        lazy_containing_type: Lazy::new(|| <OneofOptions as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
            ]
...
fn deprecated<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.deprecated)
    .or(
        <() as super::_puroro_traits::EnumOptionsTrait>::deprecated(&())
    )
}
type Field999MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::UninterpretedOption;
type Field999RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "allow_alias",
                        number: 2,
                        lazy_containing_type: Lazy::new(|| <EnumOptions as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
impl ::puroro::internal::SerializableMessageToIoWrite for EnumOptions {
        ...
        W: ::std::io::Write
    {
        ...
        if <Self as super::_puroro_traits::EnumOptionsTrait>::deprecated(self) !=
            <() as super::_puroro_traits::EnumOptionsTrait>::deprecated(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
...
fn deprecated<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.deprecated)
    .or(
        <() as super::_puroro_traits::EnumValueOptionsTrait>::deprecated(&())
    )
}
type Field999MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::UninterpretedOption;
type Field999RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "deprecated",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <EnumValueOptions as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
impl ::puroro::internal::SerializableMessageToIoWrite for EnumValueOptions {
    ...
    {
        use ::puroro::internal::impls::simple::se::SerFieldToIoWrite;
        if <Self as super::_puroro_traits::EnumValueOptionsTrait>::deprecated(self) !=
            <() as super::_puroro_traits::EnumValueOptionsTrait>::deprecated(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
...
fn deprecated<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.deprecated)
    .or(
        <() as super::_puroro_traits::ServiceOptionsTrait>::deprecated(&())
    )
}
type Field999MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::UninterpretedOption;
type Field999RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "deprecated",
                        number: 33,
                        lazy_containing_type: Lazy::new(|| <ServiceOptions as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
impl ::puroro::internal::SerializableMessageToIoWrite for ServiceOptions {
    ...
    {
        use ::puroro::internal::impls::simple::se::SerFieldToIoWrite;
        if <Self as super::_puroro_traits::ServiceOptionsTrait>::deprecated(self) !=
            <() as super::_puroro_traits::ServiceOptionsTrait>::deprecated(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
...
fn deprecated<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.deprecated)
    .or(
        <() as super::_puroro_traits::MethodOptionsTrait>::deprecated(&())
    )
}
fn idempotency_level<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::method_options::IdempotencyLevel> {
    Clone::clone(&self.idempotency_level)
    .or(
        <() as super::_puroro_traits::MethodOptionsTrait>::idempotency_level(&())
    )
}
type Field999MessageType<'this> where Self: 'this = &'this self::_puroro_root::google::protobuf::_puroro_simple_impl::UninterpretedOption;
type Field999RepeatedType<'this> = ::puroro::internal::impls::simple::BorrowedIter<
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "deprecated",
                        number: 33,
                        lazy_containing_type: Lazy::new(|| <MethodOptions as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
...
impl ::puroro::internal::SerializableMessageToIoWrite for MethodOptions {
    ...
    {
        use ::puroro::internal::impls::simple::se::SerFieldToIoWrite;
        if <Self as super::_puroro_traits::MethodOptionsTrait>::deprecated(self) !=
            <() as super::_puroro_traits::MethodOptionsTrait>::deprecated(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Bool
        ...
        if <Self as super::_puroro_traits::MethodOptionsTrait>::idempotency_level(self) !=
            <() as super::_puroro_traits::MethodOptionsTrait>::idempotency_level(&())
        {
            SerFieldToIoWrite::<
                ::puroro::tags::Optional, ::puroro::tags::Enum2<self::_puroro_root::google::protobuf::_puroro_nested::method_options::IdempotencyLevel>
...
fn identifier_value<'this>(&'this self) -> Option<&'this str> {
...
fn string_value<'this>(&'this self) -> Option<&'this [u8]> {
    self.string_value.as_ref().map(|v| v.as_ref())
}
fn aggregate_value<'this>(&'this self) -> Option<&'this str> {
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "name",
                        number: 2,
                        lazy_containing_type: Lazy::new(|| <UninterpretedOption as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
                {
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "location",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <SourceCodeInfo as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
            ]
            ...
            [
                {
                    let init = ::puroro::internal::FieldDescriptorInitializer {
                        name: "annotation",
                        number: 1,
                        lazy_containing_type: Lazy::new(|| <GeneratedCodeInfo as ::puroro::MessageRepresentativeImpl>::descriptor()),
                    };
                    ::puroro::internal::init_field_descriptor(init)
                },
            ]
...
pub mod _puroro_impls {
    mod _puroro_root {
        pub use super::super::_puroro_root::*;
    }use super::_puroro_traits::*;impl FileDescriptorSetTrait for () {
type Field1MessageType<'this> where Self: 'this = ();
type Field1RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field1MessageType<'this>>;
fn file<'this>(&'this self) -> Self::Field1RepeatedType<'this> {
...
{type Field1MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn file<'this>(&'this self) -> Self::Field1RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as FileDescriptorSetTrait>::file(t)
        )
        .map_right(
            |u| <U as FileDescriptorSetTrait>::file(u)
        )
    )
}
...
where
    T: FileDescriptorSetTrait,
{
type Field1MessageType<'this> where Self: 'this = T::Field1MessageType<'this>;
type Field1RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
        ::std::option::IntoIter<
    ...
    >;
fn file<'this>(&'this self) -> Self::Field1RepeatedType<'this> {
    self.as_ref().map(|msg| msg.file().into_iter()).into_iter().flatten()
}
}
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::FileDescriptorProtoTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
...
type Field3RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<&'this str>;
fn dependency<'this>(&'this self) -> Self::Field3RepeatedType<'this> {
    ::puroro::internal::impls::empty::EmptyRepeatedField::new()
}
type Field10RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<i32>;
fn public_dependency<'this>(&'this self) -> Self::Field10RepeatedType<'this> {
    ::puroro::internal::impls::empty::EmptyRepeatedField::new()
}
type Field11RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<i32>;
fn weak_dependency<'this>(&'this self) -> Self::Field11RepeatedType<'this> {
    ::puroro::internal::impls::empty::EmptyRepeatedField::new()
}
...
type Field7RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field7MessageType<'this>>;
fn extension<'this>(&'this self) -> Self::Field7RepeatedType<'this> {
    ::puroro::internal::impls::empty::EmptyRepeatedField::new()
}
...
fn name<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileDescriptorProtoTrait>::name(&self.1);
    u.or_else(|| <T as FileDescriptorProtoTrait>::name(&self.0))
}
fn package<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileDescriptorProtoTrait>::package(&self.1);
    u.or_else(|| <T as FileDescriptorProtoTrait>::package(&self.0))
}
...
type Field10RepeatedType<'this> where Self: 'this
    = ::puroro::internal::impls::merged::MergedRepeatedField<
...
type Field11RepeatedType<'this> where Self: 'this
    = ::puroro::internal::impls::merged::MergedRepeatedField<
...
}type Field4MessageType<'this> where Self: 'this = ::puroro::Either<
...
}type Field5MessageType<'this> where Self: 'this = ::puroro::Either<
...
}type Field6MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn syntax<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileDescriptorProtoTrait>::syntax(&self.1);
    u.or_else(|| <T as FileDescriptorProtoTrait>::syntax(&self.0))
}
...
{
    self.as_ref().either(
        |t| <T as FileDescriptorProtoTrait>::name(t),
        |u| <U as FileDescriptorProtoTrait>::name(u),
    )
}
fn package<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as FileDescriptorProtoTrait>::package(t),
        |u| <U as FileDescriptorProtoTrait>::package(u),
    )
}
type Field3RepeatedType<'this> where Self: 'this
...
fn dependency<'this>(&'this self) -> Self::Field3RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedField::new(self
        .as_ref()
        .map_left(
            |t| <T as FileDescriptorProtoTrait>::dependency(t)
        )
        .map_right(
            |u| <U as FileDescriptorProtoTrait>::dependency(u)
        )
    )
}
type Field10RepeatedType<'this> where Self: 'this
...
fn public_dependency<'this>(&'this self) -> Self::Field10RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedField::new(self
        .as_ref()
        .map_left(
            |t| <T as FileDescriptorProtoTrait>::public_dependency(t)
        )
        .map_right(
            |u| <U as FileDescriptorProtoTrait>::public_dependency(u)
        )
    )
}
type Field11RepeatedType<'this> where Self: 'this
...
fn weak_dependency<'this>(&'this self) -> Self::Field11RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedField::new(self
        .as_ref()
        .map_left(
            |t| <T as FileDescriptorProtoTrait>::weak_dependency(t)
        )
        .map_right(
            |u| <U as FileDescriptorProtoTrait>::weak_dependency(u)
        )
    )
}
type Field4MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn message_type<'this>(&'this self) -> Self::Field4RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as FileDescriptorProtoTrait>::message_type(t)
        )
        .map_right(
            |u| <U as FileDescriptorProtoTrait>::message_type(u)
        )
    )
}
type Field5MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn enum_type<'this>(&'this self) -> Self::Field5RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as FileDescriptorProtoTrait>::enum_type(t)
        )
        .map_right(
            |u| <U as FileDescriptorProtoTrait>::enum_type(u)
        )
    )
}
type Field6MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn service<'this>(&'this self) -> Self::Field6RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as FileDescriptorProtoTrait>::service(t)
        )
        .map_right(
            |u| <U as FileDescriptorProtoTrait>::service(u)
        )
    )
}
type Field7MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn extension<'this>(&'this self) -> Self::Field7RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as FileDescriptorProtoTrait>::extension(t)
        )
        .map_right(
            |u| <U as FileDescriptorProtoTrait>::extension(u)
        )
    )
}
type Field8MessageType<'this> where Self: 'this = ::puroro::Either<
...
{
    self.as_ref().either(
        |t| <T as FileDescriptorProtoTrait>::options(t).map(
            |t| ::puroro::Either::Left(t)
        ),
        |u| <U as FileDescriptorProtoTrait>::options(u).map(
            |u| ::puroro::Either::Right(u)
        ),
    )
}
type Field9MessageType<'this> where Self: 'this = ::puroro::Either<
...
{
    self.as_ref().either(
        |t| <T as FileDescriptorProtoTrait>::source_code_info(t).map(
            |t| ::puroro::Either::Left(t)
        ),
        |u| <U as FileDescriptorProtoTrait>::source_code_info(u).map(
            |u| ::puroro::Either::Right(u)
        ),
    )
}
...
{
    self.as_ref().either(
        |t| <T as FileDescriptorProtoTrait>::syntax(t),
        |u| <U as FileDescriptorProtoTrait>::syntax(u),
    )
}
...
where
    T: FileDescriptorProtoTrait,
{
fn name<'this>(&'this self) -> ::std::option::Option<&'this str> {
    self.as_ref().and_then(|msg| msg.name())
}
fn package<'this>(&'this self) -> ::std::option::Option<&'this str> {
...
type Field3RepeatedType<'this> where Self: 'this =
    ...
    >;
fn dependency<'this>(&'this self) -> Self::Field3RepeatedType<'this> {
    self.as_ref().map(|msg| msg.dependency().into_iter()).into_iter().flatten()
}
type Field10RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
        ::std::option::IntoIter<
    ...
    >;
fn public_dependency<'this>(&'this self) -> Self::Field10RepeatedType<'this> {
    self.as_ref().map(|msg| msg.public_dependency().into_iter()).into_iter().flatten()
}
type Field11RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
        ::std::option::IntoIter<
    ...
    >;
fn weak_dependency<'this>(&'this self) -> Self::Field11RepeatedType<'this> {
    self.as_ref().map(|msg| msg.weak_dependency().into_iter()).into_iter().flatten()
}
type Field4MessageType<'this> where Self: 'this = T::Field4MessageType<'this>;
type Field4RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
        ::std::option::IntoIter<
    ...
    >;
fn message_type<'this>(&'this self) -> Self::Field4RepeatedType<'this> {
    self.as_ref().map(|msg| msg.message_type().into_iter()).into_iter().flatten()
}
type Field5MessageType<'this> where Self: 'this = T::Field5MessageType<'this>;
type Field5RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
        ::std::option::IntoIter<
    ...
    >;
fn enum_type<'this>(&'this self) -> Self::Field5RepeatedType<'this> {
    self.as_ref().map(|msg| msg.enum_type().into_iter()).into_iter().flatten()
}
type Field6MessageType<'this> where Self: 'this = T::Field6MessageType<'this>;
type Field6RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
        ::std::option::IntoIter<
    ...
    >;
fn service<'this>(&'this self) -> Self::Field6RepeatedType<'this> {
    self.as_ref().map(|msg| msg.service().into_iter()).into_iter().flatten()
}
type Field7MessageType<'this> where Self: 'this = T::Field7MessageType<'this>;
type Field7RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
        ::std::option::IntoIter<
    ...
    >;
fn extension<'this>(&'this self) -> Self::Field7RepeatedType<'this> {
    self.as_ref().map(|msg| msg.extension().into_iter()).into_iter().flatten()
}
type Field8MessageType<'this> where Self: 'this = T::Field8MessageType<'this>;
fn options<'this>(&'this self) -> ::std::option::Option<Self::Field8MessageType<'this>> {
    self.as_ref().and_then(|msg| msg.options())
}
type Field9MessageType<'this> where Self: 'this = T::Field9MessageType<'this>;
fn source_code_info<'this>(&'this self) -> ::std::option::Option<Self::Field9MessageType<'this>> {
    self.as_ref().and_then(|msg| msg.source_code_info())
}
fn syntax<'this>(&'this self) -> ::std::option::Option<&'this str> {
...
{
    pub name: ::std::option::Option<ScalarType>,
}
...
{
fn name<'this>(&'this self) -> Option<&'this str> {
    self.name.as_ref().map(|r| r.as_ref())
}
type Field3RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<&'this str>;
fn dependency<'this>(&'this self) -> Self::Field3RepeatedType<'this> {
    ::puroro::internal::impls::empty::EmptyRepeatedField::new()
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub package: ::std::option::Option<ScalarType>,
}
...
{
fn package<'this>(&'this self) -> Option<&'this str> {
    self.package.as_ref().map(|r| r.as_ref())
}
type Field3RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<&'this str>;
fn dependency<'this>(&'this self) -> Self::Field3RepeatedType<'this> {
    ::puroro::internal::impls::empty::EmptyRepeatedField::new()
...
fn public_dependency<'this>(&'this self) -> Self::Field10RepeatedType<'this> {
    ::std::iter::Iterator::cloned(::std::iter::IntoIterator::into_iter(&self.public_dependency))
}
type Field11RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<i32>;
fn weak_dependency<'this>(&'this self) -> Self::Field11RepeatedType<'this> {
    ::puroro::internal::impls::empty::EmptyRepeatedField::new()
...
fn weak_dependency<'this>(&'this self) -> Self::Field11RepeatedType<'this> {
    ::std::iter::Iterator::cloned(::std::iter::IntoIterator::into_iter(&self.weak_dependency))
}
type Field4MessageType<'this> where Self: 'this = ();
type Field4RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field4MessageType<'this>>;
fn message_type<'this>(&'this self) -> Self::Field4RepeatedType<'this> {
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::DescriptorProtoTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
{
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::EnumDescriptorProtoTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
{
...
type Field6MessageType<'this> where Self: 'this = &'this ScalarType;
type Field6RepeatedType<'this> where Self: 'this
    = <&'this RepeatedType as ::std::iter::IntoIterator>::IntoIter;
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::FieldDescriptorProtoTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
{
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::FileOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub options: ::std::option::Option<ScalarType>,
}
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::SourceCodeInfoTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub source_code_info: ::std::option::Option<ScalarType>,
}
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub syntax: ::std::option::Option<ScalarType>,
}
...
type Field9MessageType<'this> where Self: 'this = ();
fn syntax<'this>(&'this self) -> Option<&'this str> {
    self.syntax.as_ref().map(|r| r.as_ref())
}
}
    ...
    T: FileDescriptorProtoTrait
{
    ...
    pub fn append_name<ScalarType>(self, value: ::std::option::Option<ScalarType>)
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    ...
    pub fn append_package<ScalarType>(self, value: ::std::option::Option<ScalarType>)
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    ...
    pub fn append_dependency<ScalarType, RepeatedType>(self, value: RepeatedType)
        -> FileDescriptorProtoBuilder<(T, FileDescriptorProtoSingleField3<ScalarType, RepeatedType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
    {
        FileDescriptorProtoBuilder((self.0, FileDescriptorProtoSingleField3 { dependency: value}))
    }

    pub fn append_public_dependency<RepeatedType>(self, value: RepeatedType)
...
>,
    {
        FileDescriptorProtoBuilder((self.0, FileDescriptorProtoSingleField10 { public_dependency: value}))
    }

    pub fn append_weak_dependency<RepeatedType>(self, value: RepeatedType)
...
>,
    {
        FileDescriptorProtoBuilder((self.0, FileDescriptorProtoSingleField11 { weak_dependency: value}))
    }

    pub fn append_message_type<ScalarType, RepeatedType>(self, value: RepeatedType)
        -> FileDescriptorProtoBuilder<(T, FileDescriptorProtoSingleField4<ScalarType, RepeatedType>)>
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::DescriptorProtoTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
    {
        FileDescriptorProtoBuilder((self.0, FileDescriptorProtoSingleField4 { message_type: value}))
    }

    pub fn append_enum_type<ScalarType, RepeatedType>(self, value: RepeatedType)
        -> FileDescriptorProtoBuilder<(T, FileDescriptorProtoSingleField5<ScalarType, RepeatedType>)>
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::EnumDescriptorProtoTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
    {
        FileDescriptorProtoBuilder((self.0, FileDescriptorProtoSingleField5 { enum_type: value}))
    }
...
>,
    ...
    pub fn append_extension<ScalarType, RepeatedType>(self, value: RepeatedType)
        -> FileDescriptorProtoBuilder<(T, FileDescriptorProtoSingleField7<ScalarType, RepeatedType>)>
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::FieldDescriptorProtoTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
    {
        FileDescriptorProtoBuilder((self.0, FileDescriptorProtoSingleField7 { extension: value}))
    }

    pub fn append_options<ScalarType>(self, value: ::std::option::Option<ScalarType>)
...
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::FileOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    ...
    pub fn append_source_code_info<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FileDescriptorProtoBuilder<(T, FileDescriptorProtoSingleField9<ScalarType>)>
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::SourceCodeInfoTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FileDescriptorProtoBuilder((self.0, FileDescriptorProtoSingleField9 { source_code_info: value}))
    }

    pub fn append_syntax<ScalarType>(self, value: ::std::option::Option<ScalarType>)
...
fn name<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as DescriptorProtoTrait>::name(&self.1);
    u.or_else(|| <T as DescriptorProtoTrait>::name(&self.0))
}type Field2MessageType<'this> where Self: 'this = ::puroro::Either<
...
}type Field3MessageType<'this> where Self: 'this = ::puroro::Either<
...
{
    self.as_ref().either(
        |t| <T as DescriptorProtoTrait>::name(t),
        |u| <U as DescriptorProtoTrait>::name(u),
    )
}
type Field2MessageType<'this> where Self: 'this = ::puroro::Either<
    <T as DescriptorProtoTrait>::Field2MessageType<'this>,
...
fn field<'this>(&'this self) -> Self::Field2RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as DescriptorProtoTrait>::field(t)
        )
        .map_right(
            |u| <U as DescriptorProtoTrait>::field(u)
        )
    )
}
type Field6MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn extension<'this>(&'this self) -> Self::Field6RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as DescriptorProtoTrait>::extension(t)
        )
        .map_right(
            |u| <U as DescriptorProtoTrait>::extension(u)
        )
    )
}
type Field3MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn nested_type<'this>(&'this self) -> Self::Field3RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as DescriptorProtoTrait>::nested_type(t)
        )
        .map_right(
            |u| <U as DescriptorProtoTrait>::nested_type(u)
        )
    )
}
type Field4MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn enum_type<'this>(&'this self) -> Self::Field4RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as DescriptorProtoTrait>::enum_type(t)
        )
        .map_right(
            |u| <U as DescriptorProtoTrait>::enum_type(u)
        )
    )
}
type Field5MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn extension_range<'this>(&'this self) -> Self::Field5RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as DescriptorProtoTrait>::extension_range(t)
        )
        .map_right(
            |u| <U as DescriptorProtoTrait>::extension_range(u)
        )
    )
}
type Field8MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn oneof_decl<'this>(&'this self) -> Self::Field8RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as DescriptorProtoTrait>::oneof_decl(t)
        )
        .map_right(
            |u| <U as DescriptorProtoTrait>::oneof_decl(u)
        )
    )
}
type Field7MessageType<'this> where Self: 'this = ::puroro::Either<
...
{
    self.as_ref().either(
        |t| <T as DescriptorProtoTrait>::options(t).map(
            |t| ::puroro::Either::Left(t)
        ),
        |u| <U as DescriptorProtoTrait>::options(u).map(
            |u| ::puroro::Either::Right(u)
        ),
    )
}
...
fn reserved_range<'this>(&'this self) -> Self::Field9RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as DescriptorProtoTrait>::reserved_range(t)
        )
        .map_right(
            |u| <U as DescriptorProtoTrait>::reserved_range(u)
        )
    )
}
type Field10RepeatedType<'this> where Self: 'this
...
fn reserved_name<'this>(&'this self) -> Self::Field10RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedField::new(self
        .as_ref()
        .map_left(
            |t| <T as DescriptorProtoTrait>::reserved_name(t)
        )
        .map_right(
            |u| <U as DescriptorProtoTrait>::reserved_name(u)
        )
    )
}
...
type Field2MessageType<'this> where Self: 'this = T::Field2MessageType<'this>;
type Field2RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
        ::std::option::IntoIter<
    ...
    >;
fn field<'this>(&'this self) -> Self::Field2RepeatedType<'this> {
    self.as_ref().map(|msg| msg.field().into_iter()).into_iter().flatten()
}
type Field6MessageType<'this> where Self: 'this = T::Field6MessageType<'this>;
type Field6RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
...
type Field3MessageType<'this> where Self: 'this = T::Field3MessageType<'this>;
type Field3RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
        ::std::option::IntoIter<
            <T::Field3RepeatedType<'this> as ::std::iter::IntoIterator>::IntoIter
    ...
    >;
fn nested_type<'this>(&'this self) -> Self::Field3RepeatedType<'this> {
    self.as_ref().map(|msg| msg.nested_type().into_iter()).into_iter().flatten()
}
type Field4MessageType<'this> where Self: 'this = T::Field4MessageType<'this>;
type Field4RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
...
type Field5RepeatedType<'this> where Self: 'this =
    ...
    >;
fn extension_range<'this>(&'this self) -> Self::Field5RepeatedType<'this> {
    self.as_ref().map(|msg| msg.extension_range().into_iter()).into_iter().flatten()
}
type Field8MessageType<'this> where Self: 'this = T::Field8MessageType<'this>;
type Field8RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
    ...
    >;
fn oneof_decl<'this>(&'this self) -> Self::Field8RepeatedType<'this> {
    self.as_ref().map(|msg| msg.oneof_decl().into_iter()).into_iter().flatten()
}
type Field7MessageType<'this> where Self: 'this = T::Field7MessageType<'this>;
...
type Field9RepeatedType<'this> where Self: 'this =
    ...
    >;
fn reserved_range<'this>(&'this self) -> Self::Field9RepeatedType<'this> {
    self.as_ref().map(|msg| msg.reserved_range().into_iter()).into_iter().flatten()
}
type Field10RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
        ::std::option::IntoIter<
    ...
    >;
fn reserved_name<'this>(&'this self) -> Self::Field10RepeatedType<'this> {
    self.as_ref().map(|msg| msg.reserved_name().into_iter()).into_iter().flatten()
}
}
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::OneofDescriptorProtoTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
{
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::MessageOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub options: ::std::option::Option<ScalarType>,
}
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    ...
    pub fn append_field<ScalarType, RepeatedType>(self, value: RepeatedType)
...
>,
    ...
    pub fn append_nested_type<ScalarType, RepeatedType>(self, value: RepeatedType)
...
>,
    {
        DescriptorProtoBuilder((self.0, DescriptorProtoSingleField5 { extension_range: value}))
    }

    pub fn append_oneof_decl<ScalarType, RepeatedType>(self, value: RepeatedType)
...
>,
    {
        DescriptorProtoBuilder((self.0, DescriptorProtoSingleField9 { reserved_range: value}))
    }

    pub fn append_reserved_name<ScalarType, RepeatedType>(self, value: RepeatedType)
...
>,
    {
        DescriptorProtoBuilder((self.0, DescriptorProtoSingleField10 { reserved_name: value}))
    }
...
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as ExtensionRangeOptionsTrait>::uninterpreted_option(t)
        )
        .map_right(
            |u| <U as ExtensionRangeOptionsTrait>::uninterpreted_option(u)
        )
    )
}
...
where
    T: ExtensionRangeOptionsTrait,
{
type Field999MessageType<'this> where Self: 'this = T::Field999MessageType<'this>;
type Field999RepeatedType<'this> where Self: 'this =
    ::std::iter::Flatten<
        ::std::option::IntoIter<
    ...
    >;
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this> {
    self.as_ref().map(|msg| msg.uninterpreted_option().into_iter()).into_iter().flatten()
}
}
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::UninterpretedOptionTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
{
...
>,
{
type Field999MessageType<'this> where Self: 'this = &'this ScalarType;
type Field999RepeatedType<'this> where Self: 'this
    = <&'this RepeatedType as ::std::iter::IntoIterator>::IntoIter;
    ...
    T: ExtensionRangeOptionsTrait
{
    ...
    pub fn append_uninterpreted_option<ScalarType, RepeatedType>(self, value: RepeatedType)
        -> ExtensionRangeOptionsBuilder<(T, ExtensionRangeOptionsSingleField999<ScalarType, RepeatedType>)>
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::UninterpretedOptionTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
    {
        ExtensionRangeOptionsBuilder((self.0, ExtensionRangeOptionsSingleField999 { uninterpreted_option: value}))
    }
...
fn name<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FieldDescriptorProtoTrait>::name(&self.1);
    u.or_else(|| <T as FieldDescriptorProtoTrait>::name(&self.0))
}
fn number<'this>(&'this self) -> Option<i32>
{
    let mut u = <U as FieldDescriptorProtoTrait>::number(&self.1);
    u.or_else(|| <T as FieldDescriptorProtoTrait>::number(&self.0))
}
fn label<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::field_descriptor_proto::Label>
{
    let mut u = <U as FieldDescriptorProtoTrait>::label(&self.1);
    u.or_else(|| <T as FieldDescriptorProtoTrait>::label(&self.0))
}
fn r#type<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::field_descriptor_proto::Type>
{
    let mut u = <U as FieldDescriptorProtoTrait>::r#type(&self.1);
    u.or_else(|| <T as FieldDescriptorProtoTrait>::r#type(&self.0))
}
fn type_name<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FieldDescriptorProtoTrait>::type_name(&self.1);
    u.or_else(|| <T as FieldDescriptorProtoTrait>::type_name(&self.0))
}
fn extendee<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FieldDescriptorProtoTrait>::extendee(&self.1);
    u.or_else(|| <T as FieldDescriptorProtoTrait>::extendee(&self.0))
}
fn default_value<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FieldDescriptorProtoTrait>::default_value(&self.1);
    u.or_else(|| <T as FieldDescriptorProtoTrait>::default_value(&self.0))
}
fn oneof_index<'this>(&'this self) -> Option<i32>
{
    let mut u = <U as FieldDescriptorProtoTrait>::oneof_index(&self.1);
    u.or_else(|| <T as FieldDescriptorProtoTrait>::oneof_index(&self.0))
}
fn json_name<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FieldDescriptorProtoTrait>::json_name(&self.1);
    u.or_else(|| <T as FieldDescriptorProtoTrait>::json_name(&self.0))
}type Field8MessageType<'this> where Self: 'this = (
...
fn proto3_optional<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FieldDescriptorProtoTrait>::proto3_optional(&self.1);
    u.or_else(|| <T as FieldDescriptorProtoTrait>::proto3_optional(&self.0))
}
...
{
    self.as_ref().either(
        |t| <T as FieldDescriptorProtoTrait>::name(t),
        |u| <U as FieldDescriptorProtoTrait>::name(u),
    )
}
fn number<'this>(&'this self) -> Option<i32>
{
...
{
    self.as_ref().either(
        |t| <T as FieldDescriptorProtoTrait>::r#type(t),
        |u| <U as FieldDescriptorProtoTrait>::r#type(u),
    )
}
fn type_name<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as FieldDescriptorProtoTrait>::type_name(t),
        |u| <U as FieldDescriptorProtoTrait>::type_name(u),
    )
}
fn extendee<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as FieldDescriptorProtoTrait>::extendee(t),
        |u| <U as FieldDescriptorProtoTrait>::extendee(u),
    )
}
fn default_value<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as FieldDescriptorProtoTrait>::default_value(t),
        |u| <U as FieldDescriptorProtoTrait>::default_value(u),
    )
}
fn oneof_index<'this>(&'this self) -> Option<i32>
{
...
{
    self.as_ref().either(
        |t| <T as FieldDescriptorProtoTrait>::json_name(t),
        |u| <U as FieldDescriptorProtoTrait>::json_name(u),
    )
}
type Field8MessageType<'this> where Self: 'this = ::puroro::Either<
...
{
    self.as_ref().either(
        |t| <T as FieldDescriptorProtoTrait>::options(t).map(
            |t| ::puroro::Either::Left(t)
        ),
        |u| <U as FieldDescriptorProtoTrait>::options(u).map(
            |u| ::puroro::Either::Right(u)
        ),
    )
}
...
fn r#type<'this>(&'this self) -> ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_descriptor_proto::Type> {
    self.as_ref().and_then(|msg| msg.r#type())
}
fn type_name<'this>(&'this self) -> ::std::option::Option<&'this str> {
    self.as_ref().and_then(|msg| msg.type_name())
}
fn extendee<'this>(&'this self) -> ::std::option::Option<&'this str> {
    self.as_ref().and_then(|msg| msg.extendee())
}
fn default_value<'this>(&'this self) -> ::std::option::Option<&'this str> {
...
fn json_name<'this>(&'this self) -> ::std::option::Option<&'this str> {
...
impl ::puroro::Message<super::FieldDescriptorProto>
for FieldDescriptorProtoSingleField3
{}

impl super::_puroro_traits::FieldDescriptorProtoTrait
for FieldDescriptorProtoSingleField3
{
fn number<'this>(&'this self) -> Option<i32> {
    Clone::clone(&self.number)
...
impl ::puroro::internal::SerializableMessageToIoWrite
for FieldDescriptorProtoSingleField3
{
    fn ser<W>(&self, out: &mut W) -> ::puroro::Result<()>
    where
...
impl ::std::convert::From<::std::option::Option<i32>>
for FieldDescriptorProtoSingleField3
{
...
impl ::std::convert::From<::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_descriptor_proto::Label>>
for FieldDescriptorProtoSingleField4
{
    fn from(value: ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_descriptor_proto::Label>) -> Self {
        Self {
            label: value,
        }
    }
...
impl ::std::convert::From<::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_descriptor_proto::Type>>
for FieldDescriptorProtoSingleField5
{
    fn from(value: ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_descriptor_proto::Type>) -> Self {
        Self {
            r#type: value,
        }
    }
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub type_name: ::std::option::Option<ScalarType>,
}
...
{
fn type_name<'this>(&'this self) -> Option<&'this str> {
    self.type_name.as_ref().map(|r| r.as_ref())
}
type Field8MessageType<'this> where Self: 'this = ();
}
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub extendee: ::std::option::Option<ScalarType>,
}
...
{
fn extendee<'this>(&'this self) -> Option<&'this str> {
    self.extendee.as_ref().map(|r| r.as_ref())
}
type Field8MessageType<'this> where Self: 'this = ();
}
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub default_value: ::std::option::Option<ScalarType>,
}
...
{
fn default_value<'this>(&'this self) -> Option<&'this str> {
    self.default_value.as_ref().map(|r| r.as_ref())
}
type Field8MessageType<'this> where Self: 'this = ();
}
...
impl ::puroro::Message<super::FieldDescriptorProto>
for FieldDescriptorProtoSingleField9
{}
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub json_name: ::std::option::Option<ScalarType>,
}
...
{
fn json_name<'this>(&'this self) -> Option<&'this str> {
    self.json_name.as_ref().map(|r| r.as_ref())
}
type Field8MessageType<'this> where Self: 'this = ();
}
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::FieldOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub options: ::std::option::Option<ScalarType>,
}
...
impl ::puroro::Message<super::FieldDescriptorProto>
for FieldDescriptorProtoSingleField17
{}
...
impl ::std::convert::From<::std::option::Option<bool>>
for FieldDescriptorProtoSingleField17
{
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    ...
    pub fn append_number(self, value: ::std::option::Option<i32>)
        -> FieldDescriptorProtoBuilder<(T, FieldDescriptorProtoSingleField3)>
    {
        FieldDescriptorProtoBuilder((self.0, FieldDescriptorProtoSingleField3 { number: value}))
    }

    pub fn append_label(self, value: ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_descriptor_proto::Label>)
    ...
    pub fn append_r#type(self, value: ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_descriptor_proto::Type>)
        -> FieldDescriptorProtoBuilder<(T, FieldDescriptorProtoSingleField5)>
    {
        FieldDescriptorProtoBuilder((self.0, FieldDescriptorProtoSingleField5 { r#type: value}))
    }

    pub fn append_type_name<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FieldDescriptorProtoBuilder<(T, FieldDescriptorProtoSingleField6<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FieldDescriptorProtoBuilder((self.0, FieldDescriptorProtoSingleField6 { type_name: value}))
    }

    pub fn append_extendee<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FieldDescriptorProtoBuilder<(T, FieldDescriptorProtoSingleField2<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FieldDescriptorProtoBuilder((self.0, FieldDescriptorProtoSingleField2 { extendee: value}))
    }

    pub fn append_default_value<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FieldDescriptorProtoBuilder<(T, FieldDescriptorProtoSingleField7<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FieldDescriptorProtoBuilder((self.0, FieldDescriptorProtoSingleField7 { default_value: value}))
    }

    pub fn append_oneof_index(self, value: ::std::option::Option<i32>)
        -> FieldDescriptorProtoBuilder<(T, FieldDescriptorProtoSingleField9)>
    {
        FieldDescriptorProtoBuilder((self.0, FieldDescriptorProtoSingleField9 { oneof_index: value}))
    }

    pub fn append_json_name<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FieldDescriptorProtoBuilder<(T, FieldDescriptorProtoSingleField10<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FieldDescriptorProtoBuilder((self.0, FieldDescriptorProtoSingleField10 { json_name: value}))
    }
...
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::FieldOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FieldDescriptorProtoBuilder((self.0, FieldDescriptorProtoSingleField8 { options: value}))
    }

    pub fn append_proto3_optional(self, value: ::std::option::Option<bool>)
        -> FieldDescriptorProtoBuilder<(T, FieldDescriptorProtoSingleField17)>
    {
        FieldDescriptorProtoBuilder((self.0, FieldDescriptorProtoSingleField17 { proto3_optional: value}))
    }
...
fn name<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as OneofDescriptorProtoTrait>::name(&self.1);
    u.or_else(|| <T as OneofDescriptorProtoTrait>::name(&self.0))
}type Field2MessageType<'this> where Self: 'this = (
...
{
    self.as_ref().either(
        |t| <T as OneofDescriptorProtoTrait>::name(t),
        |u| <U as OneofDescriptorProtoTrait>::name(u),
    )
}
type Field2MessageType<'this> where Self: 'this = ::puroro::Either<
...
{
    self.as_ref().either(
        |t| <T as OneofDescriptorProtoTrait>::options(t).map(
            |t| ::puroro::Either::Left(t)
        ),
        |u| <U as OneofDescriptorProtoTrait>::options(u).map(
            |u| ::puroro::Either::Right(u)
        ),
    )
}
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::OneofOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub options: ::std::option::Option<ScalarType>,
}
...
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::OneofOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        OneofDescriptorProtoBuilder((self.0, OneofDescriptorProtoSingleField2 { options: value}))
    }
...
fn name<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as EnumDescriptorProtoTrait>::name(&self.1);
    u.or_else(|| <T as EnumDescriptorProtoTrait>::name(&self.0))
}type Field2MessageType<'this> where Self: 'this = ::puroro::Either<
...
{
    self.as_ref().either(
        |t| <T as EnumDescriptorProtoTrait>::name(t),
        |u| <U as EnumDescriptorProtoTrait>::name(u),
    )
}
type Field2MessageType<'this> where Self: 'this = ::puroro::Either<
    <T as EnumDescriptorProtoTrait>::Field2MessageType<'this>,
...
fn value<'this>(&'this self) -> Self::Field2RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as EnumDescriptorProtoTrait>::value(t)
        )
        .map_right(
            |u| <U as EnumDescriptorProtoTrait>::value(u)
        )
    )
}
type Field3MessageType<'this> where Self: 'this = ::puroro::Either<
...
{
    self.as_ref().either(
        |t| <T as EnumDescriptorProtoTrait>::options(t).map(
            |t| ::puroro::Either::Left(t)
        ),
        |u| <U as EnumDescriptorProtoTrait>::options(u).map(
            |u| ::puroro::Either::Right(u)
        ),
    )
}
...
fn reserved_range<'this>(&'this self) -> Self::Field4RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as EnumDescriptorProtoTrait>::reserved_range(t)
        )
        .map_right(
            |u| <U as EnumDescriptorProtoTrait>::reserved_range(u)
        )
    )
}
type Field5RepeatedType<'this> where Self: 'this
...
fn reserved_name<'this>(&'this self) -> Self::Field5RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedField::new(self
        .as_ref()
        .map_left(
            |t| <T as EnumDescriptorProtoTrait>::reserved_name(t)
        )
        .map_right(
            |u| <U as EnumDescriptorProtoTrait>::reserved_name(u)
        )
    )
}
...
type Field2RepeatedType<'this> where Self: 'this =
    ...
    >;
fn value<'this>(&'this self) -> Self::Field2RepeatedType<'this> {
    self.as_ref().map(|msg| msg.value().into_iter()).into_iter().flatten()
}
type Field3MessageType<'this> where Self: 'this = T::Field3MessageType<'this>;
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::EnumOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub options: ::std::option::Option<ScalarType>,
}
...
>,
    {
        EnumDescriptorProtoBuilder((self.0, EnumDescriptorProtoSingleField4 { reserved_range: value}))
    }

    pub fn append_reserved_name<ScalarType, RepeatedType>(self, value: RepeatedType)
        -> EnumDescriptorProtoBuilder<(T, EnumDescriptorProtoSingleField5<ScalarType, RepeatedType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
    {
        EnumDescriptorProtoBuilder((self.0, EnumDescriptorProtoSingleField5 { reserved_name: value}))
    }
...
fn name<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as EnumValueDescriptorProtoTrait>::name(&self.1);
    u.or_else(|| <T as EnumValueDescriptorProtoTrait>::name(&self.0))
}
fn number<'this>(&'this self) -> Option<i32>
{
    let mut u = <U as EnumValueDescriptorProtoTrait>::number(&self.1);
    u.or_else(|| <T as EnumValueDescriptorProtoTrait>::number(&self.0))
}type Field3MessageType<'this> where Self: 'this = (
...
{
    self.as_ref().either(
        |t| <T as EnumValueDescriptorProtoTrait>::name(t),
        |u| <U as EnumValueDescriptorProtoTrait>::name(u),
    )
}
fn number<'this>(&'this self) -> Option<i32>
{
...
{
    self.as_ref().either(
        |t| <T as EnumValueDescriptorProtoTrait>::options(t).map(
            |t| ::puroro::Either::Left(t)
        ),
        |u| <U as EnumValueDescriptorProtoTrait>::options(u).map(
            |u| ::puroro::Either::Right(u)
        ),
    )
}
...
impl ::puroro::Message<super::EnumValueDescriptorProto>
for EnumValueDescriptorProtoSingleField2
{}

impl super::_puroro_traits::EnumValueDescriptorProtoTrait
for EnumValueDescriptorProtoSingleField2
{
fn number<'this>(&'this self) -> Option<i32> {
    Clone::clone(&self.number)
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::EnumValueOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub options: ::std::option::Option<ScalarType>,
}
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        EnumValueDescriptorProtoBuilder((self.0, EnumValueDescriptorProtoSingleField1 { name: value}))
    }

    pub fn append_number(self, value: ::std::option::Option<i32>)
        -> EnumValueDescriptorProtoBuilder<(T, EnumValueDescriptorProtoSingleField2)>
    {
        EnumValueDescriptorProtoBuilder((self.0, EnumValueDescriptorProtoSingleField2 { number: value}))
    }
...
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::EnumValueOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        EnumValueDescriptorProtoBuilder((self.0, EnumValueDescriptorProtoSingleField3 { options: value}))
    }
...
fn name<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as ServiceDescriptorProtoTrait>::name(&self.1);
    u.or_else(|| <T as ServiceDescriptorProtoTrait>::name(&self.0))
}type Field2MessageType<'this> where Self: 'this = ::puroro::Either<
...
{
    self.as_ref().either(
        |t| <T as ServiceDescriptorProtoTrait>::name(t),
        |u| <U as ServiceDescriptorProtoTrait>::name(u),
    )
}
type Field2MessageType<'this> where Self: 'this = ::puroro::Either<
    <T as ServiceDescriptorProtoTrait>::Field2MessageType<'this>,
...
fn method<'this>(&'this self) -> Self::Field2RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as ServiceDescriptorProtoTrait>::method(t)
        )
        .map_right(
            |u| <U as ServiceDescriptorProtoTrait>::method(u)
        )
    )
}
type Field3MessageType<'this> where Self: 'this = ::puroro::Either<
...
{
    self.as_ref().either(
        |t| <T as ServiceDescriptorProtoTrait>::options(t).map(
            |t| ::puroro::Either::Left(t)
        ),
        |u| <U as ServiceDescriptorProtoTrait>::options(u).map(
            |u| ::puroro::Either::Right(u)
        ),
    )
}
...
type Field2RepeatedType<'this> where Self: 'this =
    ...
    >;
fn method<'this>(&'this self) -> Self::Field2RepeatedType<'this> {
    self.as_ref().map(|msg| msg.method().into_iter()).into_iter().flatten()
}
type Field3MessageType<'this> where Self: 'this = T::Field3MessageType<'this>;
fn options<'this>(&'this self) -> ::std::option::Option<Self::Field3MessageType<'this>> {
    self.as_ref().and_then(|msg| msg.options())
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::MethodDescriptorProtoTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
{
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::ServiceOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub options: ::std::option::Option<ScalarType>,
}
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        ServiceDescriptorProtoBuilder((self.0, ServiceDescriptorProtoSingleField1 { name: value}))
    }

    pub fn append_method<ScalarType, RepeatedType>(self, value: RepeatedType)
        -> ServiceDescriptorProtoBuilder<(T, ServiceDescriptorProtoSingleField2<ScalarType, RepeatedType>)>
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::MethodDescriptorProtoTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
    Item = &'a ScalarType
>,
    {
        ServiceDescriptorProtoBuilder((self.0, ServiceDescriptorProtoSingleField2 { method: value}))
    }
...
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::ServiceOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        ServiceDescriptorProtoBuilder((self.0, ServiceDescriptorProtoSingleField3 { options: value}))
    }
...
fn name<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as MethodDescriptorProtoTrait>::name(&self.1);
    u.or_else(|| <T as MethodDescriptorProtoTrait>::name(&self.0))
}
fn input_type<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as MethodDescriptorProtoTrait>::input_type(&self.1);
    u.or_else(|| <T as MethodDescriptorProtoTrait>::input_type(&self.0))
}
fn output_type<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as MethodDescriptorProtoTrait>::output_type(&self.1);
    u.or_else(|| <T as MethodDescriptorProtoTrait>::output_type(&self.0))
}type Field4MessageType<'this> where Self: 'this = (
...
fn client_streaming<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as MethodDescriptorProtoTrait>::client_streaming(&self.1);
    if u == <() as MethodDescriptorProtoTrait>::client_streaming(&()) {
        u = None;
    }
    u.or_else(|| <T as MethodDescriptorProtoTrait>::client_streaming(&self.0))
}
fn server_streaming<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as MethodDescriptorProtoTrait>::server_streaming(&self.1);
    if u == <() as MethodDescriptorProtoTrait>::server_streaming(&()) {
        u = None;
    }
    u.or_else(|| <T as MethodDescriptorProtoTrait>::server_streaming(&self.0))
}
...
{
    self.as_ref().either(
        |t| <T as MethodDescriptorProtoTrait>::name(t),
        |u| <U as MethodDescriptorProtoTrait>::name(u),
    )
}
fn input_type<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as MethodDescriptorProtoTrait>::input_type(t),
        |u| <U as MethodDescriptorProtoTrait>::input_type(u),
    )
}
fn output_type<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as MethodDescriptorProtoTrait>::output_type(t),
        |u| <U as MethodDescriptorProtoTrait>::output_type(u),
    )
}
type Field4MessageType<'this> where Self: 'this = ::puroro::Either<
...
{
    self.as_ref().either(
        |t| <T as MethodDescriptorProtoTrait>::options(t).map(
            |t| ::puroro::Either::Left(t)
        ),
        |u| <U as MethodDescriptorProtoTrait>::options(u).map(
            |u| ::puroro::Either::Right(u)
        ),
    )
}
...
fn input_type<'this>(&'this self) -> ::std::option::Option<&'this str> {
    self.as_ref().and_then(|msg| msg.input_type())
}
fn output_type<'this>(&'this self) -> ::std::option::Option<&'this str> {
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub input_type: ::std::option::Option<ScalarType>,
}
...
{
fn input_type<'this>(&'this self) -> Option<&'this str> {
    self.input_type.as_ref().map(|r| r.as_ref())
}
type Field4MessageType<'this> where Self: 'this = ();
}
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub output_type: ::std::option::Option<ScalarType>,
}
...
{
fn output_type<'this>(&'this self) -> Option<&'this str> {
    self.output_type.as_ref().map(|r| r.as_ref())
}
type Field4MessageType<'this> where Self: 'this = ();
}
...
where
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::MethodOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub options: ::std::option::Option<ScalarType>,
}
...
impl ::puroro::Message<super::MethodDescriptorProto>
for MethodDescriptorProtoSingleField5
{}

impl super::_puroro_traits::MethodDescriptorProtoTrait
for MethodDescriptorProtoSingleField5
{
type Field4MessageType<'this> where Self: 'this = ();
fn client_streaming<'this>(&'this self) -> Option<bool> {
...
impl ::puroro::Message<super::MethodDescriptorProto>
for MethodDescriptorProtoSingleField6
{}
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MethodDescriptorProtoBuilder((self.0, MethodDescriptorProtoSingleField1 { name: value}))
    }

    pub fn append_input_type<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> MethodDescriptorProtoBuilder<(T, MethodDescriptorProtoSingleField2<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MethodDescriptorProtoBuilder((self.0, MethodDescriptorProtoSingleField2 { input_type: value}))
    }

    pub fn append_output_type<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> MethodDescriptorProtoBuilder<(T, MethodDescriptorProtoSingleField3<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MethodDescriptorProtoBuilder((self.0, MethodDescriptorProtoSingleField3 { output_type: value}))
    }
...
ScalarType: self::_puroro_root::google::protobuf::_puroro_traits::MethodOptionsTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        MethodDescriptorProtoBuilder((self.0, MethodDescriptorProtoSingleField4 { options: value}))
    }

    pub fn append_client_streaming(self, value: ::std::option::Option<bool>)
        -> MethodDescriptorProtoBuilder<(T, MethodDescriptorProtoSingleField5)>
    {
        MethodDescriptorProtoBuilder((self.0, MethodDescriptorProtoSingleField5 { client_streaming: value}))
    }

    pub fn append_server_streaming(self, value: ::std::option::Option<bool>)
        -> MethodDescriptorProtoBuilder<(T, MethodDescriptorProtoSingleField6)>
    {
        MethodDescriptorProtoBuilder((self.0, MethodDescriptorProtoSingleField6 { server_streaming: value}))
    }
...
fn java_package<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileOptionsTrait>::java_package(&self.1);
    u.or_else(|| <T as FileOptionsTrait>::java_package(&self.0))
}
fn java_outer_classname<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileOptionsTrait>::java_outer_classname(&self.1);
    u.or_else(|| <T as FileOptionsTrait>::java_outer_classname(&self.0))
}
fn java_multiple_files<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FileOptionsTrait>::java_multiple_files(&self.1);
    if u == <() as FileOptionsTrait>::java_multiple_files(&()) {
        u = None;
    }
    u.or_else(|| <T as FileOptionsTrait>::java_multiple_files(&self.0))
}
fn java_generate_equals_and_hash<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FileOptionsTrait>::java_generate_equals_and_hash(&self.1);
    u.or_else(|| <T as FileOptionsTrait>::java_generate_equals_and_hash(&self.0))
}
fn java_string_check_utf8<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FileOptionsTrait>::java_string_check_utf8(&self.1);
    if u == <() as FileOptionsTrait>::java_string_check_utf8(&()) {
        u = None;
    }
    u.or_else(|| <T as FileOptionsTrait>::java_string_check_utf8(&self.0))
}
fn optimize_for<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::file_options::OptimizeMode>
{
    let mut u = <U as FileOptionsTrait>::optimize_for(&self.1);
    if u == <() as FileOptionsTrait>::optimize_for(&()) {
        u = None;
    }
    u.or_else(|| <T as FileOptionsTrait>::optimize_for(&self.0))
}
fn go_package<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileOptionsTrait>::go_package(&self.1);
    u.or_else(|| <T as FileOptionsTrait>::go_package(&self.0))
}
fn cc_generic_services<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FileOptionsTrait>::cc_generic_services(&self.1);
    if u == <() as FileOptionsTrait>::cc_generic_services(&()) {
        u = None;
    }
    u.or_else(|| <T as FileOptionsTrait>::cc_generic_services(&self.0))
}
fn java_generic_services<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FileOptionsTrait>::java_generic_services(&self.1);
    if u == <() as FileOptionsTrait>::java_generic_services(&()) {
        u = None;
    }
    u.or_else(|| <T as FileOptionsTrait>::java_generic_services(&self.0))
}
fn py_generic_services<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FileOptionsTrait>::py_generic_services(&self.1);
    if u == <() as FileOptionsTrait>::py_generic_services(&()) {
        u = None;
    }
    u.or_else(|| <T as FileOptionsTrait>::py_generic_services(&self.0))
}
fn php_generic_services<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FileOptionsTrait>::php_generic_services(&self.1);
    if u == <() as FileOptionsTrait>::php_generic_services(&()) {
        u = None;
    }
    u.or_else(|| <T as FileOptionsTrait>::php_generic_services(&self.0))
}
fn deprecated<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FileOptionsTrait>::deprecated(&self.1);
    if u == <() as FileOptionsTrait>::deprecated(&()) {
        u = None;
    }
    u.or_else(|| <T as FileOptionsTrait>::deprecated(&self.0))
}
fn cc_enable_arenas<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FileOptionsTrait>::cc_enable_arenas(&self.1);
    if u == <() as FileOptionsTrait>::cc_enable_arenas(&()) {
        u = None;
    }
    u.or_else(|| <T as FileOptionsTrait>::cc_enable_arenas(&self.0))
}
fn objc_class_prefix<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileOptionsTrait>::objc_class_prefix(&self.1);
    u.or_else(|| <T as FileOptionsTrait>::objc_class_prefix(&self.0))
}
fn csharp_namespace<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileOptionsTrait>::csharp_namespace(&self.1);
    u.or_else(|| <T as FileOptionsTrait>::csharp_namespace(&self.0))
}
fn swift_prefix<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileOptionsTrait>::swift_prefix(&self.1);
    u.or_else(|| <T as FileOptionsTrait>::swift_prefix(&self.0))
}
fn php_class_prefix<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileOptionsTrait>::php_class_prefix(&self.1);
    u.or_else(|| <T as FileOptionsTrait>::php_class_prefix(&self.0))
}
fn php_namespace<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileOptionsTrait>::php_namespace(&self.1);
    u.or_else(|| <T as FileOptionsTrait>::php_namespace(&self.0))
}
fn php_metadata_namespace<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileOptionsTrait>::php_metadata_namespace(&self.1);
    u.or_else(|| <T as FileOptionsTrait>::php_metadata_namespace(&self.0))
}
fn ruby_package<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as FileOptionsTrait>::ruby_package(&self.1);
    u.or_else(|| <T as FileOptionsTrait>::ruby_package(&self.0))
}type Field999MessageType<'this> where Self: 'this = ::puroro::Either<
...
{
    self.as_ref().either(
        |t| <T as FileOptionsTrait>::java_package(t),
        |u| <U as FileOptionsTrait>::java_package(u),
    )
}
fn java_outer_classname<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as FileOptionsTrait>::java_outer_classname(t),
        |u| <U as FileOptionsTrait>::java_outer_classname(u),
    )
}
fn java_multiple_files<'this>(&'this self) -> Option<bool>
{
...
{
    self.as_ref().either(
        |t| <T as FileOptionsTrait>::go_package(t),
        |u| <U as FileOptionsTrait>::go_package(u),
    )
}
fn cc_generic_services<'this>(&'this self) -> Option<bool>
{
...
{
    self.as_ref().either(
        |t| <T as FileOptionsTrait>::objc_class_prefix(t),
        |u| <U as FileOptionsTrait>::objc_class_prefix(u),
    )
}
fn csharp_namespace<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as FileOptionsTrait>::csharp_namespace(t),
        |u| <U as FileOptionsTrait>::csharp_namespace(u),
    )
}
fn swift_prefix<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as FileOptionsTrait>::swift_prefix(t),
        |u| <U as FileOptionsTrait>::swift_prefix(u),
    )
}
fn php_class_prefix<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as FileOptionsTrait>::php_class_prefix(t),
        |u| <U as FileOptionsTrait>::php_class_prefix(u),
    )
}
fn php_namespace<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as FileOptionsTrait>::php_namespace(t),
        |u| <U as FileOptionsTrait>::php_namespace(u),
    )
}
fn php_metadata_namespace<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as FileOptionsTrait>::php_metadata_namespace(t),
        |u| <U as FileOptionsTrait>::php_metadata_namespace(u),
    )
}
fn ruby_package<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as FileOptionsTrait>::ruby_package(t),
        |u| <U as FileOptionsTrait>::ruby_package(u),
    )
}
type Field999MessageType<'this> where Self: 'this = ::puroro::Either<
    <T as FileOptionsTrait>::Field999MessageType<'this>,
...
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as FileOptionsTrait>::uninterpreted_option(t)
        )
        .map_right(
            |u| <U as FileOptionsTrait>::uninterpreted_option(u)
        )
    )
}
...
where
    T: FileOptionsTrait,
{
fn java_package<'this>(&'this self) -> ::std::option::Option<&'this str> {
    self.as_ref().and_then(|msg| msg.java_package())
}
fn java_outer_classname<'this>(&'this self) -> ::std::option::Option<&'this str> {
...
fn java_generate_equals_and_hash<'this>(&'this self) -> ::std::option::Option<bool> {
    self.as_ref().and_then(|msg| msg.java_generate_equals_and_hash())
}
...
fn go_package<'this>(&'this self) -> ::std::option::Option<&'this str> {
...
fn objc_class_prefix<'this>(&'this self) -> ::std::option::Option<&'this str> {
    self.as_ref().and_then(|msg| msg.objc_class_prefix())
}
fn csharp_namespace<'this>(&'this self) -> ::std::option::Option<&'this str> {
    self.as_ref().and_then(|msg| msg.csharp_namespace())
}
fn swift_prefix<'this>(&'this self) -> ::std::option::Option<&'this str> {
    self.as_ref().and_then(|msg| msg.swift_prefix())
}
fn php_class_prefix<'this>(&'this self) -> ::std::option::Option<&'this str> {
    self.as_ref().and_then(|msg| msg.php_class_prefix())
}
fn php_namespace<'this>(&'this self) -> ::std::option::Option<&'this str> {
    self.as_ref().and_then(|msg| msg.php_namespace())
}
fn php_metadata_namespace<'this>(&'this self) -> ::std::option::Option<&'this str> {
    self.as_ref().and_then(|msg| msg.php_metadata_namespace())
}
fn ruby_package<'this>(&'this self) -> ::std::option::Option<&'this str> {
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub java_package: ::std::option::Option<ScalarType>,
}

impl<ScalarType> ::puroro::Message<super::FileOptions>
for FileOptionsSingleField1<ScalarType>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{}

impl<ScalarType> super::_puroro_traits::FileOptionsTrait
for FileOptionsSingleField1<ScalarType>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
fn java_package<'this>(&'this self) -> Option<&'this str> {
    self.java_package.as_ref().map(|r| r.as_ref())
}
type Field999MessageType<'this> where Self: 'this = ();
type Field999RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field999MessageType<'this>>;
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this> {
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub java_outer_classname: ::std::option::Option<ScalarType>,
}
...
{
fn java_outer_classname<'this>(&'this self) -> Option<&'this str> {
    self.java_outer_classname.as_ref().map(|r| r.as_ref())
}
type Field999MessageType<'this> where Self: 'this = ();
type Field999RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field999MessageType<'this>>;
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this> {
...
impl ::puroro::Message<super::FileOptions>
for FileOptionsSingleField10
{}

impl super::_puroro_traits::FileOptionsTrait
for FileOptionsSingleField10
{
fn java_multiple_files<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.java_multiple_files)
...
impl ::std::convert::From<::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::file_options::OptimizeMode>>
for FileOptionsSingleField9
{
    fn from(value: ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::file_options::OptimizeMode>) -> Self {
        Self {
            optimize_for: value,
        }
    }
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub go_package: ::std::option::Option<ScalarType>,
}
...
{
fn go_package<'this>(&'this self) -> Option<&'this str> {
    self.go_package.as_ref().map(|r| r.as_ref())
}
type Field999MessageType<'this> where Self: 'this = ();
type Field999RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field999MessageType<'this>>;
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this> {
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub objc_class_prefix: ::std::option::Option<ScalarType>,
}
...
{
fn objc_class_prefix<'this>(&'this self) -> Option<&'this str> {
    self.objc_class_prefix.as_ref().map(|r| r.as_ref())
}
type Field999MessageType<'this> where Self: 'this = ();
type Field999RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field999MessageType<'this>>;
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this> {
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub csharp_namespace: ::std::option::Option<ScalarType>,
}
...
{
fn csharp_namespace<'this>(&'this self) -> Option<&'this str> {
    self.csharp_namespace.as_ref().map(|r| r.as_ref())
}
type Field999MessageType<'this> where Self: 'this = ();
type Field999RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field999MessageType<'this>>;
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this> {
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub swift_prefix: ::std::option::Option<ScalarType>,
}
...
{
fn swift_prefix<'this>(&'this self) -> Option<&'this str> {
    self.swift_prefix.as_ref().map(|r| r.as_ref())
}
type Field999MessageType<'this> where Self: 'this = ();
type Field999RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field999MessageType<'this>>;
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this> {
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub php_class_prefix: ::std::option::Option<ScalarType>,
}
...
{
fn php_class_prefix<'this>(&'this self) -> Option<&'this str> {
    self.php_class_prefix.as_ref().map(|r| r.as_ref())
}
type Field999MessageType<'this> where Self: 'this = ();
type Field999RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field999MessageType<'this>>;
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this> {
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub php_namespace: ::std::option::Option<ScalarType>,
}
...
{
fn php_namespace<'this>(&'this self) -> Option<&'this str> {
    self.php_namespace.as_ref().map(|r| r.as_ref())
}
type Field999MessageType<'this> where Self: 'this = ();
type Field999RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field999MessageType<'this>>;
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this> {
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub php_metadata_namespace: ::std::option::Option<ScalarType>,
}
...
{
fn php_metadata_namespace<'this>(&'this self) -> Option<&'this str> {
    self.php_metadata_namespace.as_ref().map(|r| r.as_ref())
}
type Field999MessageType<'this> where Self: 'this = ();
type Field999RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field999MessageType<'this>>;
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this> {
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub ruby_package: ::std::option::Option<ScalarType>,
}
...
{
fn ruby_package<'this>(&'this self) -> Option<&'this str> {
    self.ruby_package.as_ref().map(|r| r.as_ref())
}
type Field999MessageType<'this> where Self: 'this = ();
type Field999RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field999MessageType<'this>>;
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this> {
    ...
    T: FileOptionsTrait
{
    ...
    pub fn append_java_package<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField1<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField1 { java_package: value}))
    }

    pub fn append_java_outer_classname<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField8<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField8 { java_outer_classname: value}))
    }

    pub fn append_java_multiple_files(self, value: ::std::option::Option<bool>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField10)>
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField10 { java_multiple_files: value}))
    }

    pub fn append_java_generate_equals_and_hash(self, value: ::std::option::Option<bool>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField20)>
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField20 { java_generate_equals_and_hash: value}))
    }

    pub fn append_java_string_check_utf8(self, value: ::std::option::Option<bool>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField27)>
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField27 { java_string_check_utf8: value}))
    }

    pub fn append_optimize_for(self, value: ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::file_options::OptimizeMode>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField9)>
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField9 { optimize_for: value}))
    }

    pub fn append_go_package<ScalarType>(self, value: ::std::option::Option<ScalarType>)
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    ...
    pub fn append_cc_generic_services(self, value: ::std::option::Option<bool>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField16)>
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField16 { cc_generic_services: value}))
    }

    pub fn append_java_generic_services(self, value: ::std::option::Option<bool>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField17)>
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField17 { java_generic_services: value}))
    }

    pub fn append_py_generic_services(self, value: ::std::option::Option<bool>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField18)>
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField18 { py_generic_services: value}))
    }

    pub fn append_php_generic_services(self, value: ::std::option::Option<bool>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField42)>
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField42 { php_generic_services: value}))
    }

    pub fn append_deprecated(self, value: ::std::option::Option<bool>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField23)>
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField23 { deprecated: value}))
    }

    pub fn append_cc_enable_arenas(self, value: ::std::option::Option<bool>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField31)>
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField31 { cc_enable_arenas: value}))
    }

    pub fn append_objc_class_prefix<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField36<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField36 { objc_class_prefix: value}))
    }

    pub fn append_csharp_namespace<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField37<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField37 { csharp_namespace: value}))
    }

    pub fn append_swift_prefix<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField39<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField39 { swift_prefix: value}))
    }

    pub fn append_php_class_prefix<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField40<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField40 { php_class_prefix: value}))
    }

    pub fn append_php_namespace<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField41<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField41 { php_namespace: value}))
    }

    pub fn append_php_metadata_namespace<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField44<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField44 { php_metadata_namespace: value}))
    }

    pub fn append_ruby_package<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> FileOptionsBuilder<(T, FileOptionsSingleField45<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField45 { ruby_package: value}))
    }
...
>,
    {
        FileOptionsBuilder((self.0, FileOptionsSingleField999 { uninterpreted_option: value}))
    }
...
fn message_set_wire_format<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as MessageOptionsTrait>::message_set_wire_format(&self.1);
    if u == <() as MessageOptionsTrait>::message_set_wire_format(&()) {
        u = None;
    }
    u.or_else(|| <T as MessageOptionsTrait>::message_set_wire_format(&self.0))
}
fn no_standard_descriptor_accessor<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as MessageOptionsTrait>::no_standard_descriptor_accessor(&self.1);
    if u == <() as MessageOptionsTrait>::no_standard_descriptor_accessor(&()) {
        u = None;
    }
    u.or_else(|| <T as MessageOptionsTrait>::no_standard_descriptor_accessor(&self.0))
}
fn deprecated<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as MessageOptionsTrait>::deprecated(&self.1);
    if u == <() as MessageOptionsTrait>::deprecated(&()) {
        u = None;
    }
    u.or_else(|| <T as MessageOptionsTrait>::deprecated(&self.0))
}
fn map_entry<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as MessageOptionsTrait>::map_entry(&self.1);
    u.or_else(|| <T as MessageOptionsTrait>::map_entry(&self.0))
}type Field999MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as MessageOptionsTrait>::uninterpreted_option(t)
        )
        .map_right(
            |u| <U as MessageOptionsTrait>::uninterpreted_option(u)
        )
    )
}
...
fn no_standard_descriptor_accessor<'this>(&'this self) -> ::std::option::Option<bool> {
    self.as_ref().and_then(|msg| msg.no_standard_descriptor_accessor())
}
fn deprecated<'this>(&'this self) -> ::std::option::Option<bool> {
    self.as_ref().and_then(|msg| msg.deprecated())
}
...
impl ::puroro::Message<super::MessageOptions>
for MessageOptionsSingleField1
{}

impl super::_puroro_traits::MessageOptionsTrait
for MessageOptionsSingleField1
{
fn message_set_wire_format<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.message_set_wire_format)
...
impl ::puroro::Message<super::MessageOptions>
for MessageOptionsSingleField2
{}
...
impl ::puroro::Message<super::MessageOptions>
for MessageOptionsSingleField3
{}
...
impl ::puroro::Message<super::MessageOptions>
for MessageOptionsSingleField7
{}
    ...
    T: MessageOptionsTrait
{
    ...
    pub fn append_message_set_wire_format(self, value: ::std::option::Option<bool>)
        -> MessageOptionsBuilder<(T, MessageOptionsSingleField1)>
    {
        MessageOptionsBuilder((self.0, MessageOptionsSingleField1 { message_set_wire_format: value}))
    }

    pub fn append_no_standard_descriptor_accessor(self, value: ::std::option::Option<bool>)
        -> MessageOptionsBuilder<(T, MessageOptionsSingleField2)>
    {
        MessageOptionsBuilder((self.0, MessageOptionsSingleField2 { no_standard_descriptor_accessor: value}))
    }
    ...
    pub fn append_map_entry(self, value: ::std::option::Option<bool>)
...
>,
    {
        MessageOptionsBuilder((self.0, MessageOptionsSingleField999 { uninterpreted_option: value}))
    }
...
fn ctype<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Ctype>
{
    let mut u = <U as FieldOptionsTrait>::ctype(&self.1);
    if u == <() as FieldOptionsTrait>::ctype(&()) {
        u = None;
    }
    u.or_else(|| <T as FieldOptionsTrait>::ctype(&self.0))
}
fn packed<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FieldOptionsTrait>::packed(&self.1);
    u.or_else(|| <T as FieldOptionsTrait>::packed(&self.0))
}
fn jstype<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Jstype>
{
    let mut u = <U as FieldOptionsTrait>::jstype(&self.1);
    if u == <() as FieldOptionsTrait>::jstype(&()) {
        u = None;
    }
    u.or_else(|| <T as FieldOptionsTrait>::jstype(&self.0))
}
fn lazy<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FieldOptionsTrait>::lazy(&self.1);
    if u == <() as FieldOptionsTrait>::lazy(&()) {
        u = None;
    }
    u.or_else(|| <T as FieldOptionsTrait>::lazy(&self.0))
}
fn deprecated<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FieldOptionsTrait>::deprecated(&self.1);
    if u == <() as FieldOptionsTrait>::deprecated(&()) {
        u = None;
    }
    u.or_else(|| <T as FieldOptionsTrait>::deprecated(&self.0))
}
fn weak<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as FieldOptionsTrait>::weak(&self.1);
    if u == <() as FieldOptionsTrait>::weak(&()) {
        u = None;
    }
    u.or_else(|| <T as FieldOptionsTrait>::weak(&self.0))
}type Field999MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as FieldOptionsTrait>::uninterpreted_option(t)
        )
        .map_right(
            |u| <U as FieldOptionsTrait>::uninterpreted_option(u)
        )
    )
}
...
impl ::puroro::Message<super::FieldOptions>
for FieldOptionsSingleField1
{}

impl super::_puroro_traits::FieldOptionsTrait
for FieldOptionsSingleField1
{
fn ctype<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Ctype> {
    Clone::clone(&self.ctype)
...
impl ::std::convert::From<::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Ctype>>
for FieldOptionsSingleField1
{
    fn from(value: ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Ctype>) -> Self {
        Self {
            ctype: value,
        }
    }
...
impl ::std::convert::From<::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Jstype>>
for FieldOptionsSingleField6
{
    fn from(value: ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Jstype>) -> Self {
        Self {
            jstype: value,
        }
    }
    ...
    T: FieldOptionsTrait
{
    ...
    pub fn append_ctype(self, value: ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Ctype>)
        -> FieldOptionsBuilder<(T, FieldOptionsSingleField1)>
    {
        FieldOptionsBuilder((self.0, FieldOptionsSingleField1 { ctype: value}))
    }

    pub fn append_packed(self, value: ::std::option::Option<bool>)
        -> FieldOptionsBuilder<(T, FieldOptionsSingleField2)>
    {
        FieldOptionsBuilder((self.0, FieldOptionsSingleField2 { packed: value}))
    }

    pub fn append_jstype(self, value: ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Jstype>)
        -> FieldOptionsBuilder<(T, FieldOptionsSingleField6)>
    {
        FieldOptionsBuilder((self.0, FieldOptionsSingleField6 { jstype: value}))
    }

    pub fn append_lazy(self, value: ::std::option::Option<bool>)
    ...
    pub fn append_weak(self, value: ::std::option::Option<bool>)
...
>,
    {
        FieldOptionsBuilder((self.0, FieldOptionsSingleField999 { uninterpreted_option: value}))
    }
...
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as OneofOptionsTrait>::uninterpreted_option(t)
        )
        .map_right(
            |u| <U as OneofOptionsTrait>::uninterpreted_option(u)
        )
    )
}
...
>,
    {
        OneofOptionsBuilder((self.0, OneofOptionsSingleField999 { uninterpreted_option: value}))
    }
...
fn allow_alias<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as EnumOptionsTrait>::allow_alias(&self.1);
    u.or_else(|| <T as EnumOptionsTrait>::allow_alias(&self.0))
}
fn deprecated<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as EnumOptionsTrait>::deprecated(&self.1);
    if u == <() as EnumOptionsTrait>::deprecated(&()) {
        u = None;
    }
    u.or_else(|| <T as EnumOptionsTrait>::deprecated(&self.0))
}type Field999MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as EnumOptionsTrait>::uninterpreted_option(t)
        )
        .map_right(
            |u| <U as EnumOptionsTrait>::uninterpreted_option(u)
        )
    )
}
...
impl ::puroro::Message<super::EnumOptions>
for EnumOptionsSingleField2
{}

impl super::_puroro_traits::EnumOptionsTrait
for EnumOptionsSingleField2
{
fn allow_alias<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.allow_alias)
    ...
    T: EnumOptionsTrait
{
    ...
    pub fn append_allow_alias(self, value: ::std::option::Option<bool>)
...
>,
    {
        EnumOptionsBuilder((self.0, EnumOptionsSingleField999 { uninterpreted_option: value}))
    }
...
fn deprecated<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as EnumValueOptionsTrait>::deprecated(&self.1);
    if u == <() as EnumValueOptionsTrait>::deprecated(&()) {
        u = None;
    }
    u.or_else(|| <T as EnumValueOptionsTrait>::deprecated(&self.0))
}type Field999MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as EnumValueOptionsTrait>::uninterpreted_option(t)
        )
        .map_right(
            |u| <U as EnumValueOptionsTrait>::uninterpreted_option(u)
        )
    )
}
...
impl ::puroro::Message<super::EnumValueOptions>
for EnumValueOptionsSingleField1
{}

impl super::_puroro_traits::EnumValueOptionsTrait
for EnumValueOptionsSingleField1
{
fn deprecated<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.deprecated)
...
>,
    {
        EnumValueOptionsBuilder((self.0, EnumValueOptionsSingleField999 { uninterpreted_option: value}))
    }
...
fn deprecated<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as ServiceOptionsTrait>::deprecated(&self.1);
    if u == <() as ServiceOptionsTrait>::deprecated(&()) {
        u = None;
    }
    u.or_else(|| <T as ServiceOptionsTrait>::deprecated(&self.0))
}type Field999MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as ServiceOptionsTrait>::uninterpreted_option(t)
        )
        .map_right(
            |u| <U as ServiceOptionsTrait>::uninterpreted_option(u)
        )
    )
}
...
impl ::puroro::Message<super::ServiceOptions>
for ServiceOptionsSingleField33
{}

impl super::_puroro_traits::ServiceOptionsTrait
for ServiceOptionsSingleField33
{
fn deprecated<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.deprecated)
...
>,
    {
        ServiceOptionsBuilder((self.0, ServiceOptionsSingleField999 { uninterpreted_option: value}))
    }
...
fn deprecated<'this>(&'this self) -> Option<bool>
{
    let mut u = <U as MethodOptionsTrait>::deprecated(&self.1);
    if u == <() as MethodOptionsTrait>::deprecated(&()) {
        u = None;
    }
    u.or_else(|| <T as MethodOptionsTrait>::deprecated(&self.0))
}
fn idempotency_level<'this>(&'this self) -> Option<self::_puroro_root::google::protobuf::_puroro_nested::method_options::IdempotencyLevel>
{
    let mut u = <U as MethodOptionsTrait>::idempotency_level(&self.1);
    if u == <() as MethodOptionsTrait>::idempotency_level(&()) {
        u = None;
    }
    u.or_else(|| <T as MethodOptionsTrait>::idempotency_level(&self.0))
}type Field999MessageType<'this> where Self: 'this = ::puroro::Either<
...
fn uninterpreted_option<'this>(&'this self) -> Self::Field999RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as MethodOptionsTrait>::uninterpreted_option(t)
        )
        .map_right(
            |u| <U as MethodOptionsTrait>::uninterpreted_option(u)
        )
    )
}
...
impl ::puroro::Message<super::MethodOptions>
for MethodOptionsSingleField33
{}

impl super::_puroro_traits::MethodOptionsTrait
for MethodOptionsSingleField33
{
fn deprecated<'this>(&'this self) -> Option<bool> {
    Clone::clone(&self.deprecated)
    ...
    T: MethodOptionsTrait
{
    ...
    pub fn append_idempotency_level(self, value: ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::method_options::IdempotencyLevel>)
        -> MethodOptionsBuilder<(T, MethodOptionsSingleField34)>
    {
        MethodOptionsBuilder((self.0, MethodOptionsSingleField34 { idempotency_level: value}))
    }
...
>,
    {
        MethodOptionsBuilder((self.0, MethodOptionsSingleField999 { uninterpreted_option: value}))
    }
...
fn identifier_value<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as UninterpretedOptionTrait>::identifier_value(&self.1);
    u.or_else(|| <T as UninterpretedOptionTrait>::identifier_value(&self.0))
}
fn positive_int_value<'this>(&'this self) -> Option<u64>
{
    let mut u = <U as UninterpretedOptionTrait>::positive_int_value(&self.1);
    u.or_else(|| <T as UninterpretedOptionTrait>::positive_int_value(&self.0))
}
fn negative_int_value<'this>(&'this self) -> Option<i64>
{
    let mut u = <U as UninterpretedOptionTrait>::negative_int_value(&self.1);
    u.or_else(|| <T as UninterpretedOptionTrait>::negative_int_value(&self.0))
}
fn double_value<'this>(&'this self) -> Option<f64>
{
    let mut u = <U as UninterpretedOptionTrait>::double_value(&self.1);
    u.or_else(|| <T as UninterpretedOptionTrait>::double_value(&self.0))
}
fn string_value<'this>(&'this self) -> Option<&'this [u8]>
{
    let mut u = <U as UninterpretedOptionTrait>::string_value(&self.1);
    u.or_else(|| <T as UninterpretedOptionTrait>::string_value(&self.0))
}
fn aggregate_value<'this>(&'this self) -> Option<&'this str>
{
    let mut u = <U as UninterpretedOptionTrait>::aggregate_value(&self.1);
    u.or_else(|| <T as UninterpretedOptionTrait>::aggregate_value(&self.0))
}
...
fn name<'this>(&'this self) -> Self::Field2RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as UninterpretedOptionTrait>::name(t)
        )
        .map_right(
            |u| <U as UninterpretedOptionTrait>::name(u)
        )
    )
}
fn identifier_value<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as UninterpretedOptionTrait>::identifier_value(t),
        |u| <U as UninterpretedOptionTrait>::identifier_value(u),
    )
}
fn positive_int_value<'this>(&'this self) -> Option<u64>
{
...
{
    self.as_ref().either(
        |t| <T as UninterpretedOptionTrait>::string_value(t),
        |u| <U as UninterpretedOptionTrait>::string_value(u),
    )
}
fn aggregate_value<'this>(&'this self) -> Option<&'this str>
{
    self.as_ref().either(
        |t| <T as UninterpretedOptionTrait>::aggregate_value(t),
        |u| <U as UninterpretedOptionTrait>::aggregate_value(u),
    )
}
...
type Field2RepeatedType<'this> where Self: 'this =
    ...
    >;
fn name<'this>(&'this self) -> Self::Field2RepeatedType<'this> {
    self.as_ref().map(|msg| msg.name().into_iter()).into_iter().flatten()
}
fn identifier_value<'this>(&'this self) -> ::std::option::Option<&'this str> {
...
fn string_value<'this>(&'this self) -> ::std::option::Option<&'this [u8]> {
    self.as_ref().and_then(|msg| msg.string_value())
}
fn aggregate_value<'this>(&'this self) -> ::std::option::Option<&'this str> {
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub identifier_value: ::std::option::Option<ScalarType>,
}
...
fn identifier_value<'this>(&'this self) -> Option<&'this str> {
    self.identifier_value.as_ref().map(|r| r.as_ref())
}
}
...
impl ::puroro::Message<super::UninterpretedOption>
for UninterpretedOptionSingleField4
{}

impl super::_puroro_traits::UninterpretedOptionTrait
for UninterpretedOptionSingleField4
{
type Field2MessageType<'this> where Self: 'this = ();
type Field2RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<Self::Field2MessageType<'this>>;
...
impl ::std::convert::From<::std::option::Option<u64>>
for UninterpretedOptionSingleField4
{
...
impl ::puroro::Message<super::UninterpretedOption>
for UninterpretedOptionSingleField5
{}
...
impl ::std::convert::From<::std::option::Option<i64>>
for UninterpretedOptionSingleField5
{
...
impl ::puroro::Message<super::UninterpretedOption>
for UninterpretedOptionSingleField6
{}
...
impl ::std::convert::From<::std::option::Option<f64>>
for UninterpretedOptionSingleField6
{
...
{
    pub string_value: ::std::option::Option<ScalarType>,
}
...
fn string_value<'this>(&'this self) -> Option<&'this [u8]> {
    self.string_value.as_ref().map(|r| r.as_ref())
}
}
...
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
{
    pub aggregate_value: ::std::option::Option<ScalarType>,
}
...
fn aggregate_value<'this>(&'this self) -> Option<&'this str> {
    self.aggregate_value.as_ref().map(|r| r.as_ref())
}
}
...
>,
    ...
    pub fn append_identifier_value<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> UninterpretedOptionBuilder<(T, UninterpretedOptionSingleField3<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        UninterpretedOptionBuilder((self.0, UninterpretedOptionSingleField3 { identifier_value: value}))
    }

    pub fn append_positive_int_value(self, value: ::std::option::Option<u64>)
        -> UninterpretedOptionBuilder<(T, UninterpretedOptionSingleField4)>
    {
        UninterpretedOptionBuilder((self.0, UninterpretedOptionSingleField4 { positive_int_value: value}))
    }

    pub fn append_negative_int_value(self, value: ::std::option::Option<i64>)
        -> UninterpretedOptionBuilder<(T, UninterpretedOptionSingleField5)>
    {
        UninterpretedOptionBuilder((self.0, UninterpretedOptionSingleField5 { negative_int_value: value}))
    }

    pub fn append_double_value(self, value: ::std::option::Option<f64>)
        -> UninterpretedOptionBuilder<(T, UninterpretedOptionSingleField6)>
    {
        UninterpretedOptionBuilder((self.0, UninterpretedOptionSingleField6 { double_value: value}))
    }

    pub fn append_string_value<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> UninterpretedOptionBuilder<(T, UninterpretedOptionSingleField7<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<[u8]> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        UninterpretedOptionBuilder((self.0, UninterpretedOptionSingleField7 { string_value: value}))
    }

    pub fn append_aggregate_value<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        -> UninterpretedOptionBuilder<(T, UninterpretedOptionSingleField8<ScalarType>)>
where
ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
    {
        UninterpretedOptionBuilder((self.0, UninterpretedOptionSingleField8 { aggregate_value: value}))
    }
...
fn location<'this>(&'this self) -> Self::Field1RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as SourceCodeInfoTrait>::location(t)
        )
        .map_right(
            |u| <U as SourceCodeInfoTrait>::location(u)
        )
    )
}
...
type Field1RepeatedType<'this> where Self: 'this =
    ...
    >;
fn location<'this>(&'this self) -> Self::Field1RepeatedType<'this> {
    self.as_ref().map(|msg| msg.location().into_iter()).into_iter().flatten()
}
}
...
fn annotation<'this>(&'this self) -> Self::Field1RepeatedType<'this>
{
    ::puroro::internal::impls::either::EitherRepeatedMessageField::new(self
        .as_ref()
        .map_left(
            |t| <T as GeneratedCodeInfoTrait>::annotation(t)
        )
        .map_right(
            |u| <U as GeneratedCodeInfoTrait>::annotation(u)
        )
    )
}
...
type Field1RepeatedType<'this> where Self: 'this =
    ...
    >;
fn annotation<'this>(&'this self) -> Self::Field1RepeatedType<'this> {
    self.as_ref().map(|msg| msg.annotation().into_iter()).into_iter().flatten()
}
}
...
pub mod _puroro_traits {
    ...
    macro_rules! file_descriptor_set_delegate {
        ($ty:ty) => {
            type Field1MessageType<'this> where Self: 'this = <$ty>::Field1MessageType<'this>;
            type Field1RepeatedType<'this> where Self: 'this = <$ty>::Field1RepeatedType<'this>;
            fn file<'this>(&'this self) -> Self::Field1RepeatedType<'this> {
                (**self).file()
            }
        };
    ...
    macro_rules! file_descriptor_proto_delegate {
        ($ty:ty) => {
            ...
            type Field3RepeatedType<'this> where Self: 'this = <$ty>::Field3RepeatedType<'this>;
            fn dependency<'this>(&'this self) -> Self::Field3RepeatedType<'this> {
                (**self).dependency()
            }
            type Field10RepeatedType<'this> where Self: 'this = <$ty>::Field10RepeatedType<'this>;
            fn public_dependency<'this>(&'this self) -> Self::Field10RepeatedType<'this> {
                (**self).public_dependency()
            }
            type Field11RepeatedType<'this> where Self: 'this = <$ty>::Field11RepeatedType<'this>;
            fn weak_dependency<'this>(&'this self) -> Self::Field11RepeatedType<'this> {
                (**self).weak_dependency()
            }
            type Field4MessageType<'this> where Self: 'this = <$ty>::Field4MessageType<'this>;
            type Field4RepeatedType<'this> where Self: 'this = <$ty>::Field4RepeatedType<'this>;
            fn message_type<'this>(&'this self) -> Self::Field4RepeatedType<'this> {
                (**self).message_type()
            }
            type Field5MessageType<'this> where Self: 'this = <$ty>::Field5MessageType<'this>;
            type Field5RepeatedType<'this> where Self: 'this = <$ty>::Field5RepeatedType<'this>;
            fn enum_type<'this>(&'this self) -> Self::Field5RepeatedType<'this> {
                (**self).enum_type()
            }
            type Field6MessageType<'this> where Self: 'this = <$ty>::Field6MessageType<'this>;
            type Field6RepeatedType<'this> where Self: 'this = <$ty>::Field6RepeatedType<'this>;
            fn service<'this>(&'this self) -> Self::Field6RepeatedType<'this> {
                (**self).service()
            }
            type Field7MessageType<'this> where Self: 'this = <$ty>::Field7MessageType<'this>;
            type Field7RepeatedType<'this> where Self: 'this = <$ty>::Field7RepeatedType<'this>;
            fn extension<'this>(&'this self) -> Self::Field7RepeatedType<'this> {
                (**self).extension()
            }
            type Field8MessageType<'this> where Self: 'this = <$ty>::Field8MessageType<'this>;
            fn options<'this>(&'this self) -> ::std::option::Option<Self::Field8MessageType<'this>> {
                (**self).options()
            }
            type Field9MessageType<'this> where Self: 'this = <$ty>::Field9MessageType<'this>;
            fn source_code_info<'this>(&'this self) -> ::std::option::Option<Self::Field9MessageType<'this>> {
                (**self).source_code_info()
            }
            fn syntax<'this>(&'this self) -> ::std::option::Option<&'this str> {
    ...
    macro_rules! descriptor_proto_delegate {
        ($ty:ty) => {
            ...
            type Field2MessageType<'this> where Self: 'this = <$ty>::Field2MessageType<'this>;
            type Field2RepeatedType<'this> where Self: 'this = <$ty>::Field2RepeatedType<'this>;
            fn field<'this>(&'this self) -> Self::Field2RepeatedType<'this> {
                (**self).field()
            }
            type Field6MessageType<'this> where Self: 'this = <$ty>::Field6MessageType<'this>;
            ...
            type Field3MessageType<'this> where Self: 'this = <$ty>::Field3MessageType<'this>;
            type Field3RepeatedType<'this> where Self: 'this = <$ty>::Field3RepeatedType<'this>;
            fn nested_type<'this>(&'this self) -> Self::Field3RepeatedType<'this> {
                (**self).nested_type()
            }
            ...
            type Field8MessageType<'this> where Self: 'this = <$ty>::Field8MessageType<'this>;
            type Field8RepeatedType<'this> where Self: 'this = <$ty>::Field8RepeatedType<'this>;
            fn oneof_decl<'this>(&'this self) -> Self::Field8RepeatedType<'this> {
                (**self).oneof_decl()
            }
            type Field7MessageType<'this> where Self: 'this = <$ty>::Field7MessageType<'this>;
            ...
            type Field9MessageType<'this> where Self: 'this = <$ty>::Field9MessageType<'this>;
            type Field9RepeatedType<'this> where Self: 'this = <$ty>::Field9RepeatedType<'this>;
            fn reserved_range<'this>(&'this self) -> Self::Field9RepeatedType<'this> {
                (**self).reserved_range()
            }
            type Field10RepeatedType<'this> where Self: 'this = <$ty>::Field10RepeatedType<'this>;
    ...
    pub trait MethodDescriptorProtoTrait {
        ...
        fn client_streaming<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn server_streaming<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
    }
    ...
    pub trait FileOptionsTrait {
        ...
        fn java_multiple_files<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn java_generate_equals_and_hash<'this>(&'this self) -> ::std::option::Option<bool> {
            ::std::default::Default::default()
        }
        fn java_string_check_utf8<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn optimize_for<'this>(&'this self) -> ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::file_options::OptimizeMode> {::std::option::Option::Some(self::_puroro_root::google::protobuf::_puroro_nested::file_options::OptimizeMode::Speed)
        }
        fn go_package<'this>(&'this self) -> ::std::option::Option<&'this str> {
            ::std::default::Default::default()
        }
        fn cc_generic_services<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn java_generic_services<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn py_generic_services<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn php_generic_services<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn deprecated<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn cc_enable_arenas<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(true)
        }
        fn objc_class_prefix<'this>(&'this self) -> ::std::option::Option<&'this str> {
            ::std::default::Default::default()
        }
    ...
    pub trait MessageOptionsTrait {
        fn message_set_wire_format<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn no_standard_descriptor_accessor<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn deprecated<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn map_entry<'this>(&'this self) -> ::std::option::Option<bool> {
    ...
    pub trait FieldOptionsTrait {
        fn ctype<'this>(&'this self) -> ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Ctype> {::std::option::Option::Some(self::_puroro_root::google::protobuf::_puroro_nested::field_options::Ctype::String)
        }
        fn packed<'this>(&'this self) -> ::std::option::Option<bool> {
            ::std::default::Default::default()
        }
        fn jstype<'this>(&'this self) -> ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::field_options::Jstype> {::std::option::Option::Some(self::_puroro_root::google::protobuf::_puroro_nested::field_options::Jstype::JsNormal)
        }
        fn lazy<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn deprecated<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        fn weak<'this>(&'this self) -> ::std::option::Option<bool> {::std::option::Option::Some(false)
        }
        type Field999MessageType<'this>:
            self::_puroro_root::google::protobuf::_puroro_traits::UninterpretedOptionTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug
            where Self: 'this;
    ...
    pub trait MethodOptionsTrait {
        ...
        fn idempotency_level<'this>(&'this self) -> ::std::option::Option<self::_puroro_root::google::protobuf::_puroro_nested::method_options::IdempotencyLevel> {::std::option::Option::Some(self::_puroro_root::google::protobuf::_puroro_nested::method_options::IdempotencyLevel::IdempotencyUnknown)
        }
        type Field999MessageType<'this>:
            self::_puroro_root::google::protobuf::_puroro_traits::UninterpretedOptionTrait + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug
            where Self: 'this;
...
pub mod _puroro_nested {
    ...
    pub mod descriptor_proto {
                    ...
                    [
                        {
                            let init = ::puroro::internal::FieldDescriptorInitializer {
                                name: "start",
                                number: 1,
                                lazy_containing_type: Lazy::new(|| <ExtensionRange as ::puroro::MessageRepresentativeImpl>::descriptor()),
                            };
                            ::puroro::internal::init_field_descriptor(init)
                        },
                        {
                    ...
                    [
                        {
                            let init = ::puroro::internal::FieldDescriptorInitializer {
                                name: "start",
                                number: 1,
                                lazy_containing_type: Lazy::new(|| <ReservedRange as ::puroro::MessageRepresentativeImpl>::descriptor()),
                            };
                            ::puroro::internal::init_field_descriptor(init)
                        },
                        {
        ...
        pub mod _puroro_impls {
            mod _puroro_root {
                pub use super::super::_puroro_root::*;
            }use super::_puroro_traits::*;impl ExtensionRangeTrait for () {
        type Field3MessageType<'this> where Self: 'this = ();
        ...
        fn start<'this>(&'this self) -> Option<i32>
        {
            let mut u = <U as ExtensionRangeTrait>::start(&self.1);
            u.or_else(|| <T as ExtensionRangeTrait>::start(&self.0))
        }
        fn end<'this>(&'this self) -> Option<i32>
        {
            let mut u = <U as ExtensionRangeTrait>::end(&self.1);
            u.or_else(|| <T as ExtensionRangeTrait>::end(&self.0))
        }type Field3MessageType<'this> where Self: 'this = (
        ...
        {
            self.as_ref().either(
                |t| <T as ExtensionRangeTrait>::options(t).map(
                    |t| ::puroro::Either::Left(t)
                ),
                |u| <U as ExtensionRangeTrait>::options(u).map(
                    |u| ::puroro::Either::Right(u)
                ),
            )
        }
        ...
        impl ::puroro::Message<super::ExtensionRange>
        for ExtensionRangeSingleField1
        {}
        
        impl super::_puroro_traits::ExtensionRangeTrait
        for ExtensionRangeSingleField1
        {
        fn start<'this>(&'this self) -> Option<i32> {
            Clone::clone(&self.start)
        ...
        impl ::puroro::Message<super::ExtensionRange>
        for ExtensionRangeSingleField2
        {}
        ...
        fn start<'this>(&'this self) -> Option<i32>
        {
            let mut u = <U as ReservedRangeTrait>::start(&self.1);
            u.or_else(|| <T as ReservedRangeTrait>::start(&self.0))
        }
        fn end<'this>(&'this self) -> Option<i32>
        {
            let mut u = <U as ReservedRangeTrait>::end(&self.1);
            u.or_else(|| <T as ReservedRangeTrait>::end(&self.0))
        }
        ...
        impl ::puroro::Message<super::ReservedRange>
        for ReservedRangeSingleField1
        {}
        
        impl super::_puroro_traits::ReservedRangeTrait
        for ReservedRangeSingleField1
        {
        fn start<'this>(&'this self) -> Option<i32> {
            Clone::clone(&self.start)
    ...
    pub mod enum_descriptor_proto {
                    ...
                    [
                        {
                            let init = ::puroro::internal::FieldDescriptorInitializer {
                                name: "start",
                                number: 1,
                                lazy_containing_type: Lazy::new(|| <EnumReservedRange as ::puroro::MessageRepresentativeImpl>::descriptor()),
                            };
                            ::puroro::internal::init_field_descriptor(init)
                        },
                        {
        ...
        pub mod _puroro_impls {
            mod _puroro_root {
                pub use super::super::_puroro_root::*;
            }use super::_puroro_traits::*;impl EnumReservedRangeTrait for () {
        ...
        fn start<'this>(&'this self) -> Option<i32>
        {
            let mut u = <U as EnumReservedRangeTrait>::start(&self.1);
            u.or_else(|| <T as EnumReservedRangeTrait>::start(&self.0))
        }
        fn end<'this>(&'this self) -> Option<i32>
        {
            let mut u = <U as EnumReservedRangeTrait>::end(&self.1);
            u.or_else(|| <T as EnumReservedRangeTrait>::end(&self.0))
        }
        ...
        impl ::puroro::Message<super::EnumReservedRange>
        for EnumReservedRangeSingleField1
        {}
        
        impl super::_puroro_traits::EnumReservedRangeTrait
        for EnumReservedRangeSingleField1
        {
        fn start<'this>(&'this self) -> Option<i32> {
            Clone::clone(&self.start)
        ...
        impl ::puroro::Message<super::EnumReservedRange>
        for EnumReservedRangeSingleField2
        {}
            ...
            T: EnumReservedRangeTrait
        {
            ...
            {
                EnumReservedRangeBuilder((self.0, EnumReservedRangeSingleField1 { start: value}))
            }
    ...
    pub mod uninterpreted_option {
        ...
        fn name_part<'this>(&'this self) -> Option<&'this str> {
                    ...
                    [
                        {
                            let init = ::puroro::internal::FieldDescriptorInitializer {
                                name: "name_part",
                                number: 1,
                                lazy_containing_type: Lazy::new(|| <NamePart as ::puroro::MessageRepresentativeImpl>::descriptor()),
                            };
                            ::puroro::internal::init_field_descriptor(init)
                        },
                        {
        ...
        pub mod _puroro_impls {
            mod _puroro_root {
                pub use super::super::_puroro_root::*;
            }use super::_puroro_traits::*;impl NamePartTrait for () {
        ...
        fn name_part<'this>(&'this self) -> Option<&'this str>
        {
            let mut u = <U as NamePartTrait>::name_part(&self.1);
            u.or_else(|| <T as NamePartTrait>::name_part(&self.0))
        }
        fn is_extension<'this>(&'this self) -> Option<bool>
        {
            let mut u = <U as NamePartTrait>::is_extension(&self.1);
            u.or_else(|| <T as NamePartTrait>::is_extension(&self.0))
        }
        ...
        {
            self.as_ref().either(
                |t| <T as NamePartTrait>::name_part(t),
                |u| <U as NamePartTrait>::name_part(u),
            )
        }
        fn is_extension<'this>(&'this self) -> Option<bool>
        {
        ...
        where
            T: NamePartTrait,
        {
        fn name_part<'this>(&'this self) -> ::std::option::Option<&'this str> {
        ...
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
        {
            pub name_part: ::std::option::Option<ScalarType>,
        }
        
        impl<ScalarType> ::puroro::Message<super::NamePart>
        for NamePartSingleField1<ScalarType>
        where
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
        {}
        
        impl<ScalarType> super::_puroro_traits::NamePartTrait
        for NamePartSingleField1<ScalarType>
        where
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
        {
        fn name_part<'this>(&'this self) -> Option<&'this str> {
            self.name_part.as_ref().map(|r| r.as_ref())
        }
        }
        ...
        impl ::puroro::Message<super::NamePart>
        for NamePartSingleField2
        {}
        
        impl super::_puroro_traits::NamePartTrait
        for NamePartSingleField2
        {
        fn is_extension<'this>(&'this self) -> Option<bool> {
            Clone::clone(&self.is_extension)
            ...
            T: NamePartTrait
        {
            ...
            pub fn append_name_part<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        ...
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
            ...
            pub fn append_is_extension(self, value: ::std::option::Option<bool>)
                -> NamePartBuilder<(T, NamePartSingleField2)>
            {
                NamePartBuilder((self.0, NamePartSingleField2 { is_extension: value}))
            }
    ...
    pub mod source_code_info {
        ...
        type Field1RepeatedType<'this> = ::std::iter::Cloned<::std::slice::Iter<'this, i32>>;
        ...
        fn leading_comments<'this>(&'this self) -> Option<&'this str> {
            self.leading_comments.as_ref().map(|v| v.as_ref())
        }
        fn trailing_comments<'this>(&'this self) -> Option<&'this str> {
        ...
        fn leading_detached_comments<'this>(&'this self) -> Self::Field6RepeatedType<'this> {
            ::puroro::internal::impls::simple::BorrowedIter::new(self.leading_detached_comments.iter())
        }
        }
                    ...
                    [
                        {
                            let init = ::puroro::internal::FieldDescriptorInitializer {
                                name: "path",
                                number: 1,
                                lazy_containing_type: Lazy::new(|| <Location as ::puroro::MessageRepresentativeImpl>::descriptor()),
                            };
                            ::puroro::internal::init_field_descriptor(init)
                        },
                        {
        ...
        pub mod _puroro_impls {
            mod _puroro_root {
                pub use super::super::_puroro_root::*;
            }use super::_puroro_traits::*;impl LocationTrait for () {
        type Field1RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<i32>;
        fn path<'this>(&'this self) -> Self::Field1RepeatedType<'this> {
            ::puroro::internal::impls::empty::EmptyRepeatedField::new()
        }
        ...
        fn leading_comments<'this>(&'this self) -> Option<&'this str>
        {
            let mut u = <U as LocationTrait>::leading_comments(&self.1);
            u.or_else(|| <T as LocationTrait>::leading_comments(&self.0))
        }
        fn trailing_comments<'this>(&'this self) -> Option<&'this str>
        {
            let mut u = <U as LocationTrait>::trailing_comments(&self.1);
            u.or_else(|| <T as LocationTrait>::trailing_comments(&self.0))
        }
        type Field6RepeatedType<'this> where Self: 'this
            = ::puroro::internal::impls::merged::MergedRepeatedField<
        ...
        fn path<'this>(&'this self) -> Self::Field1RepeatedType<'this>
        {
            ::puroro::internal::impls::either::EitherRepeatedField::new(self
                .as_ref()
                .map_left(
                    |t| <T as LocationTrait>::path(t)
                )
                .map_right(
                    |u| <U as LocationTrait>::path(u)
                )
            )
        }
        type Field2RepeatedType<'this> where Self: 'this
        ...
        fn span<'this>(&'this self) -> Self::Field2RepeatedType<'this>
        {
            ::puroro::internal::impls::either::EitherRepeatedField::new(self
                .as_ref()
                .map_left(
                    |t| <T as LocationTrait>::span(t)
                )
                .map_right(
                    |u| <U as LocationTrait>::span(u)
                )
            )
        }
        fn leading_comments<'this>(&'this self) -> Option<&'this str>
        {
            self.as_ref().either(
                |t| <T as LocationTrait>::leading_comments(t),
                |u| <U as LocationTrait>::leading_comments(u),
            )
        }
        fn trailing_comments<'this>(&'this self) -> Option<&'this str>
        {
            self.as_ref().either(
                |t| <T as LocationTrait>::trailing_comments(t),
                |u| <U as LocationTrait>::trailing_comments(u),
            )
        }
        type Field6RepeatedType<'this> where Self: 'this
            = ::puroro::internal::impls::either::EitherRepeatedField<
        ...
        fn leading_detached_comments<'this>(&'this self) -> Self::Field6RepeatedType<'this>
        {
            ::puroro::internal::impls::either::EitherRepeatedField::new(self
                .as_ref()
                .map_left(
                    |t| <T as LocationTrait>::leading_detached_comments(t)
                )
                .map_right(
                    |u| <U as LocationTrait>::leading_detached_comments(u)
                )
            )
        }
        ...
        type Field1RepeatedType<'this> where Self: 'this =
            ...
            >;
        fn path<'this>(&'this self) -> Self::Field1RepeatedType<'this> {
            self.as_ref().map(|msg| msg.path().into_iter()).into_iter().flatten()
        }
        type Field2RepeatedType<'this> where Self: 'this =
            ::std::iter::Flatten<
                ::std::option::IntoIter<
            ...
            >;
        fn span<'this>(&'this self) -> Self::Field2RepeatedType<'this> {
            self.as_ref().map(|msg| msg.span().into_iter()).into_iter().flatten()
        }
        fn leading_comments<'this>(&'this self) -> ::std::option::Option<&'this str> {
            self.as_ref().and_then(|msg| msg.leading_comments())
        }
        fn trailing_comments<'this>(&'this self) -> ::std::option::Option<&'this str> {
        ...
        type Field6RepeatedType<'this> where Self: 'this =
            ...
            >;
        fn leading_detached_comments<'this>(&'this self) -> Self::Field6RepeatedType<'this> {
            self.as_ref().map(|msg| msg.leading_detached_comments().into_iter()).into_iter().flatten()
        }
        }
        ...
        impl<RepeatedType> ::puroro::Message<super::Location>
        ...
        impl<RepeatedType> super::_puroro_traits::LocationTrait
        for LocationSingleField1<RepeatedType>
        where
        for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
            Item = &'a i32
        ...
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
        {
            pub leading_comments: ::std::option::Option<ScalarType>,
        }
        
        impl<ScalarType> ::puroro::Message<super::Location>
        for LocationSingleField3<ScalarType>
        where
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
        {}
        
        impl<ScalarType> super::_puroro_traits::LocationTrait
        for LocationSingleField3<ScalarType>
        where
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
        {
        ...
        fn leading_comments<'this>(&'this self) -> Option<&'this str> {
            self.leading_comments.as_ref().map(|r| r.as_ref())
        }
        type Field6RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<&'this str>;
        fn leading_detached_comments<'this>(&'this self) -> Self::Field6RepeatedType<'this> {
            ::puroro::internal::impls::empty::EmptyRepeatedField::new()
        ...
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
        {
            pub trailing_comments: ::std::option::Option<ScalarType>,
        }
        ...
        fn trailing_comments<'this>(&'this self) -> Option<&'this str> {
            self.trailing_comments.as_ref().map(|r| r.as_ref())
        }
        type Field6RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<&'this str>;
        fn leading_detached_comments<'this>(&'this self) -> Self::Field6RepeatedType<'this> {
            ::puroro::internal::impls::empty::EmptyRepeatedField::new()
            ...
            T: LocationTrait
        {
            ...
            pub fn append_path<RepeatedType>(self, value: RepeatedType)
        ...
        >,
            ...
            pub fn append_span<RepeatedType>(self, value: RepeatedType)
        ...
        >,
            ...
            pub fn append_leading_comments<ScalarType>(self, value: ::std::option::Option<ScalarType>)
                -> LocationBuilder<(T, LocationSingleField3<ScalarType>)>
        where
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
            {
                LocationBuilder((self.0, LocationSingleField3 { leading_comments: value}))
            }
        
            pub fn append_trailing_comments<ScalarType>(self, value: ::std::option::Option<ScalarType>)
                -> LocationBuilder<(T, LocationSingleField4<ScalarType>)>
        where
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
            {
                LocationBuilder((self.0, LocationSingleField4 { trailing_comments: value}))
            }
        
            pub fn append_leading_detached_comments<ScalarType, RepeatedType>(self, value: RepeatedType)
        ...
        >,
            {
                LocationBuilder((self.0, LocationSingleField6 { leading_detached_comments: value}))
            }
    ...
    pub mod generated_code_info {
        ...
        fn source_file<'this>(&'this self) -> Option<&'this str> {
        ...
        impl ::puroro::MessageRepresentativeImpl for Annotation {
            fn descriptor() -> &'static ::puroro::desc::MessageDescriptor {
                use ::puroro::once_cell::sync::Lazy;
                static LAZY_FIELD_DESCRIPTOR_ARRAY: Lazy<[::puroro::desc::FieldDescriptor; 4]> = Lazy::new(|| {
                    [
                        {
                            let init = ::puroro::internal::FieldDescriptorInitializer {
                                name: "path",
                                number: 1,
                                lazy_containing_type: Lazy::new(|| <Annotation as ::puroro::MessageRepresentativeImpl>::descriptor()),
                            };
                            ::puroro::internal::init_field_descriptor(init)
                        },
                        {
        ...
        pub mod _puroro_impls {
            mod _puroro_root {
                pub use super::super::_puroro_root::*;
            }use super::_puroro_traits::*;impl AnnotationTrait for () {
        type Field1RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<i32>;
        fn path<'this>(&'this self) -> Self::Field1RepeatedType<'this> {
            ::puroro::internal::impls::empty::EmptyRepeatedField::new()
        }
        ...
        fn source_file<'this>(&'this self) -> Option<&'this str>
        {
            let mut u = <U as AnnotationTrait>::source_file(&self.1);
            u.or_else(|| <T as AnnotationTrait>::source_file(&self.0))
        }
        fn begin<'this>(&'this self) -> Option<i32>
        {
            let mut u = <U as AnnotationTrait>::begin(&self.1);
            u.or_else(|| <T as AnnotationTrait>::begin(&self.0))
        }
        fn end<'this>(&'this self) -> Option<i32>
        {
            let mut u = <U as AnnotationTrait>::end(&self.1);
            u.or_else(|| <T as AnnotationTrait>::end(&self.0))
        }
        ...
        fn path<'this>(&'this self) -> Self::Field1RepeatedType<'this>
        {
            ::puroro::internal::impls::either::EitherRepeatedField::new(self
                .as_ref()
                .map_left(
                    |t| <T as AnnotationTrait>::path(t)
                )
                .map_right(
                    |u| <U as AnnotationTrait>::path(u)
                )
            )
        }
        fn source_file<'this>(&'this self) -> Option<&'this str>
        {
            self.as_ref().either(
                |t| <T as AnnotationTrait>::source_file(t),
                |u| <U as AnnotationTrait>::source_file(u),
            )
        }
        fn begin<'this>(&'this self) -> Option<i32>
        {
        ...
        fn source_file<'this>(&'this self) -> ::std::option::Option<&'this str> {
        ...
        impl<RepeatedType> ::puroro::Message<super::Annotation>
        ...
        impl<RepeatedType> super::_puroro_traits::AnnotationTrait
        for AnnotationSingleField1<RepeatedType>
        where
        for <'a> &'a RepeatedType: ::std::iter::IntoIterator<
            Item = &'a i32
        ...
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
        {
            pub source_file: ::std::option::Option<ScalarType>,
        }
        
        impl<ScalarType> ::puroro::Message<super::Annotation>
        for AnnotationSingleField2<ScalarType>
        where
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
        {}
        
        impl<ScalarType> super::_puroro_traits::AnnotationTrait
        for AnnotationSingleField2<ScalarType>
        where
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
        {
        ...
        fn source_file<'this>(&'this self) -> Option<&'this str> {
            self.source_file.as_ref().map(|r| r.as_ref())
        }
        }
        ...
        impl ::puroro::Message<super::Annotation>
        for AnnotationSingleField3
        {}
        
        impl super::_puroro_traits::AnnotationTrait
        for AnnotationSingleField3
        {
        type Field1RepeatedType<'this> where Self: 'this = ::puroro::internal::impls::empty::EmptyRepeatedField<i32>;
        fn path<'this>(&'this self) -> Self::Field1RepeatedType<'this> {
        ...
        >,
            ...
            pub fn append_source_file<ScalarType>(self, value: ::std::option::Option<ScalarType>)
        ...
        ScalarType: ::std::convert::AsRef<str> + ::std::clone::Clone + ::std::cmp::PartialEq + ::std::fmt::Debug,
            ...
            pub fn append_begin(self, value: ::std::option::Option<i32>)
