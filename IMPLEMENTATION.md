...
| FieldKind → catalog emission (struct members, accessors, visitors) | **Partial** — singular scalar / string / bytes / bool / enum (open+closed; Editions cross-file import e2e); repeated / oneof / message not yet |
