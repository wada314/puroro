...
| FieldKind → catalog emission (struct members, accessors, visitors) | **Partial** — singular scalar / string / bytes / bool / enum / message (file-level peers + cross-file); repeated / oneof / nested declarations not yet |
