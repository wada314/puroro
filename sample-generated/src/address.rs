...
pub const BIT_STREET_LAZY_KIND: usize = 8; // lazy-only 2-bit WireOrSso kind (this bit and the next)
pub const BIT_CITY_LAZY_KIND: usize = 10; // lazy-only 2-bit WireOrSso kind (this bit and the next)
