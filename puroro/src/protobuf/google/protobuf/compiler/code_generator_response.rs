...
*/
pub struct File<A: ::std::alloc::Allocator = ::std::alloc::Global>(
    ::std::boxed::Box<
...
impl ::std::default::Default for self::File {
    fn default() -> Self {
        Self(
            ::std::boxed::Box::new(
                <self::_root::google::protobuf::compiler::code_generator_response::_view::FileView as ::std::default::Default>::default(),
            ),
        )
    }
}
#[cfg(feature = "allocator_api")]
impl<A> self::_puroro::DefaultIn<A> for self::File::<A>
where
    A: ::std::alloc::Allocator + ::std::clone::Clone,
    self::_root::google::protobuf::compiler::code_generator_response::_view::FileView: self::_puroro::DefaultIn<
        A,
    >,
{
    fn default_in(allocator: A) -> Self {
        Self(
            ::std::boxed::Box::new_in(
                <self::_root::google::protobuf::compiler::code_generator_response::_view::FileView as self::_puroro::DefaultIn<
                    A,
...
> ::std::cmp::PartialEq<self::File<A2>> for self::File<A1> {
    fn eq(&self, rhs: &self::File<A2>) -> bool {
        <self::_root::google::protobuf::compiler::code_generator_response::_view::FileView as ::std::cmp::PartialEq>::eq(
            &self.0,
            &rhs.0,
        )
