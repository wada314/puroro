...
pub struct Location<A: ::std::alloc::Allocator = ::std::alloc::Global>(
    ::std::boxed::Box<
...
impl ::std::default::Default for self::Location {
    fn default() -> Self {
        Self(
            ::std::boxed::Box::new(
                <self::_root::google::protobuf::source_code_info::_view::LocationView as ::std::default::Default>::default(),
            ),
        )
    }
}
#[cfg(feature = "allocator_api")]
impl<A> self::_puroro::DefaultIn<A> for self::Location::<A>
where
    A: ::std::alloc::Allocator + ::std::clone::Clone,
    self::_root::google::protobuf::source_code_info::_view::LocationView: self::_puroro::DefaultIn<
        A,
    >,
{
    fn default_in(allocator: A) -> Self {
        Self(
            ::std::boxed::Box::new_in(
                <self::_root::google::protobuf::source_code_info::_view::LocationView as self::_puroro::DefaultIn<
                    A,
...
> ::std::cmp::PartialEq<self::Location<A2>> for self::Location<A1> {
    fn eq(&self, rhs: &self::Location<A2>) -> bool {
        <self::_root::google::protobuf::source_code_info::_view::LocationView as ::std::cmp::PartialEq>::eq(
            &self.0,
            &rhs.0,
        )
    ...
    impl self::_pinternal::MessageViewInternal for self::LocationView {
        ...
        fn new_boxed_in<A: ::std::alloc::Allocator>(
            ...
            let (fields, allocator) = {
                ...
                let (span, _allocator) = self::_pinternal::FieldType::new_in(
                    shared.bitfield_mut(),
                    _allocator,
                );
                let (leading_comments, _allocator) = self::_pinternal::FieldType::new_in(
                    shared.bitfield_mut(),
                    _allocator,
                );
                let (trailing_comments, _allocator) = self::_pinternal::FieldType::new_in(
                    shared.bitfield_mut(),
                    _allocator,
                );
                let (leading_detached_comments, _allocator) = self::_pinternal::FieldType::new_in(
                    shared.bitfield_mut(),
                    _allocator,
                );
                (
                    self::_root::google::protobuf::source_code_info::_fields::LocationFields {
                        path,
                        span,
                        leading_comments,
                        trailing_comments,
