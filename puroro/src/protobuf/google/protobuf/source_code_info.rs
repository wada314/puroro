...
impl Location {
    ...
    pub fn clear_span(&mut self) {
        use self::_pinternal::{RepeatedFieldType, SharedItems as _};
        RepeatedFieldType::clear(&mut self.body.fields.span, self.body.shared.bitfield_mut())
    }
...
impl ::std::borrow::Borrow<self::_root::google::protobuf::source_code_info::_view::LocationView>
    for Location
{
    fn borrow(&self) -> &self::_root::google::protobuf::source_code_info::_view::LocationView {
        &self.body
    }
}
...
pub mod _view {
    ...
    impl LocationView {
        ...
        */
        pub fn span(&self) -> impl '_ + self::_puroro::repeated::RepeatedFieldView<'_, Item = i32> {
            use self::_pinternal::{RepeatedFieldType, SharedItems as _};
