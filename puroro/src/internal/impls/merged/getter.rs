...
impl<'a, MP, TypeTag, FieldsType, SharedType, ReturnType, const NUMBER: i32>
    GetFieldMethodImpl<'a, tags::MergedImpl, True, NUMBER>
...
// And then returns something implements `IntoIterator<Item=T::Item>`.
impl<
    'a,
    MP,
    FieldsType,
...
where
    ...
    LeftReturnType: IntoIterator<Item = ItemType>,
    RightReturnType: IntoIterator<Item = ItemType>,
{
