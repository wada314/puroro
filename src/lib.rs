...
pub use fields::{
    ...
    Singular, Oneof, OneofDeallocate, OneofEncodable, OneofGroup, OneofSlot, OneofSlotMut, Expanded, Packed,
    PresenceBits, ProtoBool, ProtoBytes, ProtoEnum, ProtoEnumStorage, ProtoInt32, ProtoInt64,
    ProtoSint32, ProtoSint64, ProtoString, ProtoUInt32, ProtoUInt64, RepeatedBytes,
    RepeatedExpandedInt32, RepeatedExpandedVarintField, RepeatedLen, RepeatedLenField,
    RepeatedLenFieldMut, RepeatedPackedInt32, RepeatedPackedVarintField,
